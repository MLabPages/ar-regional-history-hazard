...
const NATIONAL_CULTURAL_SPOTS = [
  ...
  ,makeNationalSpot({ id: 'religious-246', name: '豊受大神宮（伊勢神宮 外宮）', category: 'religious', region: '中部', coordinate: { latitude: 34.4860, longitude: 136.7030, elevationMeter: 15 }, era: 'ancient', eraLabel: '豊受大御神を祀る伊勢神宮の正宮', religiousType: '神宮・食と衣食住の守護神・伊勢信仰', summary: '豊受大御神を祀り、内宮とともに伊勢神宮を構成する外宮です。', description: '豊受大神宮は豊受大御神を祀る伊勢神宮の外宮で、天照大御神の御饌都神として崇敬されています。正宮と別宮からなる境内を通じ、祭祀・食・式年遷宮が結びつく日本の宗教文化を紹介します。', sourceName: '伊勢神宮 公式サイト（豊受大神宮・外宮）', sourceUrl: 'https://www.isejingu.or.jp/about/geku/?lang=ja' })
  ,makeNationalSpot({ id: 'religious-247', name: '住吉大社', category: 'religious', region: '近畿', coordinate: { latitude: 34.6120, longitude: 135.4930, elevationMeter: 8 }, era: 'ancient', eraLabel: '摂津国一之宮・住吉神社の総本社', religiousType: '神社・航海守護・摂津国一之宮', summary: '全国の住吉神社の総本社として、航海・外交・禊の信仰を伝える大社です。', description: '住吉大社は住吉三神と神功皇后を祀る摂津国一之宮で、全国約2300社余の住吉神社の総本社です。住吉津や遣隋使・遣唐使の航海と結びついた由緒から、古代の港湾・外交と信仰の関係を紹介します。', sourceName: '住吉大社 公式サイト（由緒）', sourceUrl: 'https://www.sumiyoshitaisha.net/about/origin.html' })
  ,makeNationalSpot({ id: 'religious-248', name: '高徳院（鎌倉大仏）', category: 'religious', region: '関東', coordinate: { latitude: 35.3160, longitude: 139.5350, elevationMeter: 20 }, era: 'kamakura', eraLabel: '建長4年（1252年）造立開始・国宝鎌倉大仏', religiousType: '寺院・浄土宗・阿弥陀信仰', summary: '露坐の鎌倉大仏を本尊とする、鎌倉を代表する仏教の拠点です。', description: '高徳院の本尊である鎌倉大仏は建長4年（1252年）に造立が始まり、台風や津波によって大仏殿を失った後も露坐の姿で伝わります。国宝の銅造阿弥陀如来坐像と災害後の景観から、中世鎌倉の信仰と復興の歴史を紹介します。', sourceName: '鎌倉大仏殿高徳院 公式サイト', sourceUrl: 'https://www.kotoku-in.jp/' })
  ,makeNationalSpot({ id: 'religious-249', name: '榛名神社', category: 'religious', region: '関東', coordinate: { latitude: 36.4670, longitude: 138.8500, elevationMeter: 820 }, era: 'ancient', eraLabel: '用明天皇元年（586年）祭祀伝承・榛名山の霊場', religiousType: '神社・山岳信仰・神仏習合', summary: '榛名山の岩峰と水源を信仰し、古代から講の文化を伝える山岳霊場です。', description: '榛名神社は用明天皇元年に祭祀の場が設けられたという伝承を持ち、延喜式神名帳にも載る古社です。中世の神仏習合、江戸時代の榛名講、御姿岩や社殿群から、山岳信仰と地域社会の結びつきを紹介します。', sourceName: '榛名神社 公式サイト（歴史）', sourceUrl: 'https://www.haruna.or.jp/?page_id=14' })
  ,makeNationalSpot({ id: 'castle-182', name: '秋月城跡', category: 'castle', region: '九州・沖縄', coordinate: { latitude: 33.4670, longitude: 130.6920, elevationMeter: 150 }, era: 'edo', eraLabel: '寛永元年（1624年）整備・秋月藩の城下町', castleType: '県指定史跡・陣屋形式・城下町', summary: '黒田長興が整えた秋月藩の城と、筑前の小京都と呼ばれる城下町です。', description: '秋月城跡は元和9年（1623年）に成立した秋月藩の陣屋として、寛永元年（1624年）に整備されました。表御殿・奥御殿、堀・石垣と城下町の景観から、福岡藩から分かれた支藩の政治拠点を紹介します。', sourceName: '朝倉市公式サイト（秋月城跡）', sourceUrl: 'https://www.city.asakura.lg.jp/soshiki/33/3507.html' })
  ,makeNationalSpot({ id: 'castle-183', name: '丹波亀山城跡', category: 'castle', region: '近畿', coordinate: { latitude: 35.0100, longitude: 135.5800, elevationMeter: 100 }, era: 'sengoku', eraLabel: '天正5年（1577年）頃築城・明智光秀の丹波攻略拠点', castleType: '城跡・平山城・天下普請', summary: '明智光秀の丹波攻略と本能寺の変に関わる、亀岡の近世城郭跡です。', description: '丹波亀山城跡は明智光秀が丹波攻略の拠点として築き、のちに天下普請で大規模な城郭へ整えられました。本能寺の変に出陣したとされる城の歴史と、宗教法人による石垣修復の現在を紹介します。', sourceName: '亀岡市公式サイト（丹波亀山城跡）', sourceUrl: 'https://www.city.kameoka.kyoto.jp/site/kirin/1244.html' })
  ,makeNationalSpot({ id: 'castle-184', name: '府内城跡', category: 'castle', region: '九州・沖縄', coordinate: { latitude: 33.2390, longitude: 131.6090, elevationMeter: 5 }, era: 'edo', eraLabel: '慶長2年（1597年）築城開始・府内藩政の中心', castleType: '県指定史跡・市指定史跡・平城', summary: '堀と石垣を残し、大分の城下町形成を伝える近世城郭です。', description: '府内城は福原直高が慶長2年（1597年）に築城を開始し、竹中重利の増改築を経て完成しました。海に近い城と城下町、廊下橋の復元から、豊後の近世都市と藩政の成立を紹介します。', sourceName: '大分市公式サイト（府内城跡）', sourceUrl: 'https://www.city.oita.oita.jp/o204/bunkasports/shitebunkazai/bunkazai.html' })
  ,makeNationalSpot({ id: 'castle-185', name: '黒井城跡', category: 'castle', region: '近畿', coordinate: { latitude: 35.1620, longitude: 135.0990, elevationMeter: 356 }, era: 'sengoku', eraLabel: '赤井（荻野）氏の居城・明智光秀の丹波攻略', castleType: '国指定史跡・続日本100名城・山城', summary: '全山を要塞化した曲輪と石垣が残る、丹波を代表する戦国山城です。', description: '黒井城跡は奥丹波の盟主であった赤井・荻野氏の居城で、織田信長の丹波攻略では明智光秀の攻撃を二度支えました。山頂の曲輪群と石垣から、戦国期の山城防御と地域支配を紹介します。', sourceName: '丹波市公式サイト（黒井城跡）', sourceUrl: 'https://www.city.tamba.lg.jp/soshiki/shakaikyoikubunkazaika/gyomuannai/7/1/1922.html' })
  ,makeNationalSpot({ id: 'religious-250', name: '池上本門寺', category: 'religious', region: '関東', coordinate: { latitude: 35.5770, longitude: 139.7060, elevationMeter: 25 }, era: 'kamakura', eraLabel: '日蓮聖人入滅の霊場・日蓮宗大本山', religiousType: '寺院・日蓮宗・祖師信仰', summary: '日蓮聖人入滅の霊場として、日蓮宗の信仰と東京の門前文化を伝える大本山です。', description: '池上本門寺は日蓮聖人入滅の霊場で、日蓮宗の大本山として法灯を受け継いでいます。祖師信仰、御会式、五重塔や宝塔などの文化財から、都市の中で続く宗教行事と日蓮宗の歴史を紹介します。', sourceName: '日蓮宗大本山 池上本門寺 公式サイト', sourceUrl: 'https://honmonji.jp/' })
  ,makeNationalSpot({ id: 'religious-251', name: '大本山總持寺', category: 'religious', region: '関東', coordinate: { latitude: 35.5070, longitude: 139.6780, elevationMeter: 10 }, era: 'kamakura', eraLabel: '元亨元年（1321年）創立・曹洞宗大本山', religiousType: '寺院・曹洞宗・禅道場', summary: '能登から横浜へ移り、国際的な禅の根本道場となった曹洞宗の大本山です。', description: '總持寺は元亨元年（1321年）に瑩山禅師が能登の諸嶽寺を改めたことに始まり、明治期の焼失を機に横浜へ移転しました。広大な境内と坐禅・修行の文化から、地方の古刹が近代都市の禅道場へ展開した歴史を紹介します。', sourceName: '横浜市観光情報サイト（大本山總持寺）', sourceUrl: 'https://www.welcome.city.yokohama.jp/spot/details.php?bbid=197' })
  ,makeNationalSpot({ id: 'religious-252', name: '仁和寺', category: 'religious', region: '近畿', coordinate: { latitude: 35.0310, longitude: 135.7130, elevationMeter: 75 }, era: 'heian', eraLabel: '仁和4年（888年）創建・御室御所', religiousType: '寺院・真言宗御室派総本山・門跡寺院', summary: '宇多天皇が創建し、皇族ゆかりの門跡寺院として続く世界遺産です。', description: '仁和寺は宇多天皇が仁和4年（888年）に創建し、法親王が住持したことから御室御所と呼ばれました。金堂・五重塔・御室桜などの境内から、皇室と仏教、京都の文化景観の結びつきを紹介します。', sourceName: '京都府公式サイト（世界遺産 仁和寺）', sourceUrl: 'https://www.pref.kyoto.jp/isan/ninnaji.html' })
  ,makeNationalSpot({ id: 'religious-253', name: '宮島弥山 大本山大聖院', category: 'religious', region: '中国', coordinate: { latitude: 34.2930, longitude: 132.3180, elevationMeter: 80 }, era: 'nara', eraLabel: '大同元年（806年）開基伝承・弥山の総本坊', religiousType: '寺院・真言宗御室派・神仏習合', summary: '厳島神社の別当寺として、宮島の神仏習合と弥山信仰を伝える寺院です。', description: '大聖院は空海が弥山で修行したことを起源とする開基伝承を持ち、厳島神社の別当寺として祭祀を担ってきました。三鬼大権現や十一面観世音菩薩など多様な仏神を祀り、宮島の神仏習合を紹介します。', sourceName: '宮島弥山 大本山大聖院 公式サイト', sourceUrl: 'https://daisho-in.com/about_daishoin.html' })
  ,makeNationalSpot({ id: 'castle-186', name: '水口岡山城跡', category: 'castle', region: '近畿', coordinate: { latitude: 34.9660, longitude: 136.1700, elevationMeter: 285 }, era: 'sengoku', eraLabel: '天正13年（1585年）築城・豊臣政権の甲賀支配拠点', castleType: '国指定史跡・山城・織豊系城郭', summary: '豊臣政権が東海道と鈴鹿越えを押さえるため築いた、甲賀の山城です。', description: '水口岡山城跡は天正13年（1585年）に中村一氏が築き、増田長盛・長束正家へ受け継がれました。東海道と鈴鹿越えを望む立地から、豊臣政権の地域支配と織豊系城郭の築城を紹介します。', sourceName: '甲賀市公式サイト（水口岡山城跡）', sourceUrl: 'https://www.city.koka.lg.jp/7616.htm' })
  ,makeNationalSpot({ id: 'castle-187', name: '利神城跡', category: 'castle', region: '中国', coordinate: { latitude: 35.0450, longitude: 134.3650, elevationMeter: 373 }, era: 'sengoku', eraLabel: '播磨・美作国境を守る山城・平福の城下町', castleType: '国指定史跡・山城・高石垣', summary: '高石垣を備え、国境と宿場町を見下ろす播磨北西部の山城です。', description: '利神城跡は利神山に築かれ、戦国から近世初頭にかけて播磨・美作国境の軍事・政治拠点となりました。山頂の高石垣と麓の平福の町並みから、城と宿場町が一体となった地域景観を紹介します。', sourceName: '佐用町公式サイト（利神城跡）', sourceUrl: 'https://www.town.sayo.lg.jp/cms-sypher/www/info/detail.jsp?id=11712' })
  ,makeNationalSpot({ id: 'castle-188', name: '田丸城跡', category: 'castle', region: '中部', coordinate: { latitude: 34.4900, longitude: 136.6300, elevationMeter: 50 }, era: 'muromachi', eraLabel: '延元元年（1336年）築城伝承・南伊勢の拠点', castleType: '県指定史跡・続日本100名城・平山城', summary: '北畠氏と織田信雄が築いた、伊勢神宮を望む南伊勢の城跡です。', description: '田丸城跡は延元元年（1336年）に北畠親房が築いたとされ、戦国期には織田信雄が伊勢支配の拠点として整備しました。天守台や石垣、堀の遺構から、南北朝から近世へ移る伊勢の政治史を紹介します。', sourceName: '玉城町公式サイト（田丸城跡）', sourceUrl: 'https://kizuna.town.tamaki.jp/tamarujo/' })
  ,makeNationalSpot({ id: 'castle-189', name: '八上城跡', category: 'castle', region: '近畿', coordinate: { latitude: 35.0730, longitude: 135.2500, elevationMeter: 462 }, era: 'sengoku', eraLabel: '波多野氏の居城・明智光秀の丹波攻略の主戦場', castleType: '国指定史跡・山城・日本遺産', summary: '高城山に曲輪を展開し、明智光秀の丹波攻略を伝える大規模山城です。', description: '八上城跡は高城山に築かれた波多野氏の居城で、明智光秀による丹波攻略の主戦場となりました。山頂の本城と周辺の曲輪群から、中世領主の山城と近世城郭へ移る丹波の城郭史を紹介します。', sourceName: '丹波地域公式観光ポータル（八上城跡）', sourceUrl: 'https://www.burari-tambaji.com/spot/141' })
  ,makeNationalSpot({ id: 'religious-254', name: '天龍寺', category: 'religious', region: '近畿', coordinate: { latitude: 35.0150, longitude: 135.6740, elevationMeter: 45 }, era: 'muromachi', eraLabel: '暦応2年（1339年）創建・京都五山第一位', religiousType: '寺院・臨済宗天龍寺派大本山・禅宗', summary: '足利尊氏が後醍醐天皇の菩提を弔うため創建した、嵐山の世界遺産です。', description: '天龍寺は暦応2年（1339年）に足利尊氏が夢窓国師を開山として創建した禅寺です。曹源池庭園と嵐山の景観から、天皇の追善供養、武家の権力、禅文化が重なる京都の宗教景観を紹介します。', sourceName: '天龍寺 公式サイト', sourceUrl: 'https://www.tenryuji.com/' })
  ,makeNationalSpot({ id: 'religious-255', name: '栂尾山高山寺', category: 'religious', region: '近畿', coordinate: { latitude: 35.0600, longitude: 135.6780, elevationMeter: 300 }, era: 'kamakura', eraLabel: '明恵上人中興・華厳宗の根本道場', religiousType: '寺院・華厳宗・山林修行', summary: '明恵上人が華厳宗興隆の根本道場とした、鳥獣人物戯画で知られる世界遺産です。', description: '高山寺は古代の開創伝承を持ち、13世紀初めに明恵上人が再建して華厳宗の根本道場としました。石水院や鳥獣人物戯画、茶の伝来に関わる伝承から、山林の修行と文化交流を紹介します。', sourceName: '高山寺 公式サイト（歴史）', sourceUrl: 'https://kosanji.com/about/history/' })
  ,makeNationalSpot({ id: 'religious-256', name: '大本山護国寺', category: 'religious', region: '関東', coordinate: { latitude: 35.7190, longitude: 139.7280, elevationMeter: 25 }, era: 'edo', eraLabel: '天和元年（1681年）創建・江戸の観音信仰', religiousType: '寺院・真言宗豊山派・観音信仰', summary: '桂昌院の発願で創建され、災害を越えて元禄の本堂を伝える東京の寺院です。', description: '護国寺は天和元年（1681年）に桂昌院の発願で創建され、徳川綱吉の時代から江戸の観音信仰を集めました。震災・戦災を越えた元禄期の観音堂と、真言宗豊山派の江戸拠点としての歴史を紹介します。', sourceName: '大本山護国寺 公式サイト', sourceUrl: 'https://www.gokokuji.or.jp/about' })
  ,makeNationalSpot({ id: 'religious-257', name: '一之宮貫前神社', category: 'religious', region: '関東', coordinate: { latitude: 36.2590, longitude: 138.7880, elevationMeter: 220 }, era: 'ancient', eraLabel: '安閑天皇元年（531年）創立伝承・上野国一宮', religiousType: '神社・一宮・刀剣と養蚕の信仰', summary: 'くだり参道と極彩色の社殿で知られる、上野国一宮の古社です。', description: '貫前神社は安閑天皇元年（531年）創立の伝承を持ち、上野国一宮として朝廷や地域から崇敬されてきました。経津主神を祀る刀剣・武道の信仰と、養蚕・機織りの伝承、独特のくだり参道を紹介します。', sourceName: '一之宮貫前神社 公式サイト（御由緒）', sourceUrl: 'https://nukisaki.or.jp/go_yui_sho.html' })
  ,makeNationalSpot({ id: 'castle-190', name: '三木城跡及び付城跡・土塁', category: 'castle', region: '近畿', coordinate: { latitude: 34.7960, longitude: 134.9900, elevationMeter: 65 }, era: 'sengoku', eraLabel: '天正6～8年（1578～1580年）三木合戦の舞台', castleType: '国指定史跡・城跡と包囲網遺跡', summary: '羽柴秀吉による兵糧攻めと、城を囲む付城群が残る戦国史跡です。', description: '三木城跡と付城跡・土塁は、別所長治と羽柴秀吉の三木合戦に関わる遺跡群です。籠城した城と周囲の包囲網を一体でたどることで、戦国期の攻城戦と軍事景観を紹介します。', sourceName: '三木市公式サイト（三木城跡及び付城跡・土塁）', sourceUrl: 'https://www.city.miki.lg.jp/site/mikirekishishiryokan/26531.html' })
  ,makeNationalSpot({ id: 'castle-191', name: '有岡城跡', category: 'castle', region: '近畿', coordinate: { latitude: 34.7800, longitude: 135.4210, elevationMeter: 20 }, era: 'sengoku', eraLabel: '天正2年（1574年）荒木村重改修・惣構の城', castleType: '国指定史跡・惣構・城下町遺跡', summary: '城・侍町・町屋を堀と土塁で囲んだ、戦国期の惣構を伝える城跡です。', description: '有岡城跡は荒木村重が伊丹城を改修して名を改め、城だけでなく侍町と町屋を惣構で囲みました。籠城戦、城下町、酒造で発展した伊丹郷町の変遷から、都市型城郭の歴史を紹介します。', sourceName: '伊丹市公式サイト（有岡城跡）', sourceUrl: 'https://www.city.itami.lg.jp/SOSIKI/TOSHIKATSURYOKU/BUNKA/bunnkazai/SINAI_BUNKAZAI/KUNI_SITEI/1386843388423.html' })
  ,makeNationalSpot({ id: 'castle-192', name: '鎌刃城跡', category: 'castle', region: '近畿', coordinate: { latitude: 35.3670, longitude: 136.3110, elevationMeter: 384 }, era: 'sengoku', eraLabel: '京極・六角の境目の城・織田信長と浅井氏の攻防', castleType: '国指定史跡・続日本100名城・山城', summary: '京極・六角の境界に築かれ、織田・浅井の攻防を伝える典型的な山城です。', description: '鎌刃城跡は標高384mの山頂に築かれ、京極氏・六角氏の勢力境界で機能しました。石積みや曲輪、堀切、水の手の遺構から、戦国期の境目の城と山の資源利用を紹介します。', sourceName: '米原市公式サイト（鎌刃城跡）', sourceUrl: 'https://www.city.maibara.lg.jp/kanko/rekishi/shitei/4607.html' })
  ,makeNationalSpot({ id: 'castle-193', name: '玄蕃尾城跡（内中尾山城）', category: 'castle', region: '中部', coordinate: { latitude: 35.5850, longitude: 136.1350, elevationMeter: 460 }, era: 'sengoku', eraLabel: '天正11年（1583年）賤ヶ岳合戦の柴田勝家本陣', castleType: '国指定史跡・続日本100名城・山城', summary: '賤ヶ岳合戦で柴田勝家が本陣を置いた、県境の戦国山城です。', description: '玄蕃尾城跡は福井・滋賀県境の内中尾山に築かれ、天正11年（1583年）の賤ヶ岳合戦で柴田勝家の本陣となりました。尾根上の曲輪と土塁から、合戦時に急造された山城の構造を紹介します。', sourceName: '敦賀観光公式サイト（玄蕃尾城跡）', sourceUrl: 'https://tsuruga-kanko.jp/spot/history_culture/genbao-castle/' })
  ,makeNationalSpot({ id: 'castle-194', name: '篠山城跡', category: 'castle', region: '近畿', coordinate: { latitude: 35.0740, longitude: 135.2200, elevationMeter: 260 }, era: 'edo', eraLabel: '慶長14年（1609年）徳川家康の命による天下普請', castleType: '国指定史跡・平城・天下普請', summary: '徳川家康の命で築かれ、馬出と水堀が残る丹波篠山の城郭です。', description: '篠山城跡は慶長14年（1609年）に徳川家康の命で築かれ、丹波八上城に代わる政治拠点となりました。大書院、馬出、同心円状の曲輪と水堀から、江戸初期の天下普請を紹介します。', sourceName: '丹波篠山市公式サイト（国指定史跡篠山城跡）', sourceUrl: 'https://www.city.tambasasayama.lg.jp/soshikikarasagasu/shinbunkazai/sasayamajo/2858.html' })
  ,makeNationalSpot({ id: 'religious-258', name: '高野山奥之院', category: 'religious', region: '近畿', coordinate: { latitude: 34.2135, longitude: 135.6075, elevationMeter: 900 }, era: 'heian', eraLabel: '弘仁7年（816年）開創・弘法大師御廟の霊場', religiousType: '寺院・真言宗・高野山二大聖地', summary: '弘法大師の御廟へ続く、高野山信仰の中心的な参詣道と霊場です。', description: '高野山奥之院は弘法大師の御廟を中心とする高野山の聖地で、参道には歴史上の人物や各地の人々が奉納した墓碑・供養塔が並びます。金剛峯寺と役割を分けて、山岳霊場に集まる祈りと記憶を紹介します。', sourceName: '高野山真言宗 総本山金剛峯寺 公式サイト（高野山の見どころ）', sourceUrl: 'https://www.koyasan.or.jp/sp/meguru/' })
  ,makeNationalSpot({ id: 'religious-259', name: '土佐神社', category: 'religious', region: '四国', coordinate: { latitude: 33.5760, longitude: 133.5770, elevationMeter: 20 }, era: 'ancient', eraLabel: '古代創祀伝承・土佐国一之宮', religiousType: '神社・土佐国一之宮・総鎮守', summary: '土佐国の総鎮守として、古代の祭祀と長宗我部氏の再興を伝える古社です。', description: '土佐神社は創祀年代を明らかにしないものの古代に遡るとされ、平安時代には式内大社、鎌倉時代初頭には土佐国総鎮守一宮とされました。元亀元年（1570年）に長宗我部元親が社殿を再興した由緒と、しなね祭の地域文化を紹介します。', sourceName: '土佐神社 公式サイト（御祭神・御由緒）', sourceUrl: 'https://tosajinja.com/gosaijin/' })
  ,makeNationalSpot({ id: 'religious-260', name: '真清田神社', category: 'religious', region: '中部', coordinate: { latitude: 35.3040, longitude: 136.8010, elevationMeter: 10 }, era: 'heian', eraLabel: '平安時代に名神大社・尾張国一之宮', religiousType: '神社・尾張国一之宮・木曽川流域の鎮守', summary: '一宮市の名前の由来となった、尾張国一之宮の古社です。', description: '真清田神社は平安時代に国家から名神大社と認められ、尾張国一之宮として崇敬を集めました。木曽川の水と農地、門前市、戦災からの社殿復興を通して、神社を中心に発展した都市の記憶を紹介します。', sourceName: '真清田神社 公式サイト（由緒）', sourceUrl: 'https://www.masumida.or.jp/yuisyo/' })
  ,makeNationalSpot({ id: 'religious-261', name: '尾張大國霊神社（国府宮）', category: 'religious', region: '中部', coordinate: { latitude: 35.2520, longitude: 136.8040, elevationMeter: 10 }, era: 'nara', eraLabel: '奈良時代に尾張国総社・国府宮', religiousType: '神社・尾張総社・厄除信仰', summary: '尾張国の総社として国司の祭祀を受け、はだか祭で知られる神社です。', description: '尾張大國霊神社は尾張地方の国霊神を祀り、奈良時代に国衙に隣接する尾張国の総社と定められました。重要文化財の楼門・拝殿と儺追神事（はだか祭）から、古代の国府と地域の厄除け信仰を紹介します。', sourceName: '尾張大國霊神社 国府宮 公式サイト（神社のご案内）', sourceUrl: 'https://www.konomiya.or.jp/about' })
  ,makeNationalSpot({ id: 'religious-262', name: '粉河寺', category: 'religious', region: '近畿', coordinate: { latitude: 34.2690, longitude: 135.3860, elevationMeter: 55 }, era: 'nara', eraLabel: '宝亀元年（770年）創建伝承・西国三十三所第三番札所', religiousType: '寺院・天台宗系・観音霊場', summary: '国宝の縁起絵巻と大規模な境内を伝える、西国巡礼の観音霊場です。', description: '粉河寺は宝亀元年（770年）の創建伝承を持ち、鎌倉時代には広大な伽藍と寺領を誇りました。豊臣秀吉の兵乱による焼失後、紀州徳川家と信徒の支援で再建された歴史から、巡礼と地域の信仰文化を紹介します。', sourceName: '粉河寺 公式サイト（草創と沿革）', sourceUrl: 'https://www.kokawadera.org/history/' })
  ,makeNationalSpot({ id: 'castle-195', name: '鳥越城跡附二曲城跡', category: 'castle', region: '中部', coordinate: { latitude: 36.4160, longitude: 136.5860, elevationMeter: 312 }, era: 'sengoku', eraLabel: '天正8～10年（1580～1582年）加賀一向一揆最後の拠点', castleType: '国指定史跡・続日本100名城・山城', summary: '本願寺門徒の一向一揆が最後まで抵抗した、白山麓の山城遺跡です。', description: '鳥越城跡附二曲城跡は、白山麓の本願寺門徒が築き整備した山城群で、織田軍との攻防を経て加賀一向一揆最後の拠点となりました。復元された門や土塁、一向一揆歴史館とあわせ、宗教と地域自治、戦国の攻城戦を紹介します。', sourceName: '白山市公式サイト（鳥越城跡附二曲城跡）', sourceUrl: 'https://www.city.hakusan.lg.jp/bunka/bunkazai/1006458/1006451/1002399.html' })
  ,makeNationalSpot({ id: 'castle-196', name: '郡上八幡城', category: 'castle', region: '中部', coordinate: { latitude: 35.7500, longitude: 136.9600, elevationMeter: 354 }, era: 'sengoku', eraLabel: '永禄2年（1559年）創始・郡上藩の城下町', castleType: '岐阜県史跡・木造再建天守・山城', summary: '水の城下町と郡上一揆の記憶を見下ろす、木造再建天守の山城です。', description: '郡上八幡城は永禄2年（1559年）の赤谷山城の戦いを創始とし、江戸時代には郡上藩の政治拠点となりました。城下町の水路、郡上一揆、昭和8年に再建された木造天守から、城と地域社会の歴史を紹介します。', sourceName: '郡上八幡城 公式サイト（郡上八幡の歴史）', sourceUrl: 'https://hachiman-castle.com/history/' })
  ,makeNationalSpot({ id: 'religious-263', name: '酒列磯前神社', category: 'religious', region: '関東', coordinate: { latitude: 36.3520, longitude: 140.6060, elevationMeter: 25 }, era: 'heian', eraLabel: '斉衡3年（856年）創建・医療薬学と海辺の信仰', religiousType: '神社・海上信仰・医療薬学の神', summary: '少彦名命を祀り、大洗磯前神社と一対で伝わる常陸の古社です。', description: '酒列磯前神社は斉衡3年（856年）の神降臨伝承を起源とし、少彦名命を主祭神、大名持命を配祀神とします。大洗磯前神社と兄弟神社を形成し、病気平癒・薬学・醸造の信仰を集めてきた海辺の宗教拠点を紹介します。', sourceName: '酒列磯前神社 公式サイト（ご由緒）', sourceUrl: 'https://sakatura.org/goyuisyo/' })
  ,makeNationalSpot({ id: 'religious-264', name: '鳴無神社', category: 'religious', region: '四国', coordinate: { latitude: 33.3950, longitude: 133.3030, elevationMeter: 5 }, era: 'edo', eraLabel: '寛文3年（1663年）造営・浦ノ内湾の海辺の社', religiousType: '神社・海上信仰・重要文化財社殿', summary: '浦ノ内湾に面し、海上渡御と重要文化財の社殿を伝える「土佐の宮島」です。', description: '鳴無神社は浦ノ内湾の奥に鎮座し、寛文3年（1663年）造営の本殿などが重要文化財に指定されています。土佐神社の祭礼とも結びつく海上渡御の伝承と神踊から、湾と地域祭祀が重なる信仰景観を紹介します。', sourceName: '高知県教育委員会（国指定重要文化財・鳴無神社）', sourceUrl: 'https://www.kochinet.ed.jp/bunkazai/details/110-1/110-1-11.htm' })
  ,makeNationalSpot({ id: 'religious-265', name: '深大寺', category: 'religious', region: '関東', coordinate: { latitude: 35.6740, longitude: 139.5440, elevationMeter: 45 }, era: 'asuka', eraLabel: '天平5年（733年）創建伝承・元三大師信仰', religiousType: '寺院・天台宗・厄除け信仰', summary: '水神と元三大師の信仰、門前のそば文化が重なる武蔵野の古刹です。', description: '深大寺は天平5年（733年）創建の伝承を持ち、深沙大王の水神信仰と元三大師の厄除け信仰を受け継いできました。湧水、境内、門前のそば文化から、武蔵野の自然と寺院の営みを紹介します。', sourceName: '深大寺 公式サイト（歴史）', sourceUrl: 'https://www.jindaiji.or.jp/about/history.php' })
  ,makeNationalSpot({ id: 'religious-266', name: '瑠璃光寺', category: 'religious', region: '中国', coordinate: { latitude: 34.1850, longitude: 131.4780, elevationMeter: 55 }, era: 'muromachi', eraLabel: '文明3年（1471年）創建・国宝五重塔', religiousType: '寺院・曹洞宗・大内氏ゆかり', summary: '国宝五重塔と香山公園に、大内氏の山口と禅寺の歴史を伝える寺院です。', description: '瑠璃光寺は文明3年（1471年）に陶弘房の菩提寺として創建され、現在地へ移転しました。大内義弘の菩提を弔うため建立された国宝五重塔と、寺宝・山口の町並みから、守護大名の文化と禅寺の記憶を紹介します。', sourceName: '山口県観光公式サイト（瑠璃光寺）', sourceUrl: 'https://yamaguchi-tourism.jp/spot/detail_12192.html' })
  ,makeNationalSpot({ id: 'religious-267', name: '一畑薬師', category: 'religious', region: '中国', coordinate: { latitude: 35.4620, longitude: 132.8420, elevationMeter: 200 }, era: 'heian', eraLabel: '寛平6年（894年）創開・日本三大薬師', religiousType: '寺院・臨済宗・薬師信仰', summary: '「目のお薬師さま」として全国から信仰を集める、出雲の山上霊場です。', description: '一畑薬師は寛平6年（894年）、日本海から引き上げられた薬師如来を祀ったことを創開と伝えます。1300段余りの石段と山上からの眺望、「目の薬師」「子どもの無事成長」の信仰から、出雲の民間信仰と巡礼を紹介します。', sourceName: '一畑薬師（総本山一畑寺）公式サイト', sourceUrl: 'https://ichibata.jp/?page_id=5' })
  ,makeNationalSpot({ id: 'religious-268', name: '万松院', category: 'religious', region: '九州・沖縄', coordinate: { latitude: 34.2030, longitude: 129.2870, elevationMeter: 25 }, era: 'edo', eraLabel: '元和元年（1615年）創立・対馬藩主宗家菩提寺', religiousType: '寺院・対馬藩主墓所・日朝交流史', summary: '対馬藩主宗家の菩提寺として、朝鮮外交を担った国境の歴史を伝えます。', description: '万松院は元和元年（1615年）に対馬藩主宗義智の冥福を祈るため創立され、宗家の墓所を守ってきました。桃山様式の山門や巨大な墓石群から、対馬藩の外交、日朝交流、国境の宗教文化を紹介します。', sourceName: '長崎県の文化財（万松院）', sourceUrl: 'https://www.pref.nagasaki.jp/bunkadb/index.php/view/501' })
  ,makeNationalSpot({ id: 'castle-197', name: '浪岡城跡', category: 'castle', region: '東北', coordinate: { latitude: 40.7120, longitude: 140.5910, elevationMeter: 35 }, era: 'muromachi', eraLabel: '15世紀後半築城・北畠氏の居城', castleType: '国指定史跡・続日本100名城・平城', summary: '七つの郭と多彩な出土品から、北畠氏の文化と北奥の中世都市を伝える城跡です。', description: '浪岡城跡は15世紀後半に北畠氏の居城として築かれ、浪岡川と正平津川の合流点に七つの郭を展開しました。中国製陶磁器を含む出土品と史跡公園から、北奥羽の政治・交易・文化の広がりを紹介します。', sourceName: '青森県庁ウェブサイト（浪岡城跡）', sourceUrl: 'https://www.pref.aomori.lg.jp/soshiki/kyoiku/e-bunka/kinen_siseki_01.html' })
  ,makeNationalSpot({ id: 'castle-198', name: '富山城', category: 'castle', region: '中部', coordinate: { latitude: 36.6920, longitude: 137.2110, elevationMeter: 10 }, era: 'sengoku', eraLabel: '天文12年（1543年）築城伝承・前田家の富山藩居城', castleType: '続日本100名城・平城・登録有形文化財天守', summary: '神通川を取り込んだ「浮き城」として、戦国から富山藩の歴史を伝える城郭です。', description: '富山城は天文12年（1543年）に神保長職が築いたとされ、佐々成政、前田利長を経て富山藩の居城となりました。神通川を利用した防御、城址公園と戦災復興期の再建天守から、富山の都市史を紹介します。', sourceName: '富山市観光公式サイト（富山城）', sourceUrl: 'https://www.toyamashi-kankoukyoukai.jp/spot/toyamajou/' })
  ,makeNationalSpot({ id: 'castle-199', name: '河後森城跡', category: 'castle', region: '四国', coordinate: { latitude: 33.2290, longitude: 132.7030, elevationMeter: 170 }, era: 'sengoku', eraLabel: '天文後期～天正期（16世紀後半）機能・国指定史跡', castleType: '国指定史跡・続日本100名城・山城', summary: '三つの川に囲まれた丘陵に曲輪を展開する、伊予と土佐の国境の山城です。', description: '河後森城跡は広見川など三つの川に囲まれた独立丘陵に築かれ、本郭を中心に馬蹄形の曲輪が連なります。伊予と土佐の国境地域で機能した中世山城の構造と、発掘・保存を続ける地域の取り組みを紹介します。', sourceName: '松野町公式サイト（河後森城）', sourceUrl: 'https://www.town.matsuno.ehime.jp/site/kagomorijou/' })
  ,makeNationalSpot({ id: 'religious-269', name: '宮地嶽神社', category: 'religious', region: '九州・沖縄', coordinate: { latitude: 33.7798, longitude: 130.4861, elevationMeter: 80 }, era: 'ancient', eraLabel: '約1700年前の創建伝承・古墳と奥之宮八社', religiousType: '神社・海上信仰・古墳祭祀', summary: '神功皇后の航海祈願伝承と、国宝が出土した古墳を抱える北部九州の聖地です。', description: '宮地嶽神社は神功皇后が宮地嶽山頂で天神地祇を祀り、航海の無事を祈ったという由緒を伝えます。奥之宮八社の不動神社は巨石古墳の中に祀られ、出土品の一部が国宝に指定されています。海上交通、古墳祭祀、現代の開運信仰が重なる宗教景観を紹介します。', sourceName: '宮地嶽神社 公式サイト（御祭神・御由緒）', sourceUrl: 'https://www.miyajidake.or.jp/history/gosaijin' })
  ,makeNationalSpot({ id: 'religious-270', name: '御岩神社', category: 'religious', region: '関東', coordinate: { latitude: 36.6486, longitude: 140.6084, elevationMeter: 310 }, era: 'ancient', eraLabel: '常陸國風土記に見える御岩山の信仰・神仏習合の霊場', religiousType: '神社・山岳信仰・神仏習合', summary: '御岩山の自然信仰と神仏習合の歴史を今に伝える、常陸の霊場です。', description: '御岩神社は創建時期は不明ながら、縄文晩期の祭祀遺跡や721年の常陸國風土記により古代からの信仰がうかがえます。中世の山岳信仰、江戸時代の水戸藩の祈願所、境内に残る仏像と188柱の神々から、神仏習合の重層的な文化を紹介します。', sourceName: '御岩神社 公式サイト（神社紹介）', sourceUrl: 'https://www.oiwajinja.jp/jinjasyoukai.html' })
  ,makeNationalSpot({ id: 'religious-271', name: '大善寺玉垂宮', category: 'religious', region: '九州・沖縄', coordinate: { latitude: 33.2670, longitude: 130.4760, elevationMeter: 15 }, era: 'asuka', eraLabel: '白鳳元年（673年）創建伝承・神宮寺の宗教拠点', religiousType: '神社・神仏習合・玉垂信仰', summary: '神社と寺院が一体となって栄えた、筑後の神仏習合を伝える古社です。', description: '大善寺玉垂宮は白鳳元年（673年）の創建伝承を持ち、かつては高法寺・大善寺と一体の神宮寺として多くの坊と社領を有しました。玉垂命・八幡大神・住吉大神への信仰、鬼夜などの祭礼、明治の神仏分離を通じて、筑後の宗教史を紹介します。', sourceName: '大善寺玉垂宮 公式サイト（玉垂宮について）', sourceUrl: 'https://tamataregu.or.jp/about' })
  ,makeNationalSpot({ id: 'religious-272', name: '龍田大社', category: 'religious', region: '近畿', coordinate: { latitude: 34.6010, longitude: 135.6940, elevationMeter: 45 }, era: 'ancient', eraLabel: '延喜式の風神祭・大和川水運を守る古社', religiousType: '神社・風神信仰・旧官幣大社', summary: '風の神を祀り、朝廷の風神祭と大和川の水運に結びついた古社です。', description: '龍田大社は天御柱大神・国御柱大神を祀る風神の本宮で、延喜式にも国家的な風神祭の記録が残ります。龍田川の景観や大和川水運との関係から、気象・農耕・交通を支えた古代の宗教拠点を紹介します。', sourceName: '奈良県公式サイト（龍田大社）', sourceUrl: 'https://www.pref.nara.lg.jp/ikasu-nara/bunkashigen/main00036.html' })
  ,makeNationalSpot({ id: 'castle-200', name: '広島城', category: 'castle', region: '中国', coordinate: { latitude: 34.4000, longitude: 132.4590, elevationMeter: 8 }, era: 'sengoku', eraLabel: '天正17年（1589年）築城開始・毛利輝元の城下町', castleType: '国指定史跡・日本100名城・平城', summary: '太田川デルタに築かれ、広島という都市の成立と復興を見つめた城郭です。', description: '広島城は天正17年（1589年）に毛利輝元が築城を始め、城下町の整備とともに広島の都市形成の起点となりました。福島氏・浅野氏の治世、原爆による建物の喪失、戦後の復元から、城と都市の近世・近代史を紹介します。', sourceName: '広島城 公式サイト（歴史）', sourceUrl: 'https://hiroshimacastle.jp/history' })
  ,makeNationalSpot({ id: 'castle-201', name: '久留米城跡', category: 'castle', region: '九州・沖縄', coordinate: { latitude: 33.3190, longitude: 130.5150, elevationMeter: 20 }, era: 'edo', eraLabel: '元和7年（1621年）有馬氏入城・久留米藩の居城', castleType: '福岡県指定史跡・続日本100名城・平山城', summary: '有馬氏が幕末まで治めた筑後の城で、石垣と内濠、城内の篠山神社を伝えます。', description: '久留米城跡は戦国期の城を基礎に、元和7年（1621年）に入城した有馬豊氏が大改修し、久留米藩の政治拠点となりました。現存する本丸の石垣・内濠と、廃城後に旧藩主を祀った篠山神社から、城郭と宗教的慰霊の結びつきを紹介します。', sourceName: '久留米市公式観光サイト（久留米城跡）', sourceUrl: 'https://welcome-kurume.com/spots/detail/40355fc2-39ee-45a3-beb2-e48ea4c26f91' })
  ,makeNationalSpot({ id: 'castle-202', name: '郡山城跡（大和）', category: 'castle', region: '近畿', coordinate: { latitude: 34.6500, longitude: 135.7800, elevationMeter: 55 }, era: 'sengoku', eraLabel: '天正13年（1585年）豊臣秀長入城・畿内統治の拠点', castleType: '国指定史跡・平山城・豊臣政権の城郭', summary: '豊臣秀長が大規模に整備し、石垣に寺社の礎石や石仏が残る大和の城跡です。', description: '郡山城跡は天正13年（1585年）に豊臣秀長が入城し、畿内統治の拠点として大規模に整備されました。城内の石垣には寺院などから転用された石材や石仏が含まれ、城郭建設と地域の寺社文化が交差する歴史を紹介します。', sourceName: '大和郡山市公式サイト（史跡郡山城跡）', sourceUrl: 'https://www.city.yamatokoriyama.lg.jp/soshiki/machidukuri_senryaku/rekishi_bunkazai/bunkazai/11888.html' })
  ,makeNationalSpot({ id: 'religious-273', name: '水若酢神社', category: 'religious', region: '中国', coordinate: { latitude: 36.2800, longitude: 133.2494, elevationMeter: 25 }, era: 'ancient', eraLabel: '延喜式名神大社・隠岐国一之宮', religiousType: '神社・隠岐国一之宮・海上鎮護', summary: '隠岐国一之宮として、日本海の国土開発と航海を守ってきた島の古社です。', description: '水若酢神社は延喜式の名神大社に数えられ、隠岐国一之宮として島民の崇敬を集めてきました。伊勢神宮・出雲大社・春日神社の要素を合わせた隠岐造りの本殿、山曳きや流鏑馬を含む祭礼風流から、島の自然と海上信仰を紹介します。', sourceName: '隠岐の島町公式サイト（水若酢神社）', sourceUrl: 'https://www.town.okinoshima.shimane.jp/soshiki/somu/gyomu/11/4/5/4/index.html' })
  ,makeNationalSpot({ id: 'religious-274', name: '忌部神社', category: 'religious', region: '四国', coordinate: { latitude: 34.0544, longitude: 134.2668, elevationMeter: 120 }, era: 'ancient', eraLabel: '阿波忌部の祖神・大嘗祭の麁服伝承', religiousType: '神社・古代祭祀・忌部氏の信仰', summary: '阿波忌部の祖神を祀り、古代の宮中祭祀と麻・織物文化につながる神社です。', description: '忌部神社は阿波忌部の祖神・天日鷲命を祀り、古代祭祀を担った忌部氏と大嘗祭の麁服献上の伝承を伝えます。現在地への鎮座には明治期の式内社比定をめぐる歴史もあり、古代の祭祀・生産・地域文化のつながりを紹介します。', sourceName: '徳島県立博物館（忌部神社の由来）', sourceUrl: 'https://museum.bunmori.tokushima.jp/museum_documents/museumnews/mnews058/058_7_qa.html' })
  ,makeNationalSpot({ id: 'religious-275', name: '霧島東神社', category: 'religious', region: '九州・沖縄', coordinate: { latitude: 31.8890, longitude: 130.9880, elevationMeter: 500 }, era: 'ancient', eraLabel: '崇神天皇の時代創建伝承・霧島六社権現', religiousType: '神社・霧島山岳信仰・修験道', summary: '高千穂峰と天逆鉾を信仰の核心とする、霧島東側の山岳霊場です。', description: '霧島東神社は霧島六社権現の一つで、高千穂峰山頂を飛地境内とし、天孫降臨の伝説に結びつく天逆鉾を社宝とします。霧島修験の拠点、祓川神楽、火山と森への信仰から、南九州の山岳宗教を紹介します。', sourceName: '宮崎県公式観光サイト（霧島東神社）', sourceUrl: 'https://www.kanko-miyazaki.jp/spot/1065' })
  ,makeNationalSpot({ id: 'religious-276', name: '大法寺', category: 'religious', region: '中部', coordinate: { latitude: 36.3700, longitude: 138.1300, elevationMeter: 650 }, era: 'asuka', eraLabel: '大宝年間（701～704年）創建伝承・国宝三重塔', religiousType: '寺院・天台宗・国宝建築と観音信仰', summary: '「見返りの塔」と呼ばれる国宝三重塔を伝える、信州の古刹です。', description: '大法寺は大宝年間に東山道の駅寺として創建されたと伝わり、1300年の法灯を受け継いでいます。正慶2年（1333年）の国宝三重塔、十一面観音、信州の山里の景観から、巡礼と地域文化を紹介します。', sourceName: '大法寺 公式サイト（国宝三重塔）', sourceUrl: 'https://www.daihoujitemple.com/' })
  ,makeNationalSpot({ id: 'castle-203', name: '横手城跡', category: 'castle', region: '東北', coordinate: { latitude: 39.3080, longitude: 140.5640, elevationMeter: 100 }, era: 'sengoku', eraLabel: '16世紀中頃築城伝承・小野寺氏の平山城', castleType: '城跡・平山城・戊辰戦争の舞台', summary: '小野寺氏から佐竹氏へ受け継がれ、戊辰戦争で落城した秋田南部の城跡です。', description: '横手城は1550年頃に小野寺氏が築いたと伝わり、横手川と山地を生かした平山城として発展しました。戊辰戦争で落城した後、城跡は公園となり、秋田神社の鎮座地にもつながります。城下町と地域の慰霊・記憶を紹介します。', sourceName: '横手市公式サイト（横手公園展望台・横手城）', sourceUrl: 'https://www.city.yokote.lg.jp/kanko/1004048/1004531.html' })
  ,makeNationalSpot({ id: 'castle-204', name: '三春城跡', category: 'castle', region: '東北', coordinate: { latitude: 37.4430, longitude: 140.4920, elevationMeter: 410 }, era: 'sengoku', eraLabel: '戦国期の田村氏居城・三春藩の城下町', castleType: '城跡・平山城・田村氏と三春藩', summary: '田村氏と近世の三春藩を重ねて伝える、城下町を見下ろす城跡です。', description: '三春城跡は戦国期の田村氏の居城として機能し、近世には三春藩の政治拠点となりました。試掘調査で江戸時代初期の石垣が確認されるなど、城郭の変遷をたどることができます。', sourceName: '三春町公式サイト（令和7年度試掘調査）', sourceUrl: 'https://www.town.miharu.fukushima.jp/soshiki/19/miharujyoatokekka-2025.html' })
  ,makeNationalSpot({ id: 'castle-205', name: '佐和山城跡', category: 'castle', region: '近畿', coordinate: { latitude: 35.2780, longitude: 136.2580, elevationMeter: 233 }, era: 'sengoku', eraLabel: '石田三成の居城・姉川合戦と関ヶ原の記憶', castleType: '城跡・山城・中世城郭', summary: '浅井・織田・石田三成らの攻防を伝える、近江の要衝の山城です。', description: '佐和山城跡は近江の境目の城として戦乱を重ね、姉川合戦では浅井勢が籠城しました。石田三成の時代には山上の曲輪と城下町を備えた大城郭となり、彦根城築城に伴う移材から城郭の継承を紹介します。', sourceName: '彦根市公式サイト（佐和山城）', sourceUrl: 'https://www.city.hikone.lg.jp/kanko/event/7/24690.html' })
  ,makeNationalSpot({ id: 'castle-207', name: '田辺城跡（舞鶴）', category: 'castle', region: '近畿', coordinate: { latitude: 35.4430, longitude: 135.3270, elevationMeter: 8 }, era: 'sengoku', eraLabel: '天正10年（1582年）細川幽斎築城・田辺籠城戦', castleType: '城跡・平城・丹後の政治拠点', summary: '細川幽斎の田辺籠城戦と舞鶴の城下町形成を伝える城跡です。', description: '田辺城跡は本能寺の変後に細川幽斎が築き、細川・京極・牧野氏の居城として約290年間、丹後の統治拠点となりました。関ヶ原の前哨戦となった田辺籠城戦と、舞鶴の地名の由来から、城と地域の歴史を紹介します。', sourceName: '舞鶴市公式サイト（田辺城資料館）', sourceUrl: 'https://www.city.maizuru.kyoto.jp/kyouiku/0000012192.html' })
  ,makeNationalSpot({ id: 'religious-277', name: '湯倉神社', category: 'religious', region: '北海道', coordinate: { latitude: 41.7801, longitude: 140.7810, elevationMeter: 12 }, era: 'edo', eraLabel: '承応年間（1650年代）創祀伝承・湯の川温泉発祥の地', religiousType: '神社・温泉信仰・函館の鎮守', summary: '湯の川温泉の発祥地に鎮座し、温泉と薬師信仰の記憶を伝える函館の古社です。', description: '湯倉神社は、境内に湧いた温泉で松前藩主の嗣子が快癒したことを契機に社殿が整えられたと伝わります。大己貴神と少彦名神を祀り、温泉地の成立と地域の祈りが重なる拠点として紹介します。', sourceName: '北海道神社庁（湯倉神社）', sourceUrl: 'https://hokkaidojinjacho.jp/%E6%B9%AF%E5%80%89%E7%A5%9E%E7%A4%BE/' })
  ,makeNationalSpot({ id: 'religious-278', name: '日光二荒山神社', category: 'religious', region: '関東', coordinate: { latitude: 36.7580, longitude: 139.5980, elevationMeter: 650 }, era: 'nara', eraLabel: '日光山信仰の古社・下野国一之宮', religiousType: '神社・日光三山の山岳信仰', summary: '男体山など日光三山を神体山とする、日光山信仰の中心です。', description: '日光二荒山神社は日光山信仰の始まりとなった古社で、男体山をはじめとする日光三山を神体山として祀ってきました。下野国一之宮としての信仰、神橋を含む世界遺産「日光の社寺」の景観から、山岳信仰と門前の歴史を紹介します。', sourceName: '日光市公式サイト（二荒山神社）', sourceUrl: 'https://www.city.nikko.lg.jp/soshiki/10/1041/1_1/2/2430.html' })
  ,makeNationalSpot({ id: 'religious-279', name: '宇都宮二荒山神社', category: 'religious', region: '関東', coordinate: { latitude: 36.5658, longitude: 139.8835, elevationMeter: 135 }, era: 'ancient', eraLabel: '下野国一之宮・宇都宮の総鎮守', religiousType: '神社・下野国一之宮・都市の鎮守', summary: '宇都宮の中心に鎮座し、下野国の政治と信仰の核となってきた古社です。', description: '宇都宮二荒山神社は、日光二荒山神社とは別の、宇都宮の中心に鎮座する神社です。下野国一之宮としての社格と、城下町・門前町の形成を重ねて、地域の守護と都市史を紹介します。', sourceName: '宇都宮二荒山神社 公式サイト', sourceUrl: 'https://futaarayamajinja.jp/' })
  ,makeNationalSpot({ id: 'religious-280', name: '伊奈波神社', category: 'religious', region: '中部', coordinate: { latitude: 35.4320, longitude: 136.7680, elevationMeter: 35 }, era: 'ancient', eraLabel: '美濃国の古社・五十瓊敷入彦命を祀る', religiousType: '神社・美濃国の総鎮守', summary: '金華山の西麓に鎮座し、岐阜の地名と地域の記憶に結びつく古社です。', description: '伊奈波神社は五十瓊敷入彦命を祀る美濃の古社で、金華山・岐阜城下と近接する立地から、地域の鎮守として崇敬を集めてきました。長い由緒と祭礼を通じて、岐阜の都市形成と古代の信仰を紹介します。', sourceName: '伊奈波神社 公式サイト（御由緒）', sourceUrl: 'https://www.inabasan.com/about/' })
  ,makeNationalSpot({ id: 'religious-281', name: '近江神宮', category: 'religious', region: '近畿', coordinate: { latitude: 35.0340, longitude: 135.8520, elevationMeter: 105 }, era: 'showa', eraLabel: '昭和15年（1940年）創建・天智天皇と大津京', religiousType: '神社・天智天皇を祀る・時の祖神', summary: '大津京を開いた天智天皇を祀り、時計と百人一首の文化も伝える神宮です。', description: '近江神宮は大津京を開いた天智天皇を御祭神とし、近江大津宮跡に近い地に鎮座します。漏刻にちなむ時計文化やかるた祭などを通じて、古代の都と近代以降の文化的な記憶が重なる拠点を紹介します。', sourceName: '滋賀県神社庁（近江神宮）', sourceUrl: 'https://www.shiga-jinjacho.jp/ycBBS/Board.cgi/02_jinja_db/db/ycDB_02jinja-pc-detail.html?mode%3Aview=1&view%3Aoid=51' })
  ,makeNationalSpot({ id: 'religious-282', name: '廣瀬大社', category: 'religious', region: '近畿', coordinate: { latitude: 34.5810, longitude: 135.7380, elevationMeter: 46 }, era: 'asuka', eraLabel: '天武天皇4年（675年）祭祀の記録・水神信仰', religiousType: '神社・河川の水神・大忌神', summary: '大和盆地の河川が集まる地で、水の恵みと災いを祈る古代祭祀を伝える大社です。', description: '廣瀬大社は大和川水系の合流域に鎮座し、『日本書紀』に天武天皇4年（675年）、廣瀬の河曲で大忌神を祀った記録が残ります。河川と農耕をめぐる水の信仰、砂かけ祭などの祭礼から、古代から続く地域の祈りを紹介します。', sourceName: '奈良県公式サイト（廣瀬神社）', sourceUrl: 'https://www.pref.nara.lg.jp/ikasu-nara/bunkashigen/main00251.html' })
  ,makeNationalSpot({ id: 'religious-283', name: '物部神社', category: 'religious', region: '中国', coordinate: { latitude: 35.1700, longitude: 132.5000, elevationMeter: 35 }, era: 'asuka', eraLabel: '継体天皇8年（513年）社殿創建伝承・石見国一宮', religiousType: '神社・石見国一之宮・物部氏の祖神', summary: '物部氏の祖神を祀り、石見の国土開拓と鎮魂祭の起源を伝える一宮です。', description: '物部神社は石見国一之宮で、物部氏の祖神とされる宇摩志麻遅命を祀ります。国土開拓の伝承や、御祭神が鎮魂宝寿を祈願したという由緒から、古代氏族・祭祀・地域の平安を結ぶ信仰拠点を紹介します。', sourceName: '石見国一宮 物部神社 公式サイト', sourceUrl: 'https://www.mononobe-jinja.jp/about/' })
  ,makeNationalSpot({ id: 'religious-284', name: '宇美八幡宮', category: 'religious', region: '九州・沖縄', coordinate: { latitude: 33.5680, longitude: 130.5120, elevationMeter: 45 }, era: 'asuka', eraLabel: '敏達天皇の御宇（570年代）創建伝承・応神天皇降誕の聖地', religiousType: '神社・八幡信仰・安産育児の拠点', summary: '応神天皇降誕の伝承と、安産・育児の信仰を受け継ぐ筑前の古社です。', description: '宇美八幡宮は、神功皇后が応神天皇を産んだ地と伝えられ、敏達天皇の時代に創建されたとされます。湯蓋の森・衣掛の森などの大樟、子安の石や宇美神楽を通じて、生命の誕生と森の信仰が結びつく景観を紹介します。', sourceName: '宇美八幡宮 公式サイト（由緒）', sourceUrl: 'https://www.umi-hachimangu.or.jp/about/' })
  ,makeNationalSpot({ id: 'religious-285', name: '大分八幡宮', category: 'religious', region: '九州・沖縄', coordinate: { latitude: 33.5660, longitude: 130.6840, elevationMeter: 75 }, era: 'nara', eraLabel: '神亀3年（726年）創始伝承・鎮西の八幡信仰', religiousType: '神社・八幡信仰・筑前穂波の鎮守', summary: '宇佐と太宰府を結ぶ道筋に鎮座し、九州の八幡信仰の広がりを伝える古社です。', description: '大分八幡宮は、神功皇后の伝承と神亀3年（726年）の社殿造営に結びつく神社です。宇佐・太宰府・筑前を結ぶ交通の要所で育まれた八幡信仰から、地域の守護と九州の歴史的な往来を紹介します。', sourceName: '大分八幡宮 公式サイト（由緒と歴史）', sourceUrl: 'https://www.daibu-hachiman.com/yuisho.html' })
  ,makeNationalSpot({ id: 'castle-208', name: '宮津城跡', category: 'castle', region: '近畿', coordinate: { latitude: 35.5350, longitude: 135.1960, elevationMeter: 5 }, era: 'sengoku', eraLabel: '細川藤孝築城・丹後の海城と城下町', castleType: '城跡・平城・丹後の政治と海運の拠点', summary: '宮津湾と大手川の河口に築かれ、丹後の政治と海運を支えた城跡です。', description: '宮津城は細川藤孝が築き、京極氏の時代を経て丹後の政治拠点となりました。宮津湾と大手川に面する立地、発掘された堀や石垣の痕跡から、海と城下町が結びついた近世城郭を紹介します。', sourceName: '宮津市公式サイト（宮津城跡）', sourceUrl: 'https://www.city.miyazu.kyoto.jp/site/citypro/5069.html' })
  ,makeNationalSpot({ id: 'castle-209', name: '出石城跡', category: 'castle', region: '近畿', coordinate: { latitude: 35.4630, longitude: 134.8710, elevationMeter: 55 }, era: 'edo', eraLabel: '慶長9年（1604年）築城・但馬の城下町', castleType: '城跡・山城と平山城・出石藩の拠点', summary: '小出吉英が築き、城下町出石の景観とともに受け継がれる但馬の城跡です。', description: '出石城跡は、江戸時代初期に小出吉英が築いた城郭で、山上の有子山城と山麓の城を組み合わせた構成を持ちます。石垣や登城門、城下町の町割りから、但馬の政治拠点と近世の観光文化を紹介します。', sourceName: '豊岡市公式サイト（出石城跡）', sourceUrl: 'https://www.city.toyooka.lg.jp/1019810/1019854/1019861/1002168.html' })
  ,makeNationalSpot({ id: 'castle-210', name: '加納城跡', category: 'castle', region: '中部', coordinate: { latitude: 35.3980, longitude: 136.7560, elevationMeter: 15 }, era: 'edo', eraLabel: '慶長5年（1600年）築城・関ヶ原後の西国備え', castleType: '城跡・平城・加納藩の政治拠点', summary: '関ヶ原後の徳川家康が西国への備えとして築かせた、岐阜の平城跡です。', description: '加納城は関ヶ原の合戦後、西に備える要衝として本多忠勝に築かせたのが起源とされます。本丸・二の丸などを備えた平城で、現在は石垣や門跡が加納公園に残り、城下町と近世政治の歴史をたどれます。', sourceName: '岐阜県公式サイト（加納城跡）', sourceUrl: 'https://www.pref.gifu.lg.jp/page/365938.html' })
  ,makeNationalSpot({ id: 'religious-286', name: '四天王寺', category: 'religious', region: '近畿', coordinate: { latitude: 34.6545, longitude: 135.5162, elevationMeter: 12 }, era: 'asuka', eraLabel: '推古天皇元年（593年）建立・日本仏法最初の官寺', religiousType: '寺院・和宗総本山・聖徳太子信仰', summary: '聖徳太子ゆかりの伽藍と救済事業を受け継ぐ、日本最古級の仏教拠点です。', description: '四天王寺は、物部守屋との戦いに際して聖徳太子が誓願し、推古天皇元年（593年）に建立したと伝わります。中門・塔・金堂・講堂を一直線に置く四天王寺式伽藍配置と、施薬・療病・悲田の事業を通じて、古代国家の仏教と社会救済の歴史を紹介します。', sourceName: '和宗総本山 四天王寺 公式サイト（歴史）', sourceUrl: 'https://www.shitennoji.or.jp/history.html' })
  ,makeNationalSpot({ id: 'religious-287', name: '西宮神社', category: 'religious', region: '近畿', coordinate: { latitude: 34.7369, longitude: 135.3375, elevationMeter: 5 }, era: 'ancient', eraLabel: 'えびす信仰の総本社・西宮の鎮守', religiousType: '神社・えびす宮総本社・福の神信仰', summary: 'えびすさまを祀る全国の社へ信仰を広げてきた、阪神地域の総本社です。', description: '西宮神社は、えびす大神を中心に祀るえびす宮総本社です。大阪湾から神像が出現したという由緒と、江戸時代に御神影札が全国へ広がった歴史から、港・商業・福の神信仰が結びつく宗教拠点を紹介します。', sourceName: 'えびす宮総本社 西宮神社 公式サイト（由緒）', sourceUrl: 'https://nishinomiya-ebisu.com/about/' })
  ,makeNationalSpot({ id: 'religious-288', name: '宇倍神社', category: 'religious', region: '中国', coordinate: { latitude: 35.4930, longitude: 134.2330, elevationMeter: 30 }, era: 'asuka', eraLabel: '大化4年（648年）創建伝承・因幡国一之宮', religiousType: '神社・因幡国一之宮・武内宿禰信仰', summary: '因幡国一之宮として崇敬を集め、武内宿禰命と麒麟獅子舞を伝える古社です。', description: '宇倍神社は大化4年（648年）の創建伝承を持ち、延喜式では因幡国の名神大社として記録されています。武内宿禰命への信仰、歴代鳥取藩主の崇敬、山陰の麒麟獅子舞を通じて、古代の社格と地域文化を紹介します。', sourceName: '宇倍神社 公式サイト（由緒）', sourceUrl: 'https://www.ubejinja.or.jp/new-about/' })
  ,makeNationalSpot({ id: 'religious-289', name: '貴船神社', category: 'religious', region: '近畿', coordinate: { latitude: 35.1210, longitude: 135.7620, elevationMeter: 270 }, era: 'asuka', eraLabel: '白鳳6年の社殿御造替伝承・鴨川源流の水神', religiousType: '神社・水神信仰・貴布禰総本宮', summary: '鴨川の源流に鎮座し、雨・水の恵みと縁結びの信仰を集める山峡の古社です。', description: '貴船神社は貴船川の源流に鎮座し、水の供給を司る高龗神を祀ります。創建年代は不詳ながら、白鳳6年の社殿御造替伝承や奥宮の水神信仰が伝わり、農漁業・醸造・縁結びへ広がった信仰の歴史を紹介します。', sourceName: '貴布禰総本宮 貴船神社 公式サイト（由緒）', sourceUrl: 'https://kifunejinja.jp/sp/history.html' })
  ,makeNationalSpot({ id: 'religious-290', name: '日枝神社（東京・赤坂）', category: 'religious', region: '関東', coordinate: { latitude: 35.6746, longitude: 139.7394, elevationMeter: 28 }, era: 'sengoku', eraLabel: '文明10年（1478年）江戸城内勧請・山王信仰', religiousType: '神社・江戸総鎮守・山王信仰', summary: '江戸城と徳川家、江戸の町の守護神として崇敬されてきた東京の大社です。', description: '日枝神社は、江戸氏の山王宮を起源とし、文明10年（1478年）に太田道灌が江戸城内へ勧請した由緒を伝えます。徳川家の産神、江戸郷の総氏神としての歴史と山王祭から、都市の守護神が形成される過程を紹介します。', sourceName: '日枝神社 公式サイト（由緒）', sourceUrl: 'https://www.hiejinja.net/about/' })
  ,makeNationalSpot({ id: 'religious-291', name: '靖国神社', category: 'religious', region: '関東', coordinate: { latitude: 35.6948, longitude: 139.7435, elevationMeter: 24 }, era: 'meiji', eraLabel: '明治2年（1869年）創建・戦没者慰霊の場', religiousType: '神社・招魂祭祀・近代日本の記憶', summary: '近代日本の戦没者慰霊と記憶をめぐる、東京の宗教・歴史拠点です。', description: '靖国神社は明治2年（1869年）の東京招魂社を起源とし、明治12年（1879年）に靖国神社と改称されました。戦没者を祀る祭祀の成立と、近代国家・戦争・慰霊をめぐる複雑な歴史を、評価を一方向に固定せず記録として紹介します。', sourceName: '千代田区公式資料（靖国神社本殿）', sourceUrl: 'https://www.city.chiyoda.lg.jp/koho/machizukuri/kekan/documents/9-1-yasukunijinjahonden.pdf' })
  ,makeNationalSpot({ id: 'castle-211', name: '大坂城跡', category: 'castle', region: '近畿', coordinate: { latitude: 34.6873, longitude: 135.5260, elevationMeter: 24 }, era: 'sengoku', eraLabel: '天正11年（1583年）豊臣秀吉築城・特別史跡', castleType: '城跡・平城・豊臣・徳川期の大城郭', summary: '大坂本願寺・豊臣・徳川の歴史が重なる、日本を代表する特別史跡です。', description: '大坂城跡は大坂本願寺の旧地に豊臣秀吉が築き、徳川期の再築を経た大城郭です。石垣・堀・本丸などの遺構と、寺内町から近世城下町へ移る変化を通じて、宗教拠点と政治都市が重なった大阪の歴史を紹介します。', sourceName: '大阪府公式サイト（大坂城跡）', sourceUrl: 'https://www.pref.osaka.lg.jp/o180150/bunkazaihogo/bunkazai/oosakajoukouen.html' })
  ,makeNationalSpot({ id: 'castle-212', name: '山口城跡（山口藩庁跡）', category: 'castle', region: '中国', coordinate: { latitude: 34.1830, longitude: 131.4740, elevationMeter: 35 }, era: 'bakumatsu', eraLabel: '元治元年（1864年）築造・幕末の藩庁', castleType: '城跡・近代的城郭・幕末政治の拠点', summary: '萩藩主毛利敬親が幕末に築いた、砲撃戦を想定した新たな藩庁跡です。', description: '山口城跡は元治元年（1864年）、萩城に代わる新たな居城・藩庁として建設されました。史料に「山口新屋形」と記される一方、西洋式城郭の要素を備えた幕末の政治・軍事拠点として、明治維新前夜の地域史を紹介します。', sourceName: '山口県公式サイト（山口城跡発掘調査）', sourceUrl: 'https://www.pref.yamaguchi.lg.jp/soshiki/97/246080.html' })
  ,makeNationalSpot({ id: 'castle-213', name: '甲府城跡（舞鶴城公園）', category: 'castle', region: '中部', coordinate: { latitude: 35.6670, longitude: 138.5680, elevationMeter: 300 }, era: 'sengoku', eraLabel: '戦国末期築城・甲斐の近世政治拠点', castleType: '城跡・平山城・舞鶴城公園', summary: '天守台や野面積み石垣を残し、甲斐の近世政治を伝える国史跡です。', description: '甲府城跡は戦国末期に築かれ、近世には甲斐を統治する政治・軍事の拠点となりました。天守台・本丸と階層的な曲輪、築城期の野面積み石垣が残り、現在の舞鶴城公園から城郭の構造と城下町の歴史を紹介します。', sourceName: '山梨県公式サイト（甲府城跡保存活用計画）', sourceUrl: 'https://www.pref.yamanashi.jp/bunka/maibun/kofuzyouato_hozonkatsuyoukeikaku.html' })
  ,makeNationalSpot({ id: 'religious-292', name: '叡福寺', category: 'religious', region: '近畿', coordinate: { latitude: 34.5070, longitude: 135.6550, elevationMeter: 85 }, era: 'asuka', eraLabel: '聖徳太子御廟・太子信仰の中核', religiousType: '寺院・聖徳太子御廟・太子信仰', summary: '聖徳太子の御廟を守り、四天王寺・法隆寺と並ぶ太子信仰の霊場です。', description: '叡福寺は境内に聖徳太子御廟（磯長廟）を擁し、太子没後に御廟を守る香華寺として始まったと伝わります。空海・親鸞・日蓮など多くの僧が参籠した大乗仏教の聖地として、人物への追慕が宗教文化へ広がる過程を紹介します。', sourceName: '上之太子 叡福寺 公式サイト（由緒）', sourceUrl: 'https://eifukuji-taishi.jp/about.php/tour.php' })
  ,makeNationalSpot({ id: 'religious-293', name: '諏訪大社 下社秋宮', category: 'religious', region: '中部', coordinate: { latitude: 36.0760, longitude: 138.0820, elevationMeter: 760 }, era: 'ancient', eraLabel: '信濃国一之宮・御柱祭の四宮', religiousType: '神社・諏訪信仰・下社秋宮', summary: '諏訪大社四宮の一つで、御柱祭と本殿を持たない古い祭祀形式を伝えます。', description: '諏訪大社下社秋宮は、春宮とともに御霊代が半年ごとに遷座する下社の宮です。御神木を拝する社殿構成、御柱祭、旧中山道と甲州道中が交わる立地から、山・水・交通が結びつく諏訪信仰を紹介します。', sourceName: '信濃國一之宮 諏訪大社 公式サイト（下社秋宮）', sourceUrl: 'https://suwataisha.or.jp/about/miyamori/shimoshaakimiya/' })
  ,makeNationalSpot({ id: 'religious-294', name: '海神神社', category: 'religious', region: '九州・沖縄', coordinate: { latitude: 34.4740, longitude: 129.2740, elevationMeter: 80 }, era: 'ancient', eraLabel: '対馬国一宮・国境の海上信仰', religiousType: '神社・対馬国一之宮・海上守護', summary: '対馬の西海岸に鎮座し、朝鮮半島との交流を示す文化財を伝える古社です。', description: '海神神社は長崎県対馬市峰町木坂に鎮座する古社で、対馬の海上交通と大陸交流を考える重要な宗教拠点です。境内に伝わる高麗・李朝関係資料や新羅仏などの文化財から、海を越えた信仰と文化の往来を紹介します。', sourceName: '長崎県神社庁・長崎県文化財データベース（海神神社）', sourceUrl: 'https://www.nagasaki-jinjacho.or.jp/search-tsushima.html' })
  ,makeNationalSpot({ id: 'religious-295', name: '由良比女神社', category: 'religious', region: '中国', coordinate: { latitude: 36.1000, longitude: 133.0300, elevationMeter: 8 }, era: 'heian', eraLabel: '承和9年（842年）官社・隠岐国一之宮', religiousType: '神社・隠岐国一之宮・海上守護', summary: '隠岐国一之宮として、海上安全と「イカ寄せ」の祭りを伝える島の古社です。', description: '由良比女神社は承和9年（842年）に官社に預かり、平安時代末期には隠岐国一之宮と定められたと伝わります。由良の浜にイカが寄るという伝承や海上渡御祭から、島の海・漁業・祭礼が結びつく信仰を紹介します。', sourceName: '島根県神社庁（由良比女神社）', sourceUrl: 'https://www.shimane-jinjacho.or.jp/nishinoshima/14644cfc44073745c06a699475a0d3cdc4f675ec.html' })
  ,makeNationalSpot({ id: 'religious-296', name: '大聖勝軍寺', category: 'religious', region: '近畿', coordinate: { latitude: 34.6060, longitude: 135.6060, elevationMeter: 20 }, era: 'asuka', eraLabel: '聖徳太子ゆかり・下の太子の霊場', religiousType: '寺院・聖徳太子信仰・河内の古刹', summary: '物部守屋との戦いにまつわる聖徳太子伝承を受け継ぐ、河内の太子信仰の寺院です。', description: '大聖勝軍寺は「下の太子」と呼ばれ、聖徳太子と物部守屋の戦いに結びつく寺伝を伝えます。四天王寺・叡福寺とつながる太子信仰の霊場として、古代の政治変動と仏教受容の記憶を紹介します。', sourceName: '八尾市公式サイト（大聖勝軍寺）', sourceUrl: 'https://www.city.yao.osaka.jp/0000067606.html' })
  ,makeNationalSpot({ id: 'religious-297', name: '海神社', category: 'religious', region: '近畿', coordinate: { latitude: 34.6300, longitude: 135.0530, elevationMeter: 8 }, era: 'ancient', eraLabel: '神功皇后伝承・垂水の海上守護', religiousType: '神社・海神信仰・航海安全', summary: '明石海峡に面し、海上交通と安産の信仰を集めてきた神戸の古社です。', description: '海神社は、神功皇后が綿津見三神を祀ったことを鎮座の由来と伝えます。垂水の海と明石海峡を望む立地から、水産業・農業・航海安全・安産の祈りが重なる海辺の宗教拠点を紹介します。', sourceName: '海神社 公式サイト（由緒）', sourceUrl: 'https://kaijinjya.jp/' })
  ,makeNationalSpot({ id: 'castle-214', name: '高槻城跡', category: 'castle', region: '近畿', coordinate: { latitude: 34.8480, longitude: 135.6170, elevationMeter: 12 }, era: 'sengoku', eraLabel: '高山右近の城下町・北摂の近世城郭', castleType: '城跡・平城・キリシタン史の舞台', summary: '高山右近のキリシタン保護と江戸期の藩政を重ねて伝える北摂の城跡です。', description: '高槻城は南北朝期の居館を起源とし、戦国期に和田惟政・高山右近が城郭を整えました。右近がキリスト教を保護した時代と、江戸時代の高槻藩政、発掘された石垣・上水道の遺構から、城が宗教と都市生活の舞台になった歴史を紹介します。', sourceName: '高槻市公式サイト（高槻城跡）', sourceUrl: 'https://www.city.takatsuki.osaka.jp/site/history/4558.html' })
  ,makeNationalSpot({ id: 'castle-215', name: '膳所城跡', category: 'castle', region: '近畿', coordinate: { latitude: 34.9860, longitude: 135.8870, elevationMeter: 85 }, era: 'edo', eraLabel: '慶長6年（1601年）築城・日本三大湖城の一つ', castleType: '城跡・水城・膳所藩の拠点', summary: '琵琶湖畔に築かれ、城門の移築遺構も残る水城の城跡です。', description: '膳所城は関ヶ原合戦の翌年、徳川家康の命で大津城を移築して築かれたとされます。琵琶湖に突き出す本丸と城下町、膳所神社などに残る移築門から、湖上交通と近世の城郭支配を紹介します。', sourceName: '大津市公式サイト（膳所城跡）', sourceUrl: 'https://www5.city.otsu.shiga.jp/kankyou/content.asp?key=0405000000&skey=7' })
  ,makeNationalSpot({ id: 'castle-216', name: '芥川城跡', category: 'castle', region: '近畿', coordinate: { latitude: 34.8840, longitude: 135.5900, elevationMeter: 180 }, era: 'sengoku', eraLabel: '三好長慶の居城・畿内政治と文化の舞台', castleType: '城跡・山城・三好政権の拠点', summary: '三好長慶が畿内政権を運営した、北摂の山城跡です。', description: '芥川城跡は三好長慶の政治・文化の舞台となった山城で、畿内の戦国政治を考えるうえで重要な遺跡です。山上の城郭と高槻城との役割の違いから、戦国期に城が政権運営と地域支配を担った過程を紹介します。', sourceName: '高槻市公式資料（文化財保存活用地域計画）', sourceUrl: 'https://www.city.takatsuki.osaka.jp/uploaded/attachment/28494.pdf' })
  ,makeNationalSpot({ id: 'religious-298', name: '熊野大社（山形）', category: 'religious', region: '東北', coordinate: { latitude: 38.0650, longitude: 140.1450, elevationMeter: 250 }, era: 'heian', eraLabel: '大同元年（806年）再建伝承・日本三熊野', religiousType: '神社・熊野信仰・東北の伊勢', summary: '熊野修験と伊達・上杉の信仰を受け継ぐ、山形の「東北の伊勢」です。', description: '熊野大社は大同元年（806年）、平城天皇の勅命により再建されたと伝わる日本三熊野の一つです。天台宗・真言宗・羽黒修験・神道が重なった霊場の歴史と、上杉・伊達の武将からの崇敬を通じて、東北における熊野信仰を紹介します。', sourceName: '熊野大社 公式サイト（御由緒）', sourceUrl: 'https://kumano-taisha.or.jp/kamisama/history/' })
  ,makeNationalSpot({ id: 'religious-299', name: '早池峯神社', category: 'religious', region: '東北', coordinate: { latitude: 39.4370, longitude: 141.5750, elevationMeter: 420 }, era: 'heian', eraLabel: '早池峰山岳信仰・修験と神楽の霊場', religiousType: '神社・山岳信仰・早池峰神楽', summary: '早池峰山を仰ぐ修験の場として、神楽と山の信仰を伝える遠野の古社です。', description: '早池峯神社は早池峰山周辺の山岳信仰と修験に結びつき、鳥居・山門・拝殿・神殿・奥宮へ続く宗教景観を伝えます。宵宮祭や例祭で奉納される神楽から、東北の山と集落を結ぶ信仰文化を紹介します。', sourceName: '遠野市観光情報（早池峯神社）', sourceUrl: 'https://tonojikan.jp/tourism/hayachine-shrine/' })
  ,makeNationalSpot({ id: 'religious-300', name: '善知鳥神社', category: 'religious', region: '東北', coordinate: { latitude: 40.8260, longitude: 140.7400, elevationMeter: 5 }, era: 'heian', eraLabel: '大同2年（807年）再建伝承・青森総鎮守', religiousType: '神社・宗像三女神・港町の鎮守', summary: '青森市発祥の地とされ、宗像三女神を祀る北国の海辺の古社です。', description: '善知鳥神社は、善知鳥村と呼ばれた時代に宗像三女神を祀ったことを起源とし、大同2年（807年）に坂上田村麻呂が再建したと伝わります。青森の港と町の形成、交通安全・海上安全の祈りが重なる総鎮守として紹介します。', sourceName: '善知鳥神社 公式サイト（由緒）', sourceUrl: 'https://utojinja.sakura.ne.jp/info.html' })
  ,makeNationalSpot({ id: 'religious-301', name: '盛岡八幡宮', category: 'religious', region: '東北', coordinate: { latitude: 39.7010, longitude: 141.1540, elevationMeter: 125 }, era: 'heian', eraLabel: '康平5年（1062年）創建伝承・盛岡の総鎮守', religiousType: '神社・八幡信仰・城下町の祭礼', summary: '盛岡城下の八幡信仰と、藩主が祭主を務めた大祭を伝える総鎮守です。', description: '盛岡八幡宮は、康平5年（1062年）に源頼義が石清水八幡宮の分霊を勧請したことを起源とする伝承を持ちます。盛岡藩南部氏の城下町で領内第一の祭礼を担った歴史から、八幡信仰と城下町の共同体を紹介します。', sourceName: '盛岡八幡宮 公式サイト（歴史）', sourceUrl: 'https://morioka8man.jp/history/' })
  ,makeNationalSpot({ id: 'religious-302', name: '諏訪大社 下社春宮', category: 'religious', region: '中部', coordinate: { latitude: 36.0830, longitude: 138.0860, elevationMeter: 760 }, era: 'ancient', eraLabel: '信濃国一之宮・下社春宮の古社殿', religiousType: '神社・諏訪信仰・下社春宮', summary: '御神木を拝する古い祭祀形式と、旧中山道の参詣景観を伝える諏訪大社の一宮です。', description: '諏訪大社下社春宮は、秋宮とともに御霊代が遷座する下社の宮です。本殿を持たず杉の木を御神木として拝する形式、室町時代建立とされる下馬橋、万治の大鳥居から、諏訪の原始信仰と参詣道の歴史を紹介します。', sourceName: '信濃國一之宮 諏訪大社 公式サイト（下社春宮）', sourceUrl: 'https://suwataisha.or.jp/about/miyamori/shimoshaharumiya/' })
  ,makeNationalSpot({ id: 'religious-303', name: '山口大神宮', category: 'religious', region: '中国', coordinate: { latitude: 34.1780, longitude: 131.4730, elevationMeter: 35 }, era: 'sengoku', eraLabel: '永正17年（1520年）創建・西のお伊勢さま', religiousType: '神社・伊勢信仰・山口の総鎮守', summary: '伊勢神宮の分霊を祀り、遠方の人々が参拝した「西のお伊勢さま」です。', description: '山口大神宮は永正17年（1520年）、大内義興が伊勢神宮の分霊を山口へ勧請して創建したと伝わります。伊勢まで赴けない西国の人々の参詣を集めた歴史から、戦国大名の都市形成と近世の伊勢信仰を紹介します。', sourceName: '山口大神宮 公式サイト', sourceUrl: 'https://www.yamaguchi-daijingu.or.jp/' })
  ,makeNationalSpot({ id: 'castle-217', name: '古宮城跡', category: 'castle', region: '中部', coordinate: { latitude: 34.9890, longitude: 137.4330, elevationMeter: 535 }, era: 'sengoku', eraLabel: '元亀3年（1572年）頃築城・武田氏の山城', castleType: '城跡・山城・続日本100名城', summary: '武田信玄が築いたとされ、白鳥神社を抱く独立丘陵の山城跡です。', description: '古宮城跡は元亀3年（1572年）頃、武田信玄が築き馬場信春が縄張りを行ったと伝わる城跡です。独立丘陵を二つの曲輪に分ける堀切や土塁、城内に鎮座する白鳥神社から、戦国の軍事拠点と地域の信仰景観を紹介します。', sourceName: '新城市公式サイト（古宮城跡）', sourceUrl: 'https://www.city.shinshiro.lg.jp/kanko/meisyo/furumiyajyoato.html' })
  ,makeNationalSpot({ id: 'castle-218', name: '亀山城跡（作手）', category: 'castle', region: '中部', coordinate: { latitude: 34.9950, longitude: 137.4730, elevationMeter: 500 }, era: 'sengoku', eraLabel: '応永31年（1424年）築城・奥平氏の軍事拠点', castleType: '城跡・平山城・奥三河の戦国城郭', summary: '奥平氏の居城として築かれ、武田・徳川の攻防を伝える奥三河の城跡です。', description: '亀山城跡は応永31年（1424年）に奥平貞俊が築いたとされ、後に武田氏と徳川氏の攻防の舞台となりました。周辺に古宮城や文殊山城などが連なる城郭ネットワークから、山間地域の軍事と領主支配を紹介します。', sourceName: '新城市公式サイト（亀山城跡）', sourceUrl: 'https://www.city.shinshiro.lg.jp/kanko/meisyo/kameyamajyoato.html' })
  ,makeNationalSpot({ id: 'castle-219', name: '亀山城跡（三重）', category: 'castle', region: '中部', coordinate: { latitude: 34.8550, longitude: 136.4500, elevationMeter: 70 }, era: 'sengoku', eraLabel: '天正18年（1590年）築城・東海道の城下町', castleType: '城跡・平山城・県史跡・現存多門櫓', summary: '東海道の宿場町を見下ろし、三重県唯一の現存城郭建造物を残す城跡です。', description: '亀山城跡は天正18年（1590年）に岡本宗憲が築城し、江戸時代に改修された城跡です。県内唯一の現存城郭建造物とされる多門櫓、高石垣、東海道亀山宿の景観から、街道と城の関係を紹介します。', sourceName: '亀山市観光協会公式サイト（亀山城跡）', sourceUrl: 'https://kameyama-kanko.com/area/kameyama/%E4%BA%80%E5%B1%B1%E5%9F%8E%E8%B7%A1/' })
  ,makeNationalSpot({ id: 'religious-304', name: '千栗八幡宮', category: 'religious', region: '九州・沖縄', coordinate: { latitude: 33.3310, longitude: 130.4420, elevationMeter: 30 }, era: 'nara', eraLabel: '神亀元年（724年）創建伝承・肥前国一宮', religiousType: '神社・八幡信仰・肥前国一之宮', summary: '宇佐八幡の別宮として崇敬され、粥祭や放生会を伝える肥前の一宮です。', description: '千栗八幡宮は神亀元年（724年）、神託を受けて創建されたと伝わり、古くから宇佐神宮の別宮として信仰を集めました。肥前国一宮としての歴史、粥の変化で吉凶を占う御粥祭、放生会から、八幡信仰と農耕儀礼を紹介します。', sourceName: '千栗八幡宮 公式サイト（由緒）', sourceUrl: 'https://chirikuhachiman.sakura.ne.jp/' })
  ,makeNationalSpot({ id: 'religious-305', name: '藤崎八旛宮', category: 'religious', region: '九州・沖縄', coordinate: { latitude: 32.8080, longitude: 130.7120, elevationMeter: 15 }, era: 'heian', eraLabel: '承平5年（935年）創建・熊本総鎮守', religiousType: '神社・八幡信仰・熊本の総鎮守', summary: '平将門の乱の平定祈願に始まり、熊本の町を守ってきた八幡宮です。', description: '藤崎八旛宮は承平5年（935年）、朱雀天皇が平将門の乱の平定を祈願して石清水八幡大神を勧請したことに始まると伝わります。西南戦争による焼失と遷座、熊本の例大祭から、都市の守護と地域の祭礼を紹介します。', sourceName: '藤崎八旛宮 公式サイト（ご由緒）', sourceUrl: 'https://www.fujisakigu.or.jp/index.html' })
  ,makeNationalSpot({ id: 'religious-306', name: '神威神社', category: 'religious', region: '北海道', coordinate: { latitude: 43.3570, longitude: 140.4820, elevationMeter: 15 }, era: 'edo', eraLabel: '神威岬の航海安全伝承・積丹の海の信仰', religiousType: '神社・海上守護・積丹の地域信仰', summary: '神威岩への信仰と航海安全の祈りを伝える、積丹半島の海辺の神社です。', description: '神威神社は、神威岬沖の神威岩に大綿津見神などを祀り、航海の安全を祈願したという伝承を持ちます。アイヌの人々も神威を尊崇したとされる記録から、北海道の海と先住民文化、和人の海上信仰が交わる場を紹介します。', sourceName: '北海道神社庁（神威神社）', sourceUrl: 'https://hokkaidojinjacho.jp/%E7%A5%9E%E5%A8%81%E7%A5%9E%E7%A4%BE/' })
  ,makeNationalSpot({ id: 'religious-307', name: '白峯寺', category: 'religious', region: '四国', coordinate: { latitude: 34.3500, longitude: 133.9200, elevationMeter: 280 }, era: 'heian', eraLabel: '四国八十八ヶ所第81番・崇徳上皇の菩提寺', religiousType: '寺院・真言宗御室派・四国遍路', summary: '五色台の山中で四国遍路と崇徳上皇の慰霊が重なる、山岳霊場です。', description: '白峯寺は五色台の白峯山中にある真言宗御室派の寺院で、四国八十八ヶ所第81番札所です。千手観音への巡礼、白峯大権現の山岳信仰、崇徳上皇を祀る頓証寺殿が同じ境内にある構成から、遍路と慰霊の歴史を紹介します。', sourceName: '白峯寺 公式サイト（縁起）', sourceUrl: 'https://www.shiromineji.com/history/' })
  ,makeNationalSpot({ id: 'religious-308', name: '琴崎八幡宮', category: 'religious', region: '中国', coordinate: { latitude: 33.9630, longitude: 131.2780, elevationMeter: 10 }, era: 'heian', eraLabel: '寿永3年（1184年）創建伝承・宇部の八幡信仰', religiousType: '神社・八幡信仰・宇部の総鎮守', summary: '長門国の大社として崇敬を集め、宇部の町の守護を担ってきた八幡宮です。', description: '琴崎八幡宮は寿永3年（1184年）、長門国守護の厚東氏が社殿を建立したことを由緒として伝えます。神社本庁の別表神社としての位置づけと、宇部の地域祭祀・人生儀礼から、八幡信仰の広がりを紹介します。', sourceName: '琴崎八幡宮 公式サイト（由緒）', sourceUrl: 'https://www.kotozaki.com/about' })
  ,makeNationalSpot({ id: 'castle-220', name: '中村城跡（相馬）', category: 'castle', region: '東北', coordinate: { latitude: 37.8020, longitude: 140.9260, elevationMeter: 35 }, era: 'edo', eraLabel: '慶長16年（1611年）築城・相馬氏の居城', castleType: '城跡・平山城・相馬藩の藩政拠点', summary: '相馬氏が260年間居城とし、相馬野馬追の出陣式にもつながる城跡です。', description: '中村城跡は慶長16年（1611年）、相馬利胤が小高城から移り築いた城で、明治初年まで相馬氏の藩政の中心でした。曲輪・堀・土塁が残り、城内の相馬中村神社で行われる出陣式から、城郭と地域祭礼のつながりを紹介します。', sourceName: '相馬市公式サイト（中村城跡）', sourceUrl: 'https://www.city.soma.fukushima.jp/digital/Cultural_guide/prefecture_designation/3457.html' })
  ,makeNationalSpot({ id: 'castle-221', name: '三戸城跡', category: 'castle', region: '東北', coordinate: { latitude: 40.3740, longitude: 141.2570, elevationMeter: 131 }, era: 'sengoku', eraLabel: '南部氏の本城・国史跡', castleType: '城跡・平山城・南部氏の本拠', summary: '盛岡城以前の南部氏の本城として、北東北の城郭史を伝える国史跡です。', description: '三戸城跡は戦国時代から江戸時代初頭にかけて南部氏の居城で、馬淵川と熊原川がつくる河岸段丘に築かれました。石垣・堀・門跡と発掘成果から、北東北の築城技術と南部氏の領国支配を紹介します。', sourceName: '三戸町公式サイト（国史跡三戸城跡）', sourceUrl: 'https://www.town.sannohe.aomori.jp/soshiki/kyouikuiinkaijimukyoku/3674.html' })
  ,makeNationalSpot({ id: 'religious-309', name: '櫛引八幡宮', category: 'religious', region: '東北', coordinate: { latitude: 40.4840, longitude: 141.4440, elevationMeter: 35 }, era: 'kamakura', eraLabel: '建久2年（1191年）創建伝承・南部一之宮', religiousType: '神社・八幡信仰・南部領総鎮守', summary: '南部家ゆかりの総鎮守で、国宝の甲冑を伝える八戸の一宮です。', description: '櫛引八幡宮は南部光行が甲斐の八幡宮から御神体を奉じ、建久2年（1191年）頃に社宮を造営したと伝わります。南部領の総鎮守としての歴史と、国宝赤糸威鎧などの文化財から、武家の八幡信仰と地域文化を紹介します。', sourceName: '櫛引八幡宮 公式サイト（由緒）', sourceUrl: 'https://www.kushihikihachimangu.com/about/' })
  ,makeNationalSpot({ id: 'religious-310', name: '静岡浅間神社', category: 'religious', region: '中部', coordinate: { latitude: 34.9820, longitude: 138.3760, elevationMeter: 35 }, era: 'heian', eraLabel: '延喜元年（901年）創建伝承・駿河国総社', religiousType: '神社・駿河国総社・浅間信仰', summary: '神部神社・浅間神社・大歳御祖神社を中心とする、駿河の総社です。', description: '静岡浅間神社は延喜元年（901年）、富士山本宮から分霊を勧請したことを由緒として伝えます。三社を中心に広がる社殿群、神仏習合と徳川家康ゆかりの歴史から、富士山信仰と駿河の都市文化を紹介します。', sourceName: '静岡浅間神社 公式サイト（御由緒）', sourceUrl: 'https://www.shizuokasengen.net/yuisho.html' })
  ,makeNationalSpot({ id: 'religious-311', name: '事任八幡宮', category: 'religious', region: '中部', coordinate: { latitude: 34.8010, longitude: 138.0410, elevationMeter: 35 }, era: 'ancient', eraLabel: '遠江国一之宮・言霊信仰の古社', religiousType: '神社・遠江国一之宮・言霊信仰', summary: '遠江国一之宮として、言葉の力と願いの成就を祈る信仰を受け継ぐ古社です。', description: '事任八幡宮は遠江国一之宮として、古くから「ことのまま」の神として信仰されてきました。東海道の往来と掛川の地域祭礼に結びつく社として、言霊信仰と街道文化のつながりを紹介します。', sourceName: '事任八幡宮 公式サイト', sourceUrl: 'https://kotonomama.org/' })
  ,makeNationalSpot({ id: 'religious-312', name: '枚聞神社', category: 'religious', region: '九州・沖縄', coordinate: { latitude: 31.2130, longitude: 130.5310, elevationMeter: 40 }, era: 'ancient', eraLabel: '薩摩国一之宮・開聞岳の山岳海上信仰', religiousType: '神社・薩摩国一之宮・開聞岳信仰', summary: '開聞岳を御神体山として仰ぎ、薩摩国一之宮として航海安全も祈られた古社です。', description: '枚聞神社は貞観年間の記録や延喜式に登場し、古来薩摩国一之宮として崇敬された神社です。開聞岳の噴火と鎮めの祭祀、島津氏の保護、琉球からの航海安全の信仰を通じて、火山と海の宗教文化を紹介します。', sourceName: '鹿児島県神社庁（枚聞神社）', sourceUrl: 'https://www.kagojinjacho.or.jp/shrine-search/area-nansatsu/%E6%8C%87%E5%AE%BF%E5%B8%82/1110/' })
  ,makeNationalSpot({ id: 'religious-313', name: '新田神社（薩摩川内）', category: 'religious', region: '九州・沖縄', coordinate: { latitude: 31.8290, longitude: 130.3030, elevationMeter: 70 }, era: 'nara', eraLabel: '薩摩国一之宮・可愛山陵の鎮守', religiousType: '神社・薩摩国一之宮・皇祖神信仰', summary: '神亀山と瓊瓊杵尊の陵墓に連なる、薩摩川内の一宮です。', description: '新田神社は神亀山の山上に鎮座し、天津日高彦火瓊瓊杵尊を中心に祀る薩摩国一之宮です。可愛山陵と一体になった山の景観、稲作・国土開拓の神話、武射祭などから、南九州の古代信仰を紹介します。', sourceName: '薩摩国一之宮 新田神社 公式サイト（由来）', sourceUrl: 'https://www.nitta-jinja.or.jp/origin' })
  ,makeNationalSpot({ id: 'castle-222', name: '館城跡', category: 'castle', region: '北海道', coordinate: { latitude: 41.9210, longitude: 140.2900, elevationMeter: 35 }, era: 'bakumatsu', eraLabel: '慶応4年（1868年）築城・日本最後の和式城郭', castleType: '城跡・幕末城郭・松前藩の最後の拠点', summary: '幕末維新期に築かれ、未完成のまま落城した日本最後の和式城郭です。', description: '館城跡は明治元年（1868年）、松前藩が松前城から移って築いた最後の和式城郭です。堀・柵・礎石建物などの発掘成果と、短期間で築城・落城した戊辰戦争の歴史から、近代への転換期を紹介します。', sourceName: '厚沢部町公式サイト（館城跡）', sourceUrl: 'https://www.town.assabu.lg.jp/page/1369.html' })
  ,makeNationalSpot({ id: 'castle-223', name: '大館城跡', category: 'castle', region: '東北', coordinate: { latitude: 40.2720, longitude: 140.5640, elevationMeter: 65 }, era: 'sengoku', eraLabel: '中世・近世の北鹿城館・大館の城下', castleType: '城跡・館跡・北鹿の地域拠点', summary: '中世から近世にかけて大館の政治拠点となった城跡で、堀や土居の遺構を伝えます。', description: '大館城跡は大館市街地の中心に位置し、中世から近世にかけて利用された城館跡です。内堀や土居、大館城下絵図などの資料から、米代川流域の地域支配と城下町形成を紹介します。', sourceName: '秋田県遺跡地図情報（大館城）', sourceUrl: 'https://common3.pref.akita.lg.jp/heritage-map/ruins/detail.html?ruins_id=624' })
  ,makeNationalSpot({ id: 'religious-314', name: '熊野皇大神社', category: 'religious', region: '関東', coordinate: { latitude: 36.3560, longitude: 138.6770, elevationMeter: 1200 }, era: 'ancient', eraLabel: '碓氷峠の古社・日本武尊伝承', religiousType: '神社・熊野信仰・碓氷峠の峠神', summary: '碓氷峠の県境に鎮座し、古代の峠越えと熊野信仰を今に伝える神社です。', description: '熊野皇大神社は碓氷峠の頂上に鎮座し、長野県と群馬県にまたがる境内を持つとされる古社です。日本武尊の東征伝承や八咫烏信仰、旅の安全を祈る峠の祭祀から、山道と地域の信仰が結びついた歴史を紹介します。', sourceName: '長野県神社庁（熊野皇大神社）', sourceUrl: 'https://www.nagano-jinjacho.jp/shibu/03tousin/02kitasaku/2039.htm', verificationNote: 'ARピンは碓氷峠の境内周辺の概略位置です。県境付近の参道・施設情報は現地案内と公式情報を確認してください。' })
  ,makeNationalSpot({ id: 'religious-315', name: '西大寺', category: 'religious', region: '近畿', coordinate: { latitude: 34.6930, longitude: 135.7830, elevationMeter: 75 }, era: 'nara', eraLabel: '天平宝字8年（765年）創建・南都七大寺', religiousType: '寺院・真言律宗総本山・南都七大寺', summary: '東大寺と並ぶ国家的寺院として始まり、叡尊の復興を伝える奈良の古刹です。', description: '西大寺は称徳天皇の発願により、天平宝字8年（765年）に創建された南都七大寺の一つです。鎌倉時代に叡尊が戒律復興の拠点として再興し、現在は真言律宗の総本山として大茶盛などの文化を伝えています。', sourceName: '西大寺 公式サイト', sourceUrl: 'https://saidaiji.or.jp/' })
  ,makeNationalSpot({ id: 'religious-316', name: '讃岐国分寺', category: 'religious', region: '四国', coordinate: { latitude: 34.3020, longitude: 133.9430, elevationMeter: 20 }, era: 'nara', eraLabel: '天平13年（741年）国分寺建立の詔・四国八十八ヶ所第80番', religiousType: '寺院・讃岐国分寺・四国遍路', summary: '聖武天皇の国分寺建立の詔に始まり、古代国家と四国遍路をつなぐ寺院です。', description: '讃岐国分寺は、天平13年（741年）の国分寺建立の詔によって全国に整えられた官寺の一つです。国の特別史跡に指定された寺跡と、四国八十八ヶ所第80番札所として続く巡礼から、古代の国家祭祀と地域の信仰を紹介します。', sourceName: '高松市公式サイト（讃岐国分寺跡）', sourceUrl: 'https://www.city.takamatsu.kagawa.jp/kurashi/kosodate/bunka/kokubunjiato/rekish_upR21210.html' })
  ,makeNationalSpot({ id: 'religious-317', name: '御香宮神社', category: 'religious', region: '近畿', coordinate: { latitude: 34.9320, longitude: 135.7630, elevationMeter: 25 }, era: 'heian', eraLabel: '貞観4年（862年）御香宮の名を賜る・伏見の産土神', religiousType: '神社・伏見の総鎮守・安産信仰', summary: '名水の湧出を由来とする名を持ち、伏見の町と祭礼を守ってきた古社です。', description: '御香宮神社は創建時期を詳らかにしないものの、貞観4年（862年）に香りのよい水が湧き、清和天皇から御香宮の名を賜ったと伝わります。豊臣秀吉による伏見城への勧請、徳川家康による本殿造営、伏見祭の歴史から、城下町の守護と地域信仰を紹介します。', sourceName: '御香宮神社 公式サイト（神社由緒）', sourceUrl: 'https://www.gokounomiya.kyoto.jp/history/history.html' })
  ,makeNationalSpot({ id: 'castle-224', name: '高山城跡', category: 'castle', region: '中部', coordinate: { latitude: 36.1370, longitude: 137.2590, elevationMeter: 686 }, era: 'sengoku', eraLabel: '天正16年（1588年）頃着工・金森氏の居城', castleType: '城跡・山城・日本遺産構成文化財', summary: '金森氏が飛騨の支配拠点として築いた、城下町高山を見下ろす山城跡です。', description: '高山城跡は標高約686メートルの城山に築かれ、天正16年（1588年）頃から金森長近・可重によって整備されたとされます。本丸・二之丸・三之丸の構成と高山の城下町を通して、飛騨の領国支配と山城の景観を紹介します。', sourceName: '高山市公式サイト（高山城跡）', sourceUrl: 'https://www.city.takayama.lg.jp/kurashi/1000021/1000119/1000847/1000954/1000969.html' })
  ,makeNationalSpot({ id: 'castle-225', name: '吉田城跡', category: 'castle', region: '中部', coordinate: { latitude: 34.7690, longitude: 137.3920, elevationMeter: 12 }, era: 'sengoku', eraLabel: '今橋城から吉田城へ・東三河の要衝', castleType: '城跡・平城・続日本100名城', summary: '豊川の河口に近い交通の要衝で、東三河の支配と城下町形成を伝える城跡です。', description: '吉田城は、今橋城として築かれた城が吉田と改称され、戦国から江戸時代にかけて東三河の政治・軍事拠点となりました。池田輝政による城域拡張や現存する鉄櫓、豊川沿いの立地から、街道・河川交通と城下町の歴史を紹介します。', sourceName: '豊橋市公式サイト（吉田城）', sourceUrl: 'https://www.city.toyohashi.lg.jp/48101.htm' })
  ,makeNationalSpot({ id: 'religious-318', name: '玉前神社', category: 'religious', region: '関東', coordinate: { latitude: 35.3710, longitude: 140.3680, elevationMeter: 8 }, era: 'ancient', eraLabel: '上総国一之宮・延喜式名神大社', religiousType: '神社・上総国一之宮・玉依姫命信仰', summary: '上総国一之宮として、九十九里浜の地域と古代以来の朝廷・武家の信仰をつなぐ古社です。', description: '玉前神社は上総国一之宮で、平安時代の『延喜式神名帳』に名神大社として記される古社です。玉依姫命を祀り、源頼朝や武家の崇敬を受けた歴史から、房総の海辺に続く一宮信仰を紹介します。', sourceName: '上総國一之宮 玉前神社 公式サイト', sourceUrl: 'https://www.tamasaki-jinja.org/' })
  ,makeNationalSpot({ id: 'religious-319', name: '小國神社', category: 'religious', region: '中部', coordinate: { latitude: 34.8350, longitude: 137.9030, elevationMeter: 45 }, era: 'ancient', eraLabel: '遠江国一之宮・本宮山の神奈備信仰', religiousType: '神社・遠江国一之宮・大己貴命信仰', summary: '深い鎮守の森と本宮山の奥宮を持ち、遠江の守護神として崇敬されてきた一宮です。', description: '小國神社は遠江国一之宮として、延喜式にも名が見える古社です。大己貴命を祀り、本宮山を神奈備山として仰ぐ奥宮と広大な鎮守の森から、古代の山岳信仰と東海の地域祭祀を紹介します。', sourceName: '遠江国一宮 小國神社 公式サイト', sourceUrl: 'https://okunijinja.or.jp/' })
  ,makeNationalSpot({ id: 'religious-320', name: '劔神社', category: 'religious', region: '中部', coordinate: { latitude: 35.9600, longitude: 136.1250, elevationMeter: 45 }, era: 'nara', eraLabel: '越前国二之宮・奈良時代からの祈願霊場', religiousType: '神社・越前国二之宮・神仏習合の霊場', summary: '織田信長の氏神としても知られ、神宮寺と門前町を含む神仏習合の景観を伝える古社です。', description: '劔神社は座ヶ岳の峰への信仰に始まり、奈良時代から朝廷や人々の祈願霊場として崇敬されてきた越前国二之宮です。かつて境内に神宮寺の織田寺が並んだ構成や、織田信長との由緒から、北陸の神仏習合と門前町の歴史を紹介します。', sourceName: '越前二の宮 劔神社 公式サイト（ご由緒）', sourceUrl: 'https://www.tsurugi-jinja.jp/yuisho/' })
  ,makeNationalSpot({ id: 'religious-321', name: '観世音寺', category: 'religious', region: '九州・沖縄', coordinate: { latitude: 33.5180, longitude: 130.5180, elevationMeter: 45 }, era: 'asuka', eraLabel: '天智天皇発願・天下三戒壇', religiousType: '寺院・天台宗・大宰府の府大寺', summary: '大宰府の古代外交・行政拠点と結びつき、僧侶の戒律を授けた九州の大寺です。', description: '観世音寺は天智天皇の発願に始まり、大宰府の東に建立された古代寺院です。戒壇院が置かれ、東大寺・下野薬師寺とともに天下三戒壇と呼ばれた歴史や、日本最古級の梵鐘・仏像群から、西海道の宗教文化を紹介します。', sourceName: '太宰府市公式サイト（観世音寺）', sourceUrl: 'https://www.city.dazaifu.lg.jp/site/kanko/11420.html' })
  ,makeNationalSpot({ id: 'religious-322', name: '筑前国分寺跡', category: 'religious', region: '九州・沖縄', coordinate: { latitude: 33.5070, longitude: 130.4980, elevationMeter: 55 }, era: 'nara', eraLabel: '天平13年（741年）国分寺建立の詔・大宰府周辺の官寺', religiousType: '古代寺院跡・筑前国分寺・国指定重要文化財', summary: '大宰府の麓に置かれた国分寺で、塔跡の礎石と平安時代の仏像を伝えます。', description: '筑前国分寺跡は、聖武天皇の国分寺建立の詔によって整えられた筑前国の官寺跡です。塔跡の礎石、講堂跡、金堂跡に建つ堂と伝薬師如来像から、国家鎮護の制度が大宰府周辺に根づいた様子を紹介します。', sourceName: '太宰府市公式サイト（筑前国分寺跡）', sourceUrl: 'https://www.city.dazaifu.lg.jp/site/kanko/12099.html' })
  ,makeNationalSpot({ id: 'religious-323', name: '阿波国分寺', category: 'religious', region: '四国', coordinate: { latitude: 34.0530, longitude: 134.4140, elevationMeter: 25 }, era: 'nara', eraLabel: '天平13年（741年）創建・四国八十八ヶ所第15番', religiousType: '寺院・曹洞宗・阿波国分寺庭園', summary: '阿波国府に近い場所で古代の国分寺を受け継ぎ、名勝庭園と遍路文化を伝える寺院です。', description: '阿波国分寺は、聖武天皇の詔による国分寺建立に始まる寺院で、現在は四国八十八ヶ所第15番札所です。阿波国府に近い立地と国指定名勝の庭園から、古代の地方行政・国家祈願と近世以降の遍路を紹介します。', sourceName: '文化庁 国指定文化財等データベース（阿波国分寺庭園）', sourceUrl: 'https://kunishitei.bunka.go.jp/heritage/detail/401/3232' })
  ,makeNationalSpot({ id: 'religious-324', name: '土佐国分寺', category: 'religious', region: '四国', coordinate: { latitude: 33.5750, longitude: 133.6430, elevationMeter: 25 }, era: 'nara', eraLabel: '天平13年（741年）創建・四国八十八ヶ所第29番', religiousType: '寺院・真言宗智山派・土佐国分寺跡', summary: '国家鎮護の国分寺から四国遍路の霊場へ続く、苔の庭と文化財を持つ古刹です。', description: '土佐国分寺は天平13年（741年）、聖武天皇の勅願により行基が創建したと伝わる寺院です。空海による中興を経て四国八十八ヶ所第29番札所となり、国史跡の寺跡と本堂・庭園から、古代の国家祈願と遍路の歴史を紹介します。', sourceName: '土佐国分寺 公式サイト（歴史）', sourceUrl: 'https://www.tosakokubunji.org/history.html' })
  ,makeNationalSpot({ id: 'religious-325', name: '伊予国分寺', category: 'religious', region: '四国', coordinate: { latitude: 34.0210, longitude: 133.0180, elevationMeter: 15 }, era: 'nara', eraLabel: '天平勝宝8年（756年）頃完成・四国八十八ヶ所第59番', religiousType: '寺院・真言律宗・伊予国分寺塔跡', summary: '伊予国府に近い古代寺院で、巨大な塔の礎石と遍路の札所を今に伝えます。', description: '伊予国分寺は聖武天皇の発願により整えられ、天平勝宝8年（756年）頃に完成したとみられる古代寺院です。現在の寺院と国指定史跡の塔跡、四国八十八ヶ所第59番札所としての巡礼から、伊予の古代仏教と地域文化を紹介します。', sourceName: '愛媛県公式サイト（伊予国分寺塔跡）', sourceUrl: 'https://www.pref.ehime.jp/ehimenotakara/372.html' })
  ,makeNationalSpot({ id: 'castle-226', name: '向羽黒山城跡', category: 'castle', region: '東北', coordinate: { latitude: 37.4520, longitude: 139.9260, elevationMeter: 410 }, era: 'sengoku', eraLabel: '永禄4年（1561年）築城開始・蘆名氏の本城', castleType: '城跡・山城・国指定史跡・続日本100名城', summary: '蘆名盛氏が築いた会津最大級の山城で、羽黒神社など信仰の山と一体になった城跡です。', description: '向羽黒山城跡は戦国時代に会津を治めた蘆名盛氏が築いた天然の要害です。一曲輪・二曲輪や虎口などの遺構を残し、観音山・羽黒神社を含む白鳳山公園の山々と連なる景観から、城郭と山岳信仰が重なる会津の歴史を紹介します。', sourceName: '会津美里町公式サイト（向羽黒山城跡）', sourceUrl: 'https://www.town.aizumisato.fukushima.jp/soshiki/1007/6/3/1219.html' })
  ,makeNationalSpot({ id: 'castle-227', name: '小机城跡', category: 'castle', region: '関東', coordinate: { latitude: 35.5120, longitude: 139.5960, elevationMeter: 45 }, era: 'sengoku', eraLabel: '15世紀中頃築城・小田原北条氏の関東進出拠点', castleType: '城跡・平山城・小机領の支配拠点', summary: '空堀や土塁が残り、横浜における小田原北条氏の戦国支配を伝える城跡です。', description: '小机城跡は15世紀半ば頃に築かれ、戦国時代には小田原北条氏の関東進出を支えた軍事・地域支配の拠点となりました。空堀や曲輪を残す市民の森と発掘調査成果から、都市の中に残る中世城郭の姿を紹介します。', sourceName: '横浜市公式サイト（小机城跡発掘調査）', sourceUrl: 'https://www.city.yokohama.lg.jp/city-info/koho-kocho/press/kyoiku/2023/20231124houkokukai.html' })
  ,makeNationalSpot({ id: 'castle-228', name: '長岡城跡', category: 'castle', region: '中部', coordinate: { latitude: 37.4460, longitude: 138.8510, elevationMeter: 20 }, era: 'edo', eraLabel: '元和4年（1618年）築城継承・長岡藩の城下', castleType: '城跡・平城・長岡藩政の中心', summary: '現在の長岡駅周辺に本丸が置かれた、城下町長岡の成立を伝える城跡です。', description: '長岡城跡は元和4年（1618年）に入部した牧野忠成が築城を継承し、苧引形兜城とも呼ばれる城を完成させたとされます。本丸・二之丸の位置が市街地に重なることから、近世城郭と現在の都市の重なりを紹介します。', sourceName: '長岡市公式サイト（長岡城趾）', sourceUrl: 'https://www.city.nagaoka.niigata.jp/kankou/rekishi/shiro/nagaokajyou.html' })
  ,makeNationalSpot({ id: 'religious-326', name: '枚岡神社', category: 'religious', region: '近畿', coordinate: { latitude: 34.6700, longitude: 135.6510, elevationMeter: 45 }, era: 'ancient', eraLabel: '河内国一之宮・延喜式名神大社', religiousType: '神社・河内国一之宮・元春日', summary: '生駒山麓に鎮座し、春日大社とのつながりと河内の祭礼文化を伝える古社です。', description: '枚岡神社は延喜式神名帳に載る名神大社で、中世以来の河内国一之宮として崇敬されてきました。天児屋根命・比売御神などを祀り、粥占神事や秋郷祭から、古代の氏族祭祀と地域共同体の信仰を紹介します。', sourceName: '東大阪市公式サイト（枚岡神社）', sourceUrl: 'https://www.city.higashiosaka.lg.jp/0000007197.html' })
  ,makeNationalSpot({ id: 'religious-327', name: '秋葉山本宮秋葉神社', category: 'religious', region: '中部', coordinate: { latitude: 34.9710, longitude: 137.9050, elevationMeter: 866 }, era: 'nara', eraLabel: '和銅2年（709年）創建伝承・全国秋葉信仰の総本宮', religiousType: '神社・火防信仰・秋葉山の山岳霊場', summary: '秋葉山を神体山と仰ぎ、火防の神として全国の秋葉講を生んだ山上の霊場です。', description: '秋葉山本宮秋葉神社は和銅2年（709年）創建と伝えられ、秋葉山を神体山として火之迦具土大神を祀ります。中世の秋葉大権現、江戸時代の秋葉講と参詣道の広がりから、火の信仰と山岳霊場の歴史を紹介します。', sourceName: '秋葉山本宮秋葉神社 公式サイト（由緒）', sourceUrl: 'https://www.akihasanhongu.jp/history/index.html' })
  ,makeNationalSpot({ id: 'religious-328', name: '安芸国分寺跡', category: 'religious', region: '中国', coordinate: { latitude: 34.4380, longitude: 132.7440, elevationMeter: 220 }, era: 'nara', eraLabel: '奈良時代の国分寺・国史跡', religiousType: '古代寺院跡・安芸国分寺・国師院跡', summary: '国師院の存在が発掘で明らかになった、古代地方仏教の重要な国分寺跡です。', description: '安芸国分寺跡は聖武天皇の詔によって造られた国分寺の一つで、現在は歴史公園として整備されています。天平勝宝2年（750年）銘の木簡や国師院跡の発見から、中央と地方をつないだ奈良時代の宗教行政を紹介します。', sourceName: '東広島市公式サイト（安芸国分寺跡）', sourceUrl: 'https://www.city.higashihiroshima.lg.jp/kanko/bunka/3/43671.html' })
  ,makeNationalSpot({ id: 'religious-329', name: '備中国分寺', category: 'religious', region: '中国', coordinate: { latitude: 34.6750, longitude: 133.7670, elevationMeter: 35 }, era: 'nara', eraLabel: '天平13年（741年）創建・吉備路の五重塔', religiousType: '寺院・備中国分寺・吉備路の古代寺院', summary: '古代国分寺の伝統と江戸時代再建の五重塔が、吉備路の田園景観に残る寺院です。', description: '備中国分寺は、聖武天皇の発願で全国に整えられた国分寺の一つです。南北朝期の焼失後に再建された境内と、岡山県内唯一の五重塔がつくる景観から、古代の国家祈願と近世の地域文化を紹介します。', sourceName: '総社市公式サイト（備中国分寺）', sourceUrl: 'https://www.city.soja.okayama.jp/site/kanko/3601.html' })
  ,makeNationalSpot({ id: 'religious-330', name: '豊前国分寺跡', category: 'religious', region: '九州・沖縄', coordinate: { latitude: 33.6670, longitude: 130.9490, elevationMeter: 35 }, era: 'nara', eraLabel: '8世紀半ば成立・豊前の国分寺', religiousType: '古代寺院跡・豊前国分寺・三重塔', summary: '国分寺建立の制度を受け継ぎ、江戸期復興の三重塔も伝える北九州の古代寺院跡です。', description: '豊前国分寺跡は8世紀半ば頃に造られた諸国国分寺の一つで、戦国期の焼失を経て江戸時代に復興されました。境内に残る三重塔と寺跡から、古代国家の宗教政策と地域の再建の歴史を紹介します。', sourceName: '福岡県公式観光サイト（豊前国分寺跡）', sourceUrl: 'https://www.crossroadfukuoka.jp/spot/14824' })
  ,makeNationalSpot({ id: 'religious-331', name: '豊後国分寺跡', category: 'religious', region: '九州・沖縄', coordinate: { latitude: 33.1950, longitude: 131.5750, elevationMeter: 30 }, era: 'nara', eraLabel: '天平13年（741年）創建・国指定史跡', religiousType: '古代寺院跡・豊後国分寺・七重塔跡', summary: '高さ約67メートルと推定される七重塔跡を残す、規模の大きな国分寺遺跡です。', description: '豊後国分寺跡は聖武天皇の発願により大分市国分の地に造られた国分寺跡です。中門・金堂・回廊・七重塔の伽藍配置が確認され、七重塔の巨大な心礎から、豊後の古代仏教文化と国家鎮護の規模を紹介します。', sourceName: '大分市公式サイト（豊後国分寺跡）', sourceUrl: 'https://www.city.oita.oita.jp/o204/bunkasports/rekishi/bunkazai3.html' })
  ,makeNationalSpot({ id: 'religious-332', name: '東長寺', category: 'religious', region: '九州・沖縄', coordinate: { latitude: 33.5960, longitude: 130.4140, elevationMeter: 8 }, era: 'heian', eraLabel: '大同元年（806年）創建伝承・博多旧市街の真言密教寺院', religiousType: '寺院・真言宗九州教団本山・博多旧市街', summary: '弘法大師ゆかりの寺として、博多の寺町と国際交流の歴史を伝える古刹です。', description: '東長寺は、唐での修行を終えた空海が博多に帰着後、真言密教の東方への広がりを祈願して建立したと伝えられる寺院です。博多旧市街の寺社景観や福岡大仏、節分祭から、港町の宗教文化と現在の地域交流を紹介します。', sourceName: '東長寺 公式サイト', sourceUrl: 'https://www.tochoji.net/' })
  ,makeNationalSpot({ id: 'religious-333', name: '本願寺函館別院', category: 'religious', region: '北海道', coordinate: { latitude: 41.7650, longitude: 140.7110, elevationMeter: 12 }, era: 'modern', eraLabel: '大正4年（1915年）本堂竣工・重要文化財', religiousType: '寺院・浄土真宗本願寺派・北海道開教拠点', summary: '北海道開教の拠点で、伝統様式を鉄筋コンクリートで再現した近代寺院建築です。', description: '本願寺函館別院は、北海道における浄土真宗本願寺派の開教拠点の一つです。函館大火後に再建された本堂・鐘楼・正門は重要文化財に指定され、伝統的な真宗本堂形式と近代の耐火建築が重なる歴史を紹介します。', sourceName: '本願寺函館別院 公式サイト（函館別院の歴史）', sourceUrl: 'https://hongwanji-h.h-tk.jp/betuin/rekisi.shtml' })
  ,makeNationalSpot({ id: 'religious-334', name: '中山神社', category: 'religious', region: '中国', coordinate: { latitude: 35.0750, longitude: 134.0140, elevationMeter: 130 }, era: 'ancient', eraLabel: '美作国一宮・延喜式名神大社', religiousType: '神社・美作国一之宮・名神大社', summary: '美作国唯一の名神大社として、門前市と地域の信仰を伝える一宮です。', description: '中山神社は文武天皇の慶雲4年（707年）創建伝承を持ち、貞観年間に官社となり、延喜式では美作国唯一の名神大社とされています。美作国一宮としての祭祀と中世から近世の門前市の歴史を紹介します。', sourceName: '岡山県神社庁（中山神社）', sourceUrl: 'https://www.okayama-jinjacho.or.jp/search/16978/' })
  ,makeNationalSpot({ id: 'religious-335', name: '伊和神社', category: 'religious', region: '近畿', coordinate: { latitude: 35.0730, longitude: 134.5540, elevationMeter: 170 }, era: 'ancient', eraLabel: '播磨国一之宮・大己貴神の国造り伝承', religiousType: '神社・播磨国一之宮・国造り信仰', summary: '播磨国一之宮として、揖保川上流の自然と国造りの神話を伝える古社です。', description: '伊和神社は播磨国一之宮として古くから崇敬を集め、大己貴神を祀る神社です。神が播磨を巡って国造りを終え「おわ」と語ったという伝承や、風鎮祭・秋季大祭から、山間の一宮と地域祭礼の歴史を紹介します。', sourceName: '兵庫県神社庁（伊和神社）', sourceUrl: 'https://www.hyogo-jinjacho.com/data/6320080.html' })
  ,makeNationalSpot({ id: 'religious-336', name: '出石神社', category: 'religious', region: '近畿', coordinate: { latitude: 35.4730, longitude: 134.8730, elevationMeter: 25 }, era: 'ancient', eraLabel: '但馬国一之宮・天日槍の開発神話', religiousType: '神社・但馬国一之宮・但馬開発の祖神', summary: '但馬国一之宮として、天日槍と八種の神宝をめぐる日本海側の古代伝承を伝える神社です。', description: '出石神社は但馬国一之宮として、但馬開発の祖神とされる天日槍と八種の神宝を祀ります。古事記・日本書紀にも関わる伝承と、出石川盆地の禁足地・神苑から、山陰の古代信仰と地域形成を紹介します。', sourceName: '豊岡市観光公式サイト（出石神社）', sourceUrl: 'https://toyooka-tourism.com/spot/izushijinja/' })
  ,makeNationalSpot({ id: 'religious-337', name: '求菩提山', category: 'religious', region: '九州・沖縄', coordinate: { latitude: 33.5320, longitude: 131.0080, elevationMeter: 782 }, era: 'heian', eraLabel: '北部九州修験道の聖地・国指定史跡', religiousType: '山岳霊場・修験道・国玉神社中宮', summary: '「一山五百坊」と称された、英彦山と並ぶ北部九州修験道の山岳霊場です。', description: '求菩提山は標高782メートルの山で、平安時代後期以降、求菩提山護国寺を中心に多くの山伏が修行した豊前修験道の聖地です。坊跡・行場・岩窟・国玉神社中宮などの遺構から、神仏習合の山岳信仰を紹介します。', sourceName: '豊前市公式サイト（求菩提山と修験道）', sourceUrl: 'https://www.city.buzen.lg.jp/kanko/miru/bunkazai/04.html' })
  ,makeNationalSpot({ id: 'castle-229', name: '勝山城跡（都留）', category: 'castle', region: '中部', coordinate: { latitude: 35.5530, longitude: 138.9060, elevationMeter: 571 }, era: 'sengoku', eraLabel: '文禄3年（1594年）築城伝承・谷村城下の詰城', castleType: '城跡・山城・山梨県指定史跡', summary: '谷村城下を見下ろし、土塁・堀・竪堀などの遺構を残す甲斐東部の山城です。', description: '勝山城跡は都留市川棚の城山にあり、文禄3年（1594年）に浅野氏重が築いたという伝承を持つ城跡です。中世小山田氏の築城説や江戸期の茶壺蔵の伝承、土塁・横堀・竪堀の遺構から、谷村の城下町と山城の歴史を紹介します。', sourceName: '山梨県公式サイト（勝山城跡）', sourceUrl: 'https://www.pref.yamanashi.jp/bunka/maibun/yamanashinobunkazai_sc0018.html' })
  ,makeNationalSpot({ id: 'religious-338', name: '根室金刀比羅神社', category: 'religious', region: '北海道', coordinate: { latitude: 43.3290, longitude: 145.5850, elevationMeter: 20 }, era: 'edo', eraLabel: '文化3年（1806年）創建伝承・根室の海上守護', religiousType: '神社・金刀比羅信仰・根室の総鎮守', summary: '北東の港町根室で、海上安全と地域の祭礼を支える金刀比羅信仰の拠点です。', description: '根室金刀比羅神社は大物主神・事代主神・倉稲魂命を祀り、根室の港と漁業を守る神社として崇敬されています。例大祭や神輿の伝統から、北方の海上交通と開拓地域の信仰を紹介します。', sourceName: '根室金刀比羅神社 公式サイト', sourceUrl: 'https://www.nemuro-kotohira.com/' })
  ,makeNationalSpot({ id: 'religious-339', name: '小樽住吉神社', category: 'religious', region: '北海道', coordinate: { latitude: 43.1820, longitude: 141.0030, elevationMeter: 35 }, era: 'modern', eraLabel: '元治元年（1864年）創建・小樽総鎮守', religiousType: '神社・住吉信仰・港町の総鎮守', summary: '北前船の航海安全を願って始まり、小樽港と商業都市の発展を見守った神社です。', description: '小樽住吉神社は元治元年（1864年）に住吉大神を勧請する願いが出されたことに始まり、明治以降の小樽の発展とともに総鎮守として崇敬されました。奉納された鳥居・灯籠・石段から、港町の商人文化と海上信仰を紹介します。', sourceName: '小樽住吉神社 公式サイト', sourceUrl: 'https://www.otarusumiyoshijinja.com/' })
  ,makeNationalSpot({ id: 'religious-340', name: '富貴寺', category: 'religious', region: '九州・沖縄', coordinate: { latitude: 33.5450, longitude: 131.5470, elevationMeter: 105 }, era: 'heian', eraLabel: '平安時代創建・国宝富貴寺大堂', religiousType: '寺院・天台宗・六郷満山文化', summary: '九州最古の木造建築とされる大堂を伝える、国東半島の仏教文化の中心寺院です。', description: '富貴寺は平安時代に宇佐神宮大宮司の氏寺として開かれたとされ、阿弥陀堂である富貴寺大堂は国宝に指定されています。宇治平等院鳳凰堂・中尊寺金色堂と並ぶ阿弥陀堂の歴史から、国東半島の六郷満山文化を紹介します。', sourceName: '豊後高田市公式サイト（富貴寺）', sourceUrl: 'https://www.city.bungotakada.oita.jp/site/showanomachi/1251.html' })
  ,makeNationalSpot({ id: 'religious-341', name: '両子寺', category: 'religious', region: '九州・沖縄', coordinate: { latitude: 33.5520, longitude: 131.6140, elevationMeter: 610 }, era: 'nara', eraLabel: '六郷満山の総持院・両子山の山岳仏教', religiousType: '寺院・天台宗・六郷満山総持院', summary: '両子山の中腹にあり、神仏習合の六郷満山文化を代表する山岳寺院です。', description: '両子寺は国東半島中央の両子山に位置し、江戸時代には杵築藩の庇護を受けて六郷満山の総持院を務めました。仁王像や護摩堂、山中の修行環境から、宇佐神宮と結びついた国東の神仏習合を紹介します。', sourceName: '国東市公式サイト（六郷満山）', sourceUrl: 'https://www.city.kunisaki.oita.jp/site/kanko/yumekikou-satori.html' })
  ,makeNationalSpot({ id: 'religious-342', name: '高瀬神社', category: 'religious', region: '中部', coordinate: { latitude: 36.5530, longitude: 136.9510, elevationMeter: 105 }, era: 'ancient', eraLabel: '越中国一之宮・延喜式内社', religiousType: '神社・越中国一之宮・大国主命信仰', summary: '砺波平野の鎮守として、越中国一之宮と古代の地域開拓伝承を伝える神社です。', description: '高瀬神社は越中国一之宮で、延喜式内社として朝廷からも崇敬されてきました。大国主命の北国開拓伝承と、古代地方官衙に関わる高瀬遺跡に近い立地から、越中の開拓と祭祀の歴史を紹介します。', sourceName: '越中一宮 高瀬神社 公式サイト（ご案内）', sourceUrl: 'https://www.takase.or.jp/guide.html' })
  ,makeNationalSpot({ id: 'religious-343', name: '大麻山神社', category: 'religious', region: '中国', coordinate: { latitude: 34.7970, longitude: 131.9870, elevationMeter: 570 }, era: 'heian', eraLabel: '仁和4年（888年）創建伝承・大麻山の山岳信仰', religiousType: '神社・式内社・山岳信仰', summary: '日本海と中国山地を望む大麻山に鎮座し、神仏習合の山岳信仰を伝える古社です。', description: '大麻山神社は浜田市の大麻山山頂近くに鎮座し、延喜式神名帳に記載された式内社です。阿波の大麻比古神社・忌部神社からの分霊伝承と、かつて境内に尊勝寺が置かれた歴史から、石見の山岳祭祀と神仏習合を紹介します。', sourceName: '大麻山神社公式サイト', sourceUrl: 'https://taimasan-jinja.com/about.html' })
  ,makeNationalSpot({ id: 'religious-344', name: '忌部神社（徳島）', category: 'religious', region: '四国', coordinate: { latitude: 34.0570, longitude: 134.5430, elevationMeter: 75 }, era: 'modern', eraLabel: '明治20年（1887年）現在地に社殿・阿波忌部の祖神', religiousType: '神社・忌部氏の祭祀・阿波の総鎮守', summary: '阿波忌部の祖神を祀り、大嘗祭の布を献上した祭祀集団の歴史を伝える神社です。', description: '忌部神社は天日鷲命を主祭神とし、阿波忌部の祖神と古代の宮中祭祀とのつながりを伝えます。式内社の所在地をめぐる近代の論争を経て現在地に鎮座した経緯から、古代伝承が近代国家の神社制度の中で再編された歴史を紹介します。', sourceName: '徳島県立博物館（忌部神社の由来）', sourceUrl: 'https://museum.bunmori.tokushima.jp/museum_documents/museumnews/mnews058/058_7_qa.html' })
  ,makeNationalSpot({ id: 'castle-230', name: '基肄城跡', category: 'castle', region: '九州・沖縄', coordinate: { latitude: 33.4350, longitude: 130.5330, elevationMeter: 405 }, era: 'asuka', eraLabel: '天智天皇4年（665年）築造・大宰府南方の古代山城', castleType: '特別史跡・朝鮮式山城', summary: '大野城と連携して大宰府を守った、日本最古級の本格的な朝鮮式山城です。', description: '基肄城跡は白村江の戦い後、唐・新羅の侵攻に備えて天智天皇4年（665年）に築かれたとされます。土塁・石垣・水門などの遺構から、大宰府を中心とする古代国家の防衛と東アジア交流を紹介します。', sourceName: '基山町公式サイト（基肄城跡）', sourceUrl: 'https://www.town.kiyama.lg.jp/kiji0031236/index.html' })
  ,makeNationalSpot({ id: 'castle-231', name: '杵築城', category: 'castle', region: '九州・沖縄', coordinate: { latitude: 33.4190, longitude: 131.6740, elevationMeter: 30 }, era: 'sengoku', eraLabel: '応永元年（1394年）頃移転・杵築城下の中心', castleType: '城跡・平山城・杵築藩の城下町', summary: '八坂川と高山川に挟まれた城下町を見下ろし、木付氏以来の地域支配を伝える城です。', description: '杵築城は木付氏の城として始まり、応永元年（1394年）頃に現在の城山へ移転したとされます。江戸時代には城下町の中心となり、南北の高台と谷を生かした町並みから、豊後の領主支配と城下町景観を紹介します。', sourceName: '杵築市公式サイト（杵築城）', sourceUrl: 'https://www.city.kitsuki.lg.jp/soshiki/7/bunka/bunkazai/bunkazai/1823.html' })
  ,makeNationalSpot({ id: 'religious-345', name: '最勝院', category: 'religious', region: '東北', coordinate: { latitude: 40.5960, longitude: 140.4730, elevationMeter: 35 }, era: 'sengoku', eraLabel: '弘前藩総祈願所・寛文7年（1667年）五重塔完成', religiousType: '寺院・真言宗智山派・津軽の総祈願所', summary: '弘前藩の祈願寺として栄え、戦死者を供養する国重要文化財の五重塔を伝える古刹です。', description: '最勝院は弘前藩で諸宗筆頭・寺格第一位を有した真言宗の寺院で、津軽家の総祈願所として存続してきました。寛文年間に建立された五重塔や神仏分離を乗り越えた歴史から、城下町の武家信仰と供養文化を紹介します。', sourceName: '金剛山最勝院 公式サイト', sourceUrl: 'https://saisyouin.jp/jp/' })
  ,makeNationalSpot({ id: 'religious-346', name: '高龍寺', category: 'religious', region: '北海道', coordinate: { latitude: 41.7760, longitude: 140.7010, elevationMeter: 25 }, era: 'edo', eraLabel: '寛永10年（1633年）創建・函館最古の曹洞宗寺院', religiousType: '寺院・曹洞宗・函館の寺町', summary: '函館最古の曹洞宗寺院として、寺町の形成と箱館戦争の記憶を伝える古刹です。', description: '高龍寺は寛永10年（1633年）に創建され、松前法源寺の末寺として函館の発展とともに移転・再建を重ねました。総ケヤキ造りの山門や登録有形文化財の建物、箱館戦争時の病舎となった歴史から、北方の寺町文化を紹介します。', sourceName: '北海道公式観光サイト（高龍寺）', sourceUrl: 'https://www.visit-hokkaido.jp/spot/detail_13050.html' })
  ,makeNationalSpot({ id: 'religious-347', name: '那谷寺', category: 'religious', region: '中部', coordinate: { latitude: 36.3000, longitude: 136.4500, elevationMeter: 95 }, era: 'nara', eraLabel: '養老元年（717年）開創伝承・白山信仰の霊場', religiousType: '寺院・高野山真言宗・白山修験', summary: '奇岩と洞窟を抱く自然智の森で、白山信仰と観音巡礼が重なる北陸の古刹です。', description: '那谷寺は養老元年（717年）、泰澄が岩窟に千手観音を安置したことを始まりと伝える寺院です。白山信仰、花山法皇による寺名の伝承、前田利常による堂宇再建から、自然崇拝と仏教・大名文化の重なりを紹介します。', sourceName: '那谷寺 公式サイト（年表）', sourceUrl: 'https://natadera.com/about/history/' })
  ,makeNationalSpot({ id: 'religious-348', name: '施福寺', category: 'religious', region: '近畿', coordinate: { latitude: 34.4010, longitude: 135.5200, elevationMeter: 485 }, era: 'nara', eraLabel: '西国三十三所第4番・槇尾山の山岳霊場', religiousType: '寺院・天台宗・西国観音巡礼', summary: '槇尾山の深山に位置し、西国三十三所の難所として歩く巡礼文化を伝える寺院です。', description: '施福寺は槇尾山にある天台宗の寺院で、西国三十三所観音霊場第4番札所です。標高485メートルの山道と十一面千手千眼観世音菩薩への参詣から、観音巡礼と山岳修行が結びついた信仰景観を紹介します。', sourceName: '河内長野市公式サイト（槇尾山施福寺）', sourceUrl: 'https://www.city.kawachinagano.lg.jp/soshiki/59/3580.html' })
  ,makeNationalSpot({ id: 'religious-349', name: '葛井寺', category: 'religious', region: '近畿', coordinate: { latitude: 34.5720, longitude: 135.5960, elevationMeter: 20 }, era: 'nara', eraLabel: '神亀2年（725年）創建・西国三十三所第5番', religiousType: '寺院・真言宗御室派・国宝千手観音', summary: '実際に千本以上の手を持つ国宝千手観音を祀り、厄除けと観音巡礼を伝える古寺です。', description: '葛井寺は725年、百済からの渡来人葛井氏の氏寺として建立されたと伝えられます。聖武天皇の厄除け祈願で奉安された国宝千手観音と、西国三十三所第5番札所としての毎月の御開扉から、古代の国際交流と民衆信仰を紹介します。', sourceName: '葛井寺 公式サイト', sourceUrl: 'https://www.fujiidera-temple.or.jp/' })
  ,makeNationalSpot({ id: 'religious-350', name: '中山寺', category: 'religious', region: '近畿', coordinate: { latitude: 34.8170, longitude: 135.3690, elevationMeter: 70 }, era: 'asuka', eraLabel: '聖徳太子創建伝承・西国三十三所第24番', religiousType: '寺院・聖徳太子創建伝承・安産観音', summary: '安産の観音さまとして全国から参詣を集め、西国巡礼にも連なる宝塚の古刹です。', description: '中山寺は聖徳太子創建と伝わる観音霊場で、西国三十三所第24番札所です。十一面観世音菩薩を本尊とし、安産・子授けの祈願で広く信仰を集めてきた歴史から、巡礼と人生儀礼のつながりを紹介します。', sourceName: '大本山中山寺 公式サイト', sourceUrl: 'https://www.nakayamadera.or.jp/' })
  ,makeNationalSpot({ id: 'castle-232', name: '小浜城跡', category: 'castle', region: '中部', coordinate: { latitude: 35.4940, longitude: 135.7390, elevationMeter: 5 }, era: 'edo', eraLabel: '慶長6年（1601年）築城開始・若狭小浜藩の居城', castleType: '城跡・平城・福井県指定史跡', summary: '小浜湾と河川に囲まれた水城で、京極・酒井氏が治めた若狭の藩政拠点です。', description: '小浜城跡は関ヶ原後の慶長6年（1601年）に築城が始まり、酒井忠勝の時代に天守などが完成した若狭小浜藩の居城です。小浜神社境内に残る高石垣と礎石から、港湾都市と藩政の歴史を紹介します。', sourceName: '小浜市公式サイト（小浜城跡）', sourceUrl: 'https://www1.city.obama.fukui.jp/kanko-bunka/jisha-shiseki/82.html' })
  ,makeNationalSpot({ id: 'castle-233', name: '石垣山城跡', category: 'castle', region: '関東', coordinate: { latitude: 35.2380, longitude: 139.1310, elevationMeter: 250 }, era: 'sengoku', eraLabel: '天正18年（1590年）小田原合戦の豊臣秀吉本陣', castleType: '国指定史跡・総石垣の陣城・石垣山一夜城', summary: '小田原城を包囲した豊臣秀吉が築き、近世城郭への転換を示す総石垣の城跡です。', description: '石垣山城跡は天正18年（1590年）の小田原合戦で、豊臣秀吉が小田原城攻略のために築いた城です。自然石を積む野面積みの石垣、本丸・二の丸・井戸曲輪などの構成から、天下統一戦争と安土桃山期の築城技術を紹介します。', sourceName: '小田原市公式サイト（史跡・石垣山）', sourceUrl: 'https://www.city.odawara.kanagawa.jp/field/lifelong/property/cultural/historic/s-ishigakiyama.html' })
  ,makeNationalSpot({ id: 'religious-351', name: '砥鹿神社', category: 'religious', region: '中部', coordinate: { latitude: 34.8480, longitude: 137.4208, elevationMeter: 50 }, era: 'asuka', eraLabel: '大宝元〜4年（701〜704年）鎮座伝承・三河国一之宮', religiousType: '神社・三河国一之宮・本宮山信仰', summary: '本宮山の奥宮と里宮が一体となった、三河国一之宮です。', description: '砥鹿神社は大己貴命を祀り、本宮山の奥宮と山麓の里宮が二所一体で信仰されてきました。延喜式内社・三河国一之宮としての歴史と、本宮山の磐座や水源への自然信仰から、東三河の古代祭祀を紹介します。', sourceName: '三河國一之宮 砥鹿神社 公式サイト', sourceUrl: 'https://www.togajinja.or.jp/about/' })
  ,makeNationalSpot({ id: 'religious-352', name: '椿大神社', category: 'religious', region: '中部', coordinate: { latitude: 34.9614, longitude: 136.4547, elevationMeter: 110 }, era: 'ancient', eraLabel: '垂仁天皇27年（紀元前3年）創建伝承・伊勢国一之宮', religiousType: '神社・猿田彦大神・道開き信仰', summary: '猿田彦大神を祀り、道開きと鈴鹿山系の山岳信仰を伝える古社です。', description: '椿大神社は猿田彦大神を主神とし、鈴鹿山系の自然を神域として崇敬を集めてきました。道開きの神としての信仰や、伊勢国一之宮・全国の猿田彦神社の総本宮という位置づけから、交通と人生の道を結ぶ信仰を紹介します。', sourceName: '椿大神社 公式サイト（椿大神社について）', sourceUrl: 'https://tsubaki.or.jp/about/' })
  ,makeNationalSpot({ id: 'religious-353', name: '射水神社', category: 'religious', region: '中部', coordinate: { latitude: 36.7485, longitude: 137.0216, elevationMeter: 20 }, era: 'ancient', eraLabel: '古代創祀・越中国一之宮・延喜式名神大社', religiousType: '神社・越中国一之宮・高岡古城公園', summary: '高岡古城公園の本丸跡に鎮座する、越中の総鎮守です。', description: '射水神社は二上神を祀る越中国一之宮で、延喜式では越中国唯一の名神大社とされています。古代の国造が国の安寧と五穀豊穣を祈った由緒と、高岡城跡への遷座を通じて、地域の祭祀と城下町の重なりを紹介します。', sourceName: '越中総鎮守一宮 射水神社 公式サイト', sourceUrl: 'https://www.imizujinjya.or.jp/about' })
  ,makeNationalSpot({ id: 'religious-354', name: '駒形神社', category: 'religious', region: '東北', coordinate: { latitude: 39.1364, longitude: 141.1385, elevationMeter: 40 }, era: 'ancient', eraLabel: '1500年ほど前の駒ヶ岳山頂鎮座伝承・陸中国一之宮', religiousType: '神社・陸中国一之宮・駒ヶ岳信仰', summary: '駒ヶ岳を神体山と仰ぎ、奥州の馬と農耕の信仰を伝える一之宮です。', description: '駒形神社は焼石連峰の駒ヶ岳山頂に祀られたことを起源と伝え、現在は奥州市水沢に鎮座する陸中国一之宮です。山頂の奥宮と里宮を結ぶ信仰、馬や農耕に関わる神徳から、奥州の山岳祭祀を紹介します。', sourceName: '陸中一宮 駒形神社 公式サイト', sourceUrl: 'https://komagata.iwate.jp/about/' })
  ,makeNationalSpot({ id: 'religious-355', name: '西寒多神社', category: 'religious', region: '九州・沖縄', coordinate: { latitude: 33.1727, longitude: 131.5984, elevationMeter: 35 }, era: 'ancient', eraLabel: '応神天皇9年（278年）創始伝承・豊後国一之宮', religiousType: '神社・豊後国一之宮・本宮山信仰', summary: '本宮山から現在地へ遷った、豊後国一之宮の古社です。', description: '西寒多神社は応神天皇9年に西寒多山（現在の本宮山）へ宮殿を建立したことを創始と伝え、室町期に現在地へ遷座しました。豊後国一之宮としての祭祀と、万年橋など境内の歴史景観から、大分の地域信仰を紹介します。', sourceName: '豊後一ノ宮 西寒多神社 公式サイト', sourceUrl: 'https://sasamuta.com/' })
  ,makeNationalSpot({ id: 'religious-356', name: '都農神社', category: 'religious', region: '九州・沖縄', coordinate: { latitude: 32.2631, longitude: 131.5587, elevationMeter: 60 }, era: 'ancient', eraLabel: '日向国一之宮・延喜式内社', religiousType: '神社・日向国一之宮・大己貴命信仰', summary: '日向国一之宮として、国土平安と海上安全を祈る古社です。', description: '都農神社は大己貴命を祀る日向国一之宮で、神武天皇が当地で国土平安や海上平穏を祈ったことを創祀と伝えます。延喜式内社としての格式と、日向灘に面した信仰の立地から、南九州の古代祭祀を紹介します。', sourceName: '宮崎県公式観光サイト（都農神社）', sourceUrl: 'https://www.kanko-miyazaki.jp/spot/1098' })
  ,makeNationalSpot({ id: 'religious-357', name: '大鳥大社', category: 'religious', region: '近畿', coordinate: { latitude: 34.5367, longitude: 135.4607, elevationMeter: 20 }, era: 'ancient', eraLabel: '延喜式名神大社・和泉国一之宮', religiousType: '神社・日本武尊信仰・和泉国一之宮', summary: '日本武尊の白鳥伝承を伝え、国家の祈雨・防災祈願を担った和泉国一之宮です。', description: '大鳥大社は延喜式神名帳に載る和泉国一之宮で、日本武尊の霊が白鳥となって当地に留まったという由緒を伝えます。古代の国家的な祈雨・防災祈願の社としての役割から、災害と祭祀の歴史的な結びつきを紹介します。', sourceName: '大鳥大社 公式サイト（由緒沿革）', sourceUrl: 'https://www.ootoritaisha.jp/taisha/' })
  ,makeNationalSpot({ id: 'religious-358', name: '籠神社', category: 'religious', region: '近畿', coordinate: { latitude: 35.5828, longitude: 135.1967, elevationMeter: 8 }, era: 'ancient', eraLabel: '丹後国一之宮・延喜式名神大社・元伊勢', religiousType: '神社・丹後国一之宮・元伊勢信仰', summary: '天橋立の北に鎮座し、元伊勢と丹後国一之宮の伝承を伝える古社です。', description: '籠神社は丹後国一之宮で、延喜式に名神大社として記された古社です。天照大神を一時祀った元伊勢の伝承や、海部氏の祭政を伝える国宝系図から、日本海沿岸の古代信仰と海上交通を紹介します。', sourceName: '宮津市公式サイト（籠神社）', sourceUrl: 'https://www.city.miyazu.kyoto.jp/soshiki/85/3315.html' })
  ,makeNationalSpot({ id: 'castle-234', name: '芥川山城跡', category: 'castle', region: '近畿', coordinate: { latitude: 34.8820, longitude: 135.5940, elevationMeter: 183 }, era: 'sengoku', eraLabel: '永正13年（1516年）までに築城・三好長慶の居城', castleType: '国指定史跡・続日本100名城・山城', summary: '三好長慶が畿内を治めた、戦国期の政治・軍事拠点です。', description: '芥川山城跡は三好山に築かれた戦国時代の山城で、三好長慶が天文22年（1553年）に入城しました。主郭・東郭・堀切・土塁などの遺構から、畿内政権の中枢となった山城の構造を紹介します。', sourceName: '高槻市公式サイト（続日本100名城 芥川山城跡）', sourceUrl: 'https://www.city.takatsuki.osaka.jp/site/history/4622.html' })
  ,makeNationalSpot({ id: 'castle-235', name: '飯盛城跡', category: 'castle', region: '近畿', coordinate: { latitude: 34.7280, longitude: 135.6380, elevationMeter: 314 }, era: 'sengoku', eraLabel: '三好長慶の最後の居城・国指定史跡', castleType: '国指定史跡・続日本100名城・山城', summary: '三好長慶が拠点とした、西日本有数の規模を持つ戦国山城です。', description: '飯盛城跡は飯盛山に築かれた東西約400メートル、南北約700メートルの大規模な山城です。堀切・石垣・郭が連なる構造から、三好政権の政治・軍事と戦国山城の発達を紹介します。', sourceName: '大東市公式サイト（飯盛城）', sourceUrl: 'https://www.city.daito.lg.jp/site/miryoku/19937.html' })
  ,makeNationalSpot({ id: 'castle-236', name: '若桜鬼ヶ城跡', category: 'castle', region: '中国', coordinate: { latitude: 35.3420, longitude: 134.3970, elevationMeter: 452 }, era: 'sengoku', eraLabel: '播磨・但馬街道の結節点・国指定史跡', castleType: '国指定史跡・続日本100名城・山城', summary: '因幡の街道を押さえ、本丸・二の丸に石垣を残す山城です。', description: '若桜鬼ヶ城跡は鶴尾山に築かれ、播磨・但馬へ通じる街道の結節点として機能しました。複数時期の城跡や廊下橋虎口などの遺構から、中世から近世への城郭の変化を紹介します。', sourceName: '鳥取県公式文化財ナビ（若桜鬼ヶ城跡）', sourceUrl: 'https://db.pref.tottori.jp/bunkazainavi.nsf/bunkazai_web_view/785D5B942E01FACF49257AB4002925DA' })
  ,makeNationalSpot({ id: 'castle-237', name: '美濃金山城跡', category: 'castle', region: '中部', coordinate: { latitude: 35.4260, longitude: 137.0220, elevationMeter: 235 }, era: 'sengoku', eraLabel: '天文6年（1537年）築城伝承・森氏の居城', castleType: '国指定史跡・山城・織豊期城郭', summary: '森氏が東美濃支配の拠点とした、木曽川沿いの戦国山城です。', description: '美濃金山城跡は古城山の頂に築かれ、斎藤氏から織田氏、森氏へと城主が移りました。石垣や曲輪、織豊期の城郭構造から、森氏と東美濃の支配を紹介します。', sourceName: '可児市公式サイト（国史跡 美濃金山城跡）', sourceUrl: 'https://www.city.kani.lg.jp/5580.htm' })
  ,makeNationalSpot({ id: 'castle-238', name: '佐柿国吉城跡', category: 'castle', region: '中部', coordinate: { latitude: 35.6160, longitude: 135.9250, elevationMeter: 197 }, era: 'sengoku', eraLabel: '弘治2年（1556年）築城伝承・朝倉氏を退けた境目の城', castleType: '町指定史跡・続日本100名城・山城', summary: '織田信長ら三英傑も入城した、若狭と越前の境を守る山城です。', description: '佐柿国吉城跡は弘治2年（1556年）築城と伝わり、越前朝倉氏の侵攻を繰り返し退けた「難攻不落」の城です。信長・秀吉・家康が入城した歴史と、城下町佐柿の景観から、戦国の国境支配を紹介します。', sourceName: '美浜町公式サイト（国吉城址）', sourceUrl: 'https://www.town.fukui-mihama.lg.jp/soshiki/30/493.html' })
  ,makeNationalSpot({ id: 'castle-239', name: '新高山城跡', category: 'castle', region: '中国', coordinate: { latitude: 34.4120, longitude: 132.9520, elevationMeter: 197 }, era: 'sengoku', eraLabel: '天文21年（1552年）築城・小早川隆景の本拠', castleType: '国指定史跡・小早川氏城跡・山城', summary: '小早川隆景が本拠を移した、瀬戸内を望む中世山城です。', description: '新高山城跡は天文21年（1552年）に小早川隆景が築き、高山城から本拠を移した城です。本丸・中の丸・釣井の段などの郭と石垣・井戸から、戦国大名の領国支配を紹介します。', sourceName: '三原市公式サイト（新高山城跡）', sourceUrl: 'https://www.city.mihara.hiroshima.jp/soshiki/50/139862.html' })
  ,makeNationalSpot({ id: 'castle-240', name: '大和郡山城跡', category: 'castle', region: '近畿', coordinate: { latitude: 34.6470, longitude: 135.7820, elevationMeter: 70 }, era: 'sengoku', eraLabel: '筒井順慶・豊臣秀長の居城・郡山藩の城下', castleType: '城跡・続日本100名城・近世平城', summary: '豊臣秀長の居城となり、奈良盆地の政治拠点として整えられた城跡です。', description: '大和郡山城跡は戦国期の筒井氏から豊臣秀長へと城主が移り、近世には郡山藩の城下町の中心となりました。天守台や石垣、城下の町割から、大和の領国支配と近世都市の形成を紹介します。', sourceName: '奈良県公式観光サイト（郡山城跡）', sourceUrl: 'https://yamatoji.nara-kankou.or.jp/03history/07castle/02west_area/koriyamajoseki/' })
  ,makeNationalSpot({ id: 'castle-241', name: '三春城跡', category: 'castle', region: '東北', coordinate: { latitude: 37.4440, longitude: 140.4930, elevationMeter: 410 }, era: 'sengoku', eraLabel: '三春藩主田村氏の居城・続日本100名城', castleType: '城跡・続日本100名城・山城', summary: '城下町三春の中心に位置し、田村氏と近世藩政の歴史を伝える城跡です。', description: '三春城跡は田村氏の居城として発展し、近世には三春藩の城下町を見下ろす丘陵の城となりました。曲輪や土塁などの遺構と城下町の景観から、奥州の領主支配の変遷を紹介します。', sourceName: '三春町公式サイト（文化財保存活用地域計画）', sourceUrl: 'https://www.town.miharu.fukushima.jp/soshiki/19/uploads/%E7%AC%AC8%E5%9B%9E%E4%B8%89%E6%98%A5%E7%94%BA%E6%96%87%E5%8C%96%E8%B2%A1%E4%BF%9D%E5%AD%98%E6%B4%BB%E7%94%A8%E5%9C%B0%E5%9F%9F%E8%A8%88%E7%94%BB%E7%AD%96%E5%AE%9A%E5%8D%94%E8%AD%B0%E4%BC%9A%E8%B3%87%E6%96%99%E4%B8%80%E5%BC%8F.pdf' })
].filter(spot => !['castle-238', 'castle-241'].includes(spot.id)).concat([
  makeNationalSpot({ id: 'castle-238', name: '佐柿国吉城跡', category: 'castle', region: '中部', coordinate: { latitude: 35.6160, longitude: 135.9250, elevationMeter: 197 }, era: 'sengoku', eraLabel: '弘治2年（1556年）築城伝承・朝倉氏を退けた境目の城', castleType: '町指定史跡・続日本100名城・山城', summary: '織田信長ら三英傑も入城した、若狭と越前の境を守る山城です。', description: '佐柿国吉城跡は弘治2年（1556年）築城と伝わり、越前朝倉氏の侵攻を繰り返し退けた「難攻不落」の城です。信長・秀吉・家康が入城した歴史と、城下町佐柿の景観から、戦国の国境支配を紹介します。', sourceName: '美浜町公式サイト（国吉城址）', sourceUrl: 'https://www.town.fukui-mihama.lg.jp/soshiki/30/493.html' }),
  makeNationalSpot({ id: 'castle-241', name: '出石城・有子山城跡', category: 'castle', region: '近畿', coordinate: { latitude: 35.4630, longitude: 134.8720, elevationMeter: 320 }, era: 'sengoku', eraLabel: '天正2年（1574年）有子山城・慶長9年（1604年）出石城', castleType: '国指定史跡・続日本100名城・山城／平山城', summary: '山名氏の山城と小出氏の城下を一体で伝える但馬の城郭群です。', description: '出石城・有子山城跡は、山名氏が築いた標高320メートルの有子山城と、麓に小出氏が整備した出石城からなる城郭群です。山城から近世の城下町へ移る過程と石垣・曲輪の構造を紹介します。', sourceName: '豊岡市公式サイト（国史跡 有子山城跡）', sourceUrl: 'https://www.city.toyooka.lg.jp/shisei/1027491/1027495/1029005.html' })
  ,makeNationalSpot({ id: 'religious-359', name: '焼山寺', category: 'religious', region: '四国', coordinate: { latitude: 33.9698, longitude: 134.3276, elevationMeter: 700 }, era: 'heian', eraLabel: '弘仁6年（815年）開創伝承・四国八十八箇所第12番', religiousType: '寺院・真言宗・山岳霊場・四国遍路', summary: '焼山寺山の深い山中にたたずむ、四国遍路を代表する難所の札所です。', description: '焼山寺は標高の高い焼山寺山にあり、遍路ころがしと呼ばれる山道を越えて参詣する第12番札所です。山岳修行と弘法大師信仰が重なる霊場として、歩いて祈る遍路の文化を紹介します。', sourceName: '四国八十八ヶ所霊場会 公式サイト（第12番 焼山寺）', sourceUrl: 'https://88shikokuhenro.jp/12shozanji/' })
  ,makeNationalSpot({ id: 'religious-360', name: '太龍寺', category: 'religious', region: '四国', coordinate: { latitude: 33.8814, longitude: 134.5200, elevationMeter: 618 }, era: 'nara', eraLabel: '延暦12年（793年）開創伝承・四国八十八箇所第21番', religiousType: '寺院・高野山真言宗・山岳霊場・四国遍路', summary: '太龍寺山の山頂近くにあり、「西の高野」とも称される山岳寺院です。', description: '太龍寺は標高618メートルの太龍寺山に位置する第21番札所です。舎心嶽で弘法大師が虚空蔵求聞持法を修めたという伝承を持ち、山岳修行の場としての遍路を伝えます。', sourceName: '四国八十八ヶ所霊場会 公式サイト（第21番 太龍寺）', sourceUrl: 'https://88shikokuhenro.jp/21tairyuji/' })
  ,makeNationalSpot({ id: 'religious-361', name: '雲辺寺', category: 'religious', region: '四国', coordinate: { latitude: 34.0352, longitude: 133.7237, elevationMeter: 911 }, era: 'nara', eraLabel: '延暦8年（789年）開創伝承・四国八十八箇所第66番', religiousType: '寺院・真言宗御室派・山岳霊場・四国遍路', summary: '標高約911メートルの雲辺寺山にある、四国遍路最高所の札所です。', description: '雲辺寺は第66番札所で、四国八十八箇所の中でも最も高い場所に位置します。阿波と讃岐の境に広がる山岳景観と千手観音への信仰を通じ、国境を越えて続く遍路文化を紹介します。', sourceName: '四国八十八ヶ所霊場会 公式サイト（第66番 雲辺寺）', sourceUrl: 'https://88shikokuhenro.jp/66unpenji/' })
  ,makeNationalSpot({ id: 'religious-362', name: '根香寺', category: 'religious', region: '四国', coordinate: { latitude: 34.3445, longitude: 133.9606, elevationMeter: 360 }, era: 'heian', eraLabel: '弘仁年間（810〜824年）開創伝承・四国八十八箇所第82番', religiousType: '寺院・天台宗・五色台の山岳霊場・四国遍路', summary: '五色台の青峰にあり、牛鬼伝説も残る第82番札所です。', description: '根香寺は五色台の主峰・青峰に開かれた山岳寺院です。弘法大師と智証大師にまつわる開創伝承や牛鬼伝説を持ち、海を望む山の遍路道と地域の物語を紹介します。', sourceName: '四国八十八ヶ所霊場会 公式サイト（第82番 根香寺）', sourceUrl: 'https://88shikokuhenro.jp/82negoroji/' })
  ,makeNationalSpot({ id: 'religious-363', name: '一宮寺', category: 'religious', region: '四国', coordinate: { latitude: 34.2861, longitude: 134.0261, elevationMeter: 25 }, era: 'nara', eraLabel: '和銅年間（708〜715年）創建伝承・四国八十八箇所第83番', religiousType: '寺院・讃岐国一宮ゆかり・四国遍路', summary: '讃岐国一宮の信仰と結びつき、高松の市街地に残る第83番札所です。', description: '一宮寺は讃岐国一宮との関わりを持つ寺院で、都市化した高松の中にも遍路の歴史を伝えています。境内の薬師如来信仰と一宮の地名から、古代の地域拠点と巡礼のつながりを紹介します。', sourceName: '四国八十八ヶ所霊場会 公式サイト（第83番 一宮寺）', sourceUrl: 'https://88shikokuhenro.jp/83ichinomiyaji/' })
  ,makeNationalSpot({ id: 'religious-364', name: '八栗寺', category: 'religious', region: '四国', coordinate: { latitude: 34.3597, longitude: 134.1400, elevationMeter: 270 }, era: 'heian', eraLabel: '天長6年（829年）開創伝承・四国八十八箇所第85番', religiousType: '寺院・真言宗大覚寺派・五剣山霊場・四国遍路', summary: '五剣山の山腹にあり、山岳信仰と商売繁昌の祈願で知られる札所です。', description: '八栗寺は五剣山の山腹に開かれた第85番札所です。弘法大師が五本の剣を納めたという伝承を持ち、山の岩峰と聖観音への信仰が一体となった景観を紹介します。', sourceName: '四国八十八ヶ所霊場会 公式サイト（第85番 八栗寺）', sourceUrl: 'https://88shikokuhenro.jp/85yakuriji/' })
  ,makeNationalSpot({ id: 'religious-365', name: '長尾寺', category: 'religious', region: '四国', coordinate: { latitude: 34.2669, longitude: 134.1714, elevationMeter: 30 }, era: 'nara', eraLabel: '天平11年（739年）創建伝承・四国八十八箇所第87番', religiousType: '寺院・天台宗・四国遍路', summary: '讃岐の門前町にあり、静御前や長尾天神宮の伝承も残る札所です。', description: '長尾寺は第87番札所として、結願の大窪寺へ向かう遍路道の要所となってきました。静御前の伝承や長尾天神宮との関わりを通じ、寺院と地域の物語が重なる讃岐の信仰拠点を紹介します。', sourceName: '四国八十八ヶ所霊場会 公式サイト（第87番 長尾寺）', sourceUrl: 'https://88shikokuhenro.jp/87nagaoji/' })
  ,makeNationalSpot({ id: 'religious-366', name: '横峰寺', category: 'religious', region: '四国', coordinate: { latitude: 33.8379, longitude: 133.1111, elevationMeter: 750 }, era: 'asuka', eraLabel: '白鳳2年（651年）開創伝承・四国八十八箇所第60番', religiousType: '寺院・真言宗御室派・石鎚山系山岳霊場・四国遍路', summary: '石鎚山系の標高750メートル付近にあり、四国遍路屈指の難所とされる札所です。', description: '横峰寺は石鎚山系の深い山中にある第60番札所です。石鎚山の修験道や蔵王権現への信仰と結びついた山岳霊場で、自然の険しさそのものが巡礼の体験になる場所を紹介します。', sourceName: '四国八十八ヶ所霊場会 公式サイト（第60番 横峰寺）', sourceUrl: 'https://88shikokuhenro.jp/60yokomineji/' })
  ,makeNationalSpot({ id: 'castle-242', name: '八幡山城跡', category: 'castle', region: '近畿', coordinate: { latitude: 35.1370, longitude: 136.0950, elevationMeter: 272 }, era: 'sengoku', eraLabel: '天正13年（1585年）築城・豊臣秀次の城下町', castleType: '山城・八幡堀と城下町の歴史景観', summary: '豊臣秀次が築き、近江商人の町の基礎を形づくった山城跡です。', description: '八幡山城跡は豊臣秀次が八幡山に築いた城で、山城と碁盤目状の城下町、八幡堀が一体となって近江八幡の都市景観を形づくりました。城と商業都市の成立を紹介します。', sourceName: '近江八幡市公式サイト（商都ものがたり）', sourceUrl: 'https://www.city.omihachiman.lg.jp/kanko/kanko/3794.html' })
  ,makeNationalSpot({ id: 'castle-243', name: '武田氏館跡', category: 'castle', region: '中部', coordinate: { latitude: 35.6934, longitude: 138.5685, elevationMeter: 350 }, era: 'sengoku', eraLabel: '永正16年（1519年）築館・武田氏三代の本拠', castleType: '国指定史跡・戦国期居館・躑躅ヶ崎館', summary: '武田信虎・信玄・勝頼の三代が政務を行った、甲斐の中世居館跡です。', description: '武田氏館跡は永正16年に武田信虎が築き、信虎・信玄・勝頼の三代が居住した甲斐武田氏の本拠です。現在の武田神社と堀・土塁に残る館の構造から、戦国大名の政治拠点を紹介します。', sourceName: '甲府市公式サイト（武田氏館跡）', sourceUrl: 'https://www.city.kofu.yamanashi.jp/senior/bunkazai/002.html' })
  ,makeNationalSpot({ id: 'castle-244', name: '足利氏宅跡（鑁阿寺）', category: 'castle', region: '関東', coordinate: { latitude: 36.3340, longitude: 139.4530, elevationMeter: 35 }, era: 'kamakura', eraLabel: '12世紀後半成立・室町将軍家ゆかりの中世武士館', castleType: '国指定史跡・中世武士館・堀と土塁', summary: '足利氏の氏寺・鑁阿寺として受け継がれる、方形の中世武士館跡です。', description: '足利氏宅跡は12世紀後半に足利氏が築いた館で、現在は鑁阿寺の境内として堀と土塁が残ります。武士の居館が氏寺へ受け継がれた姿から、鎌倉・室町期の政治と宗教の結びつきを紹介します。', sourceName: '足利市公式サイト（史跡足利氏宅跡）', sourceUrl: 'https://www.city.ashikaga.tochigi.jp/category/000000/p000903.html' })
  ,makeNationalSpot({ id: 'castle-245', name: '小田原城跡', category: 'castle', region: '関東', coordinate: { latitude: 35.2503, longitude: 139.1537, elevationMeter: 20 }, era: 'sengoku', eraLabel: '北条氏五代の本城・天正18年（1590年）小田原合戦', castleType: '国指定史跡・日本100名城・総構をもつ城郭', summary: '北条氏の本城として拡大し、戦国最大級の総構を備えた城跡です。', description: '小田原城跡は北条氏の本城として発展し、豊臣秀吉の小田原合戦では城下を包む約9キロメートルの総構が築かれました。城と城下町を一体で守る戦国大名の本拠を紹介します。', sourceName: '小田原市公式サイト（史跡・小田原城跡）', sourceUrl: 'https://www.city.odawara.kanagawa.jp/field/lifelong/property/cultural/historic/s-odawarazyou.html' })
  ,makeNationalSpot({ id: 'castle-246', name: '会津若松城跡（鶴ヶ城）', category: 'castle', region: '東北', coordinate: { latitude: 37.4870, longitude: 139.9298, elevationMeter: 220 }, era: 'edo', eraLabel: '文禄2年（1593年）天守整備・戊辰戦争の舞台', castleType: '国指定史跡・日本100名城・城下町の中核', summary: '会津の政治拠点として発展し、戊辰戦争の歴史を伝える城跡です。', description: '会津若松城跡は若松城・鶴ヶ城とも呼ばれ、会津の城下町を支えた平城です。近世の城郭整備と戊辰戦争時の籠城の記憶を重ねながら、東北の政治・軍事拠点の歴史を紹介します。', sourceName: '会津若松市公式サイト（若松城跡）', sourceUrl: 'https://www.city.aizuwakamatsu.fukushima.jp/docs/2012110600030/' })
  ,makeNationalSpot({ id: 'religious-367', name: '賀茂別雷神社（上賀茂神社）', category: 'religious', region: '近畿', coordinate: { latitude: 35.0594, longitude: 135.7528, elevationMeter: 75 }, era: 'asuka', eraLabel: '天武天皇6年（677年）造営伝承・山城国一之宮', religiousType: '神社・賀茂信仰・世界文化遺産', summary: '神山への信仰を起源とし、平安京の鎮護を担った京都最古級の古社です。', description: '上賀茂神社は神山に降臨した賀茂別雷大神を祀り、天武天皇6年の造営を由緒として伝えます。山と社殿、葵祭の文化を通じ、古代の自然信仰が都の祭祀へ展開した姿を紹介します。', sourceName: '賀茂別雷神社（上賀茂神社）公式サイト（御由緒）', sourceUrl: 'https://www.kamigamojinja.jp/about/yuisho/' })
  ,makeNationalSpot({ id: 'religious-368', name: '賀茂御祖神社（下鴨神社）', category: 'religious', region: '近畿', coordinate: { latitude: 35.0394, longitude: 135.7731, elevationMeter: 50 }, era: 'ancient', eraLabel: '古代の賀茂祭・糺の森の信仰', religiousType: '神社・賀茂信仰・世界文化遺産', summary: '糺の森と賀茂川・高野川の合流点に鎮座する、京都の古社です。', description: '下鴨神社は賀茂御祖神社とも呼ばれ、糺の森を含む境内が古都京都の文化財を構成します。上賀茂神社とともに葵祭を担い、森と水辺の信仰が都市の祭礼に受け継がれています。', sourceName: '京都市公式サイト（賀茂御祖神社）', sourceUrl: 'https://www.city.kyoto.lg.jp/bunshi/page/0000005607.html' })
  ,makeNationalSpot({ id: 'religious-369', name: '談山神社', category: 'religious', region: '近畿', coordinate: { latitude: 34.4672, longitude: 135.8612, elevationMeter: 500 }, era: 'asuka', eraLabel: '白鳳8年（679年）創建伝承・藤原鎌足公を祀る', religiousType: '神社・山岳信仰・神仏習合の歴史', summary: '大化の改新につながる談合の地と伝わる、多武峰の山中の社です。', description: '談山神社は藤原鎌足公を祀り、鎌足を弔う十三重塔や講堂を起源とする多武峰の信仰を伝えます。神社となる以前の寺院との関係から、神仏習合と国家形成の記憶が重なる場所を紹介します。', sourceName: '談山神社公式サイト（歴史）', sourceUrl: 'https://www.tanzan.or.jp/rekishi.html' })
  ,makeNationalSpot({ id: 'religious-370', name: '三室戸寺', category: 'religious', region: '近畿', coordinate: { latitude: 34.8968, longitude: 135.8050, elevationMeter: 50 }, era: 'nara', eraLabel: '西国三十三所第10番札所・宇治の観音霊場', religiousType: '寺院・西国三十三所・観音信仰', summary: '宇治の山あいで観音信仰を伝える、西国三十三所第10番札所です。', description: '三室戸寺は明星山にある西国三十三所第10番札所で、平安時代から広がった観音信仰の巡礼地です。季節の花が彩る境内と宇治の歴史を結び、歩いて祈る西国巡礼の文化を紹介します。', sourceName: '三室戸寺公式サイト', sourceUrl: 'https://www.mimurotoji.com/' })
  ,makeNationalSpot({ id: 'religious-371', name: '壷阪寺（南法華寺）', category: 'religious', region: '近畿', coordinate: { latitude: 34.4498, longitude: 135.8089, elevationMeter: 300 }, era: 'nara', eraLabel: '西国三十三所第6番札所・眼病封じの信仰', religiousType: '寺院・西国三十三所・観音信仰', summary: '高取の山中にあり、眼病封じの観音信仰と国際的な文化交流を伝える寺院です。', description: '壷阪寺は南法華寺とも呼ばれ、西国三十三所第6番札所として観音信仰を集めてきました。壺阪霊験記の物語やインドとの交流から、祈りが地域の物語と国境を越えた文化へ広がる姿を紹介します。', sourceName: '壷阪寺公式サイト', sourceUrl: 'https://www.tsubosaka1300.or.jp/' })
  ,makeNationalSpot({ id: 'religious-372', name: '紀三井寺（金剛宝寺）', category: 'religious', region: '近畿', coordinate: { latitude: 34.1909, longitude: 135.1674, elevationMeter: 50 }, era: 'nara', eraLabel: '西国三十三所第2番札所・名草山の観音霊場', religiousType: '寺院・西国三十三所・観音信仰', summary: '名草山の中腹にあり、和歌浦を望む西国三十三所第2番札所です。', description: '紀三井寺は名草山の中腹に開かれた観音霊場で、境内の三井水や早咲きの桜でも知られます。和歌浦の海と山の景観を背景に、古代から続く巡礼と水の信仰を紹介します。', sourceName: '紀三井寺公式サイト', sourceUrl: 'https://www.kimiidera.com/' })
  ,makeNationalSpot({ id: 'religious-373', name: '勝尾寺', category: 'religious', region: '近畿', coordinate: { latitude: 34.8649, longitude: 135.4902, elevationMeter: 350 }, era: 'nara', eraLabel: '西国三十三所第23番札所・勝運信仰', religiousType: '寺院・西国三十三所・勝運信仰', summary: '箕面の山中にあり、「勝運の寺」として広く信仰される西国霊場です。', description: '勝尾寺は箕面の山中にある西国三十三所第23番札所です。山岳寺院の静けさと勝運を願う参詣が重なり、古い巡礼が現代の祈願文化へ受け継がれる姿を紹介します。', sourceName: '勝尾寺公式サイト', sourceUrl: 'https://katsuo-ji-temple.or.jp/' })
  ,makeNationalSpot({ id: 'religious-374', name: '日光山輪王寺', category: 'religious', region: '関東', coordinate: { latitude: 36.7547, longitude: 139.6042, elevationMeter: 650 }, era: 'nara', eraLabel: '天平神護2年（766年）開山・日光山の中心寺院', religiousType: '寺院・天台宗・日光の社寺・山岳信仰', summary: '二荒山神社・東照宮とともに日光山の宗教景観を形づくる中心寺院です。', description: '輪王寺は勝道上人による日光開山を起源とし、日光山の仏教施設として発展しました。神社と寺院が一体だった日光山の歴史や、徳川家光の大猷院を通じ、神仏習合の宗教景観を紹介します。', sourceName: '日光山輪王寺公式サイト（輪王寺について）', sourceUrl: 'https://www.rinnoji.or.jp/history/' })
  ,makeNationalSpot({ id: 'religious-375', name: '津島神社', category: 'religious', region: '中部', coordinate: { latitude: 35.1771, longitude: 136.7273, elevationMeter: 5 }, era: 'ancient', eraLabel: '欽明天皇元年（540年）鎮座伝承・全国天王総本社', religiousType: '神社・津島信仰・疫病除け', summary: '疫病除けの津島信仰を全国へ広げた、天王社の総本社です。', description: '津島神社は建速須佐之男命を祀り、疫病や災厄を除ける神として信仰を集めてきました。織田・豊臣氏の崇敬や天王祭の文化から、地域の祭礼と全国的な分霊の広がりを紹介します。', sourceName: '津島神社公式サイト（由緒）', sourceUrl: 'https://tsushimajinja.or.jp/' })
  ,makeNationalSpot({ id: 'religious-376', name: '南宮大社', category: 'religious', region: '中部', coordinate: { latitude: 35.3708, longitude: 136.5297, elevationMeter: 35 }, era: 'ancient', eraLabel: '美濃国一宮・金山彦命を祀る金属の総本宮', religiousType: '神社・美濃国一宮・金属信仰', summary: '鉱山・金属の神を祀り、美濃国一宮として崇敬されてきた古社です。', description: '南宮大社は金山彦命を祀る美濃国一宮で、古くから金属業の総本宮として信仰を集めてきました。関ケ原後に徳川家光の天下普請で再建された社殿群と、金属に関わる祭祀から産業と宗教の結びつきを紹介します。', sourceName: '岐阜県公式サイト（南宮神社・重要文化財）', sourceUrl: 'https://www.pref.gifu.lg.jp/page/354085.html' })
  ,makeNationalSpot({ id: 'religious-377', name: '青井阿蘇神社', category: 'religious', region: '九州・沖縄', coordinate: { latitude: 32.2149, longitude: 130.7514, elevationMeter: 105 }, era: 'edo', eraLabel: '大同元年（806年）創建伝承・国宝社殿', religiousType: '神社・阿蘇信仰・球磨地方の総鎮守', summary: '人吉球磨の開拓と地域信仰を支え、社殿群が国宝に指定される古社です。', description: '青井阿蘇神社は阿蘇神社の分霊を祀り、人吉球磨の開拓と安泰を願う信仰の拠点となってきました。本殿・廊・幣殿・拝殿・楼門からなる社殿群を通じ、九州の地域文化と神社建築を紹介します。', sourceName: '青井阿蘇神社公式サイト', sourceUrl: 'https://aoisan.jp/about/kami/' })
  ,makeNationalSpot({ id: 'castle-247', name: '宇都宮城跡', category: 'castle', region: '関東', coordinate: { latitude: 36.5551, longitude: 139.8834, elevationMeter: 130 }, era: 'edo', eraLabel: '平安時代後期築城伝承・日光社参の宿城', castleType: '城跡・宇都宮氏の居城・近世平城', summary: '宇都宮氏の中世居城から、将軍の日光社参を支えた近世城郭へ発展した城跡です。', description: '宇都宮城は平安時代後期の築城伝承を持ち、宇都宮氏の居城として中世から発展しました。江戸時代には日光社参の将軍が宿泊する城となり、城と街道・都市の関係を紹介します。', sourceName: '宇都宮市公式サイト（宇都宮城の歴史）', sourceUrl: 'https://www.city.utsunomiya.lg.jp/citypromotion/kanko/meisho/jyiousi/1007284.html' })
  ,makeNationalSpot({ id: 'castle-248', name: '土浦城跡（亀城公園）', category: 'castle', region: '関東', coordinate: { latitude: 36.0834, longitude: 140.1996, elevationMeter: 25 }, era: 'edo', eraLabel: '永享年間（1429〜1440年）築城伝承・水城', castleType: '県指定史跡・水城・現存櫓門', summary: '本丸が水堀に浮かぶ亀の姿にたとえられた、関東を代表する平城跡です。', description: '土浦城跡は亀城とも呼ばれる水城で、本丸・二の丸跡が亀城公園として保存されています。現存する櫓門や堀の景観から、霞ヶ浦周辺の水運と近世城下町の構造を紹介します。', sourceName: '土浦市公式サイト（名所・史跡）', sourceUrl: 'https://www.city.tsuchiura.lg.jp/kanko-bunka-sports/kanko-matsuri-event/kanko/page001098.html' })
  ,makeNationalSpot({ id: 'castle-249', name: '館林城跡', category: 'castle', region: '関東', coordinate: { latitude: 36.2449, longitude: 139.5295, elevationMeter: 20 }, era: 'edo', eraLabel: '城沼を要害とする平城・館林藩の居城', castleType: '市指定史跡・平城・城沼の水城', summary: '城沼を天然の堀として利用した、館林藩の政治拠点です。', description: '館林城跡は城沼を要害とし、その西側の台地に築かれた平城です。歴代城主と城下町、尾曳稲荷神社などの周辺文化資産から、城を中心とした地域の歴史を紹介します。', sourceName: '館林市公式サイト（歴史文化保存活用計画）', sourceUrl: 'https://www.city.tatebayashi.gunma.jp/s091/shisei/020/keikaku5.pdf' })
  ,makeNationalSpot({ id: 'castle-250', name: '尼崎城跡', category: 'castle', region: '近畿', coordinate: { latitude: 34.7164, longitude: 135.4164, elevationMeter: 3 }, era: 'edo', eraLabel: '元和3年（1617年）築城・大坂西方の守り', castleType: '城跡・近世平城・復元天守', summary: '大坂城の西を守る役割を期待され、海と川に囲まれた近世城郭です。', description: '尼崎城は元和3年に戸田氏鉄が築き、三重の堀をめぐらせた近世の平城です。庄下川や海との関係から「琴浦城」とも呼ばれた城の立地と、大坂を支えた西方の防衛拠点を紹介します。', sourceName: '尼崎市公式サイト（尼崎城跡）', sourceUrl: 'https://www.city.amagasaki.hyogo.jp/manabu/bunkazai_0/1028308/1028344/1028734.html' })
  ,makeNationalSpot({ id: 'castle-251', name: '龍野城跡', category: 'castle', region: '近畿', coordinate: { latitude: 34.8680, longitude: 134.5450, elevationMeter: 50 }, era: 'edo', eraLabel: '明応8年（1499年）築城伝承・脇坂氏の城下', castleType: '城跡・山城と平山城・復元門櫓', summary: '鶏籠山の中世城郭から麓の近世城郭へ移った、播磨の城下町です。', description: '龍野城は鶏籠山の朝霧城を起源とし、近世には山麓へ城を移して整備されました。山城と城下町、復元された門・櫓・御殿を通じ、中世から近世へ変化する城郭の姿を紹介します。', sourceName: '兵庫県立歴史博物館（龍野城）', sourceUrl: 'https://rekihaku.pref.hyogo.lg.jp/castle/tatsuno/' })
  ,makeNationalSpot({ id: 'religious-378', name: '岡寺（龍蓋寺）', category: 'religious', region: '近畿', coordinate: { latitude: 34.4718, longitude: 135.8279, elevationMeter: 150 }, era: 'nara', eraLabel: '約1300年前創建伝承・西国三十三所第7番', religiousType: '寺院・西国三十三所・厄除け観音信仰', summary: '龍を封じたという伝承を持ち、日本最古の厄除け観音霊場とされる飛鳥の古寺です。', description: '岡寺は正式には龍蓋寺といい、義淵僧正が龍を池に封じたという伝承から名づけられました。西国三十三所第7番札所として、塑造如意輪観音への厄除け信仰と飛鳥の古代文化を紹介します。', sourceName: '奈良県公式サイト（岡寺）', sourceUrl: 'https://www.pref.nara.lg.jp/ikasu-nara/bunken/okadera/index.html' })
  ,makeNationalSpot({ id: 'religious-379', name: '善峯寺', category: 'religious', region: '近畿', coordinate: { latitude: 34.9381, longitude: 135.6440, elevationMeter: 300 }, era: 'heian', eraLabel: '長元2年（1029年）開山・西国三十三所第20番', religiousType: '寺院・天台宗・西国三十三所', summary: '京都西山の山中に広大な境内を持つ、西国三十三所第20番札所です。', description: '善峯寺は源算上人が1029年に開いた寺院で、皇室や将軍の帰依を受けて発展しました。遊龍の松や京都を望む山の景観とともに、観音巡礼と山寺の歴史を紹介します。', sourceName: '善峯寺公式サイト（寺の概要）', sourceUrl: 'https://www.yoshiminedera.com/about/overview/index.html' })
  ,makeNationalSpot({ id: 'religious-380', name: '穴太寺', category: 'religious', region: '近畿', coordinate: { latitude: 35.0274, longitude: 135.5458, elevationMeter: 120 }, era: 'nara', eraLabel: '慶雲2年（705年）創建伝承・西国三十三所第21番', religiousType: '寺院・天台宗・西国三十三所', summary: '丹波の里山にたたずみ、涅槃像と庭園で信仰を集める西国札所です。', description: '穴太寺は西国三十三所第21番札所で、病を癒すとされる釈迦涅槃像や名勝庭園を伝えます。亀岡の里山景観と結びついた巡礼文化を紹介します。', sourceName: '西国三十三所札所会公式サイト（第21番 穴太寺）', sourceUrl: 'https://www.saikoku33.gr.jp/place/21' })
  ,makeNationalSpot({ id: 'religious-381', name: '総持寺', category: 'religious', region: '近畿', coordinate: { latitude: 34.8290, longitude: 135.5816, elevationMeter: 35 }, era: 'heian', eraLabel: '仁和2年（886年）開創伝承・西国三十三所第22番', religiousType: '寺院・高野山真言宗・西国三十三所', summary: '包丁の祖を祀る信仰でも知られる、茨木市街の西国三十三所札所です。', description: '総持寺は藤原山蔭中納言が開いたと伝わる西国三十三所第22番札所です。千手観音信仰と包丁塚にまつわる料理文化を通じ、都市の中で続く巡礼と職人の祈りを紹介します。', sourceName: '総持寺公式サイト（交通案内）', sourceUrl: 'https://sojiji.or.jp/access/' })
  ,makeNationalSpot({ id: 'religious-382', name: '書寫山圓教寺', category: 'religious', region: '近畿', coordinate: { latitude: 34.8779, longitude: 134.6675, elevationMeter: 371 }, era: 'heian', eraLabel: '康保3年（966年）開山・西国三十三所第27番', religiousType: '寺院・天台宗・山岳霊場・西国三十三所', summary: '「西の比叡」と呼ばれ、山上に堂宇が点在する播磨の大寺院です。', description: '圓教寺は性空上人が966年に書写山を開いたことを起源とする天台宗の修行道場です。摩尼殿や三つの堂など山上に点在する伽藍と西国三十三所の巡礼を紹介します。', sourceName: '書寫山圓教寺公式サイト（概要）', sourceUrl: 'https://www.shosha.or.jp/description/description.html' })
  ,makeNationalSpot({ id: 'religious-383', name: '吉野神宮', category: 'religious', region: '近畿', coordinate: { latitude: 34.3850, longitude: 135.8459, elevationMeter: 280 }, era: 'meiji', eraLabel: '明治25年（1892年）鎮座・後醍醐天皇を祀る', religiousType: '神社・南朝ゆかり・吉野山の信仰', summary: '吉野の山麓で後醍醐天皇を祀り、南北朝の歴史を伝える神宮です。', description: '吉野神宮は後醍醐天皇を御祭神とし、明治25年の鎮座以来、吉野と南朝の記憶を伝えてきました。吉野山の自然と近代の神宮建築を通じ、歴史的記憶が宗教拠点として再構成された姿を紹介します。', sourceName: '吉野町公式サイト（吉野神宮）', sourceUrl: 'https://www.town.yoshino.nara.jp/cgi-bin/recruit.php/2/detail/87?ck=1' })
  ,makeNationalSpot({ id: 'religious-384', name: '広隆寺', category: 'religious', region: '近畿', coordinate: { latitude: 35.0150, longitude: 135.7012, elevationMeter: 45 }, era: 'asuka', eraLabel: '推古天皇11年（603年）創建伝承・秦氏ゆかり', religiousType: '寺院・真言宗系単立・弥勒菩薩信仰', summary: '秦氏と聖徳太子にゆかりを持ち、飛鳥期の仏像を伝える太秦の古寺です。', description: '広隆寺は蜂岡寺・秦公寺とも呼ばれ、飛鳥時代にさかのぼる仏像と秦氏の歴史を伝えます。弥勒菩薩半跏像などの文化財から、渡来系氏族と古代仏教の交流を紹介します。', sourceName: '京都市公式サイト（秦氏と広隆寺）', sourceUrl: 'https://www2.city.kyoto.lg.jp/somu/rekishi/fm/nenpyou/htmlsheet/toshi01.html' })
  ,makeNationalSpot({ id: 'religious-385', name: '今宮神社', category: 'religious', region: '近畿', coordinate: { latitude: 35.0450, longitude: 135.7358, elevationMeter: 70 }, era: 'heian', eraLabel: '正暦5年（994年）紫野御霊会・疫病退散の信仰', religiousType: '神社・御霊会・疫病除け', summary: '疫病退散を願う「やすらい祭」を伝える、京都西陣の氏神です。', description: '今宮神社は平安京で流行した疫病を鎮める紫野御霊会を起源とし、やすらい祭を今に伝えています。疫病除けの信仰と西陣の町衆、桂昌院による再興の歴史を紹介します。', sourceName: '京都市公式観光Navi（今宮神社）', sourceUrl: 'https://ja.kyoto.travel/tourism/single01.php?category_id=7&tourism_id=496' })
  ,makeNationalSpot({ id: 'castle-252', name: '大溝城跡', category: 'castle', region: '近畿', coordinate: { latitude: 35.2885, longitude: 136.0192, elevationMeter: 90 }, era: 'sengoku', eraLabel: '天正6年（1578年）築城・琵琶湖の水城', castleType: '市指定文化財・水城・織田信澄の城', summary: '乙女ヶ池と水路を要害に取り込んだ、琵琶湖畔の織豊期水城です。', description: '大溝城は織田信長の甥・信澄が1578年に築き、琵琶湖の内湖と川・堀を利用した水城です。城下町や港と一体となった湖上交通の拠点を紹介します。', sourceName: '高島市公式サイト（大溝城跡）', sourceUrl: 'https://www.city.takashima.lg.jp/soshiki/bunkasports/bunkazaika/1/1/665.html' })
  ,makeNationalSpot({ id: 'castle-253', name: '金ヶ崎城跡', category: 'castle', region: '中部', coordinate: { latitude: 35.6658, longitude: 136.0604, elevationMeter: 86 }, era: 'muromachi', eraLabel: '延元元年（1336年）南北朝の戦場・金崎宮境内', castleType: '国指定史跡・山城・南北朝の城跡', summary: '敦賀湾を望む半島にあり、南北朝の攻防を伝える山城跡です。', description: '金ヶ崎城跡は敦賀湾東方の半島に位置し、南北朝期に新田義貞らが立て籠もった城として知られます。金崎宮の境内と月見御殿跡などを通じ、日本海交通と戦乱の歴史を紹介します。', sourceName: '敦賀市公式サイト（金ヶ崎城跡）', sourceUrl: 'https://www.city.tsuruga.lg.jp/page/4440.html' })
  ,makeNationalSpot({ id: 'castle-254', name: '千早城跡', category: 'castle', region: '近畿', coordinate: { latitude: 34.4309, longitude: 135.6385, elevationMeter: 660 }, era: 'muromachi', eraLabel: '元弘2年（1332年）築城・楠木正成の山城', castleType: '国指定史跡・日本100名城・山城', summary: '楠木正成が鎌倉勢を迎え撃った、金剛山麓の難攻不落の山城です。', description: '千早城跡は元弘2年に楠木正成が築き、急峻な地形を生かして鎌倉幕府軍と戦った城です。城跡に建つ千早神社と金剛山の信仰を重ね、南北朝の歴史を紹介します。', sourceName: '千早赤阪村公式サイト（千早城跡）', sourceUrl: 'https://www.vill.chihayaakasaka.osaka.jp/kakuka/kyoiku/syakaikyoiku/bunnkazai/9118.html' })
  ,makeNationalSpot({ id: 'castle-255', name: '坂本城跡', category: 'castle', region: '近畿', coordinate: { latitude: 35.0706, longitude: 135.8842, elevationMeter: 85 }, era: 'sengoku', eraLabel: '元亀2年（1571年）築城・明智光秀の琵琶湖畔の居城', castleType: '国指定史跡・織豊系水城', summary: '比叡山の監視と琵琶湖水運を担った、明智光秀の居城跡です。', description: '坂本城跡は織田信長が明智光秀に築かせた琵琶湖畔の水城です。比叡山の監視、京都と美濃を結ぶ交通、水上交通の要衝という複数の役割から、織豊政権の地域支配を紹介します。', sourceName: '大津市公式サイト（坂本城跡）', sourceUrl: 'https://www.city.otsu.lg.jp/bz/a/03/16/60747.html' })
  ,makeNationalSpot({ id: 'religious-386', name: '中禅寺（立木観音）', category: 'religious', region: '関東', coordinate: { latitude: 36.7382, longitude: 139.5033, elevationMeter: 1280 }, era: 'nara', eraLabel: '延暦13年（784年）建立・坂東三十三観音第18番', religiousType: '寺院・天台宗・坂東三十三観音・山岳信仰', summary: '中禅寺湖畔に立木観音を祀る、日光山の山岳霊場です。', description: '中禅寺は勝道上人が784年に建立したと伝わる日光山の別院で、坂東三十三観音第18番札所です。中禅寺湖と男体山を望む自然景観、根を張った桂の立木観音から、山岳信仰と巡礼の結びつきを紹介します。', sourceName: '日光山輪王寺公式サイト（中禅寺・立木観音）', sourceUrl: 'https://www.rinnoji.or.jp/history/temple/chuzenji/' })
  ,makeNationalSpot({ id: 'religious-387', name: '大谷寺（大谷観音）', category: 'religious', region: '関東', coordinate: { latitude: 36.6035, longitude: 139.8265, elevationMeter: 190 }, era: 'heian', eraLabel: '弘法大師開山伝承・坂東三十三観音第19番', religiousType: '寺院・天台宗・坂東三十三観音・磨崖仏信仰', summary: '洞穴に観音堂を築き、大谷磨崖仏を伝える宇都宮の霊場です。', description: '大谷寺は坂東三十三観音第19番札所で、洞穴内の観音堂と岩壁に刻まれた大谷磨崖仏で知られます。自然の岩窟を信仰の場へ転じた、関東の古代・中世仏教文化を紹介します。', sourceName: '宇都宮市公式サイト（大谷寺）', sourceUrl: 'https://www.city.utsunomiya.lg.jp/citypromotion/kanko/1032109/1032112.html' })
  ,makeNationalSpot({ id: 'religious-388', name: '谷汲山華厳寺', category: 'religious', region: '中部', coordinate: { latitude: 35.4972, longitude: 136.6028, elevationMeter: 220 }, era: 'nara', eraLabel: '延暦17年（798年）創建伝承・西国三十三所第33番満願霊場', religiousType: '寺院・天台宗・西国三十三所満願霊場', summary: '西国三十三所の結願寺として、巡礼の終着点となる美濃の古刹です。', description: '華厳寺は西国三十三所第33番札所で、巡礼を終える満願霊場として知られます。過去・現在・未来を表す三つの御詠歌や、山中の参道を通じ、巡礼の終着点に込められた祈りを紹介します。', sourceName: '西国三十三所札所会公式サイト（第33番 華厳寺）', sourceUrl: 'https://www.saikoku33.gr.jp/place/33' })
  ,makeNationalSpot({ id: 'religious-389', name: '長命寺', category: 'religious', region: '中部', coordinate: { latitude: 35.1626, longitude: 136.1018, elevationMeter: 250 }, era: 'asuka', eraLabel: '推古天皇27年（619年）創建伝承・西国三十三所第31番', religiousType: '寺院・天台系単立・西国三十三所・長寿信仰', summary: '琵琶湖を望む山上にあり、健康長寿を願う西国三十三所札所です。', description: '長命寺は西国三十三所第31番札所で、湖岸から続く長い石段と琵琶湖の眺望で知られます。武内宿禰の長寿伝承と三尊一体の観音信仰から、生命への祈りと湖国の巡礼景観を紹介します。', sourceName: '西国三十三所札所会公式サイト（第31番 長命寺）', sourceUrl: 'https://www.saikoku33.gr.jp/place/31' })
  ,makeNationalSpot({ id: 'religious-390', name: '成相寺', category: 'religious', region: '近畿', coordinate: { latitude: 35.5688, longitude: 135.1954, elevationMeter: 450 }, era: 'nara', eraLabel: '慶雲元年（704年）創建伝承・西国三十三所第28番', religiousType: '寺院・橋立真言宗・西国三十三所・修験道', summary: '天橋立を望む山中にあり、修験道を起源とする西国札所です。', description: '成相寺は天橋立を見下ろす鼓ヶ岳の中腹にあり、古くは山岳修験の場だったと伝えられます。身代わり観音や雪深い丹後の巡礼路から、海と山を結ぶ信仰の景観を紹介します。', sourceName: '成相山成相寺公式サイト', sourceUrl: 'https://www.nariaiji.jp/' })
  ,makeNationalSpot({ id: 'religious-391', name: '松尾寺', category: 'religious', region: '近畿', coordinate: { latitude: 35.4628, longitude: 135.4211, elevationMeter: 260 }, era: 'nara', eraLabel: '和銅元年（708年）創建伝承・西国三十三所第29番', religiousType: '寺院・真言宗醍醐派・西国三十三所・馬頭観音信仰', summary: '青葉山の中腹にあり、馬頭観音を本尊とする西国唯一の札所です。', description: '松尾寺は西国三十三所第29番札所で、三十三所の中で唯一、馬頭観世音菩薩を本尊とします。農耕・水産・牛馬・交通の守り仏としての信仰から、丹後若狭の生活文化と巡礼を紹介します。', sourceName: '西国三十三所札所会公式サイト（第29番 松尾寺）', sourceUrl: 'https://www.saikoku33.gr.jp/place/29' })
  ,makeNationalSpot({ id: 'religious-392', name: '法華山一乗寺', category: 'religious', region: '近畿', coordinate: { latitude: 34.9195, longitude: 134.8432, elevationMeter: 150 }, era: 'asuka', eraLabel: '白雉元年（650年）創建伝承・西国三十三所第26番', religiousType: '寺院・天台宗・西国三十三所・山岳信仰', summary: '国宝三重塔を山中に伝える、播磨の西国三十三所札所です。', description: '一乗寺は法道仙人を開基とし、白雉元年創建を伝える西国三十三所第26番札所です。国宝三重塔と法華山の静かな境内から、古代の山岳寺院と観音巡礼の文化を紹介します。', sourceName: '西国三十三所札所会公式サイト（第26番 一乗寺）', sourceUrl: 'https://www.saikoku33.gr.jp/place/26' })
  ,makeNationalSpot({ id: 'religious-393', name: '播州清水寺', category: 'religious', region: '近畿', coordinate: { latitude: 34.9215, longitude: 134.9710, elevationMeter: 550 }, era: 'nara', eraLabel: '推古天皇35年（627年）創建伝承・西国三十三所第25番', religiousType: '寺院・天台宗・西国三十三所・清水信仰', summary: '御嶽山の山上にあり、霊泉と十一面観音を伝える播磨の古刹です。', description: '播州清水寺は西国三十三所第25番札所で、法道仙人と霊泉の伝承を持つ山上寺院です。清水の湧出と十一面観音への祈りから、水と山をめぐる播磨の信仰を紹介します。', sourceName: '播州清水寺公式サイト', sourceUrl: 'https://kiyomizudera.net/' })
  ,makeNationalSpot({ id: 'castle-256', name: '江馬氏館跡', category: 'castle', region: '中部', coordinate: { latitude: 36.3266, longitude: 137.3135, elevationMeter: 500 }, era: 'muromachi', eraLabel: '室町時代・飛騨江馬氏の武家館', castleType: '国指定史跡・名勝庭園・中世武家館', summary: '飛騨を治めた江馬氏の居館を復元し、庭園とともに伝える史跡です。', description: '江馬氏館跡は室町時代に飛騨北部を治めた江馬氏の武家館跡です。主殿や庭園を復元した公園から、山国飛騨の領主館と中世武家文化を紹介します。', sourceName: '飛騨市公式サイト（史跡江馬氏館跡公園）', sourceUrl: 'https://www.city.hida.gifu.jp/map/s931.html' })
  ,makeNationalSpot({ id: 'castle-257', name: '後瀬山城跡', category: 'castle', region: '中部', coordinate: { latitude: 35.4882, longitude: 135.7391, elevationMeter: 168 }, era: 'sengoku', eraLabel: '大永2年（1522年）築城・若狭国主の居城', castleType: '国指定史跡・山城・守護居館', summary: '小浜湊を見下ろし、歴代若狭国主が在城した中世山城です。', description: '後瀬山城跡は若狭守護武田元光が1522年に築き、近世小浜城へ役目を譲るまで歴代若狭国主の居城となりました。山城と麓の守護居館、小浜湊・丹後街道の結びつきから、日本海交易を支えた城下を紹介します。', sourceName: '小浜市公式サイト（後瀬山城跡）', sourceUrl: 'https://www1.city.obama.fukui.jp/kanko-bunka/jisha-shiseki/75.html' })
  ,makeNationalSpot({ id: 'castle-258', name: '日出城跡（暘谷城）', category: 'castle', region: '九州・沖縄', coordinate: { latitude: 33.3698, longitude: 131.5328, elevationMeter: 20 }, era: 'edo', eraLabel: '慶長6年（1601年）築城伝承・日出藩の居城', castleType: '城跡・別府湾を望む平山城・日出藩城下', summary: '別府湾を望む城下町と松屋寺を含め、日出藩の歴史を伝える城跡です。', description: '日出城は日出藩初代藩主木下延俊が築いた城で、別府湾を望む城下町の中心となりました。城跡と藩主の菩提寺・松屋寺などを通じ、豊後の近世大名文化を紹介します。', sourceName: '日出町公式サイト（日出町の歴史）', sourceUrl: 'https://www.town.hiji.lg.jp/gyoseijoho/shisetsuannai/shiryokan_kinenkan/1636.html' })
  ,makeNationalSpot({ id: 'castle-259', name: '富岡城跡', category: 'castle', region: '九州・沖縄', coordinate: { latitude: 32.5310, longitude: 130.0560, elevationMeter: 100 }, era: 'edo', eraLabel: '慶長7年（1602年）築城伝承・天草の海城', castleType: '城跡・天草の海上交通拠点・復元城郭', summary: '天草の海を見渡す丘に築かれ、島原・天草の歴史と結びつく城跡です。', description: '富岡城跡は天草下島の海を見渡す丘にあり、天草の政治・海上交通の拠点となった城です。富岡ビジターセンターと復元整備された本丸から、島の支配と海域交流の歴史を紹介します。', sourceName: '熊本県公式サイト（熊本県富岡ビジターセンター）', sourceUrl: 'https://www.pref.kumamoto.jp/soshiki/52/2506.html' })
  ,makeNationalSpot({ id: 'religious-394', name: '杉本寺', category: 'religious', region: '関東', coordinate: { latitude: 35.322583, longitude: 139.567444, elevationMeter: 45 }, era: 'nara', eraLabel: '天平6年（734年）創建伝承・坂東三十三観音第1番', religiousType: '寺院・天台宗・坂東三十三観音・鎌倉観音', summary: '鎌倉最古の寺とされ、坂東観音巡礼の出発点となる古刹です。', description: '杉本寺は三体の十一面観音を本尊とし、坂東三十三観音第1番札所として鎌倉の観音信仰を伝えます。苔むした石段と茅葺きの本堂を通じ、山の斜面に築かれた中世以来の祈りの場を紹介します。', sourceName: '杉本寺公式サイト', sourceUrl: 'https://sugimotodera.com/' })
  ,makeNationalSpot({ id: 'religious-395', name: '慈光寺', category: 'religious', region: '関東', coordinate: { latitude: 36.0113, longitude: 139.2333, elevationMeter: 320 }, era: 'asuka', eraLabel: '天武天皇2年（673年）開基伝承・坂東三十三観音第9番', religiousType: '寺院・天台宗・坂東三十三観音・山岳寺院', summary: '都幾山の深い森に1300年の歴史を刻む坂東札所です。', description: '慈光寺は寺伝で僧慈訓が673年に千手観音堂を建立したことを開基とし、坂東三十三観音第9番札所として信仰を集めてきました。国宝を伝える山岳寺院として、比企の山と巡礼の結びつきを紹介します。', sourceName: '都幾山 慈光寺公式サイト', sourceUrl: 'https://www.temple.or.jp/' })
  ,makeNationalSpot({ id: 'religious-396', name: '那古寺', category: 'religious', region: '関東', coordinate: { latitude: 35.027088, longitude: 139.859726, elevationMeter: 65 }, era: 'nara', eraLabel: '養老元年（717年）開基伝承・坂東三十三観音第33番', religiousType: '寺院・真言宗智山派・坂東三十三観音・観音信仰', summary: '房総の海を望む坂東三十三観音の結願寺です。', description: '那古寺は千手観音を本尊とし、坂東三十三観音第33番札所として古来から巡礼者を迎えてきました。海上交通と房総の観音信仰が交わる境内を通じ、巡礼路の東端にある祈りの拠点を紹介します。', sourceName: '補陀洛山 那古寺公式サイト', sourceUrl: 'https://www.nagoji.com/' })
  ,makeNationalSpot({ id: 'religious-397', name: '水潜寺', category: 'religious', region: '関東', coordinate: { latitude: 36.08222, longitude: 139.0536, elevationMeter: 250 }, era: 'muromachi', eraLabel: '秩父札所第34番・日本百観音結願寺', religiousType: '寺院・曹洞宗・秩父三十四観音・日本百観音', summary: '西国・坂東・秩父を結ぶ日本百観音の結願寺です。', description: '水潜寺は秩父札所第34番で、西国・坂東・秩父の百観音巡礼を結ぶ寺院と伝えられています。お砂踏みや水くぐりの岩屋の伝承から、長い旅を終えて俗世へ戻る結願の文化を紹介します。', sourceName: '秩父札所連合会公式サイト（水潜寺）', sourceUrl: 'https://chichibufudasho.com/fudasho/suisenji/' })
  ,makeNationalSpot({ id: 'religious-398', name: '法起院', category: 'religious', region: '近畿', coordinate: { latitude: 34.5361, longitude: 135.9065, elevationMeter: 150 }, era: 'nara', eraLabel: '西国三十三所番外札所・徳道上人ゆかりの寺', religiousType: '寺院・真言宗豊山派・西国三十三所番外・巡礼開創伝承', summary: '長谷寺門前で西国巡礼の開創者をまつる番外札所です。', description: '法起院は長谷寺の門前にある西国三十三所の番外札所で、巡礼の開創者とされる徳道上人ゆかりの寺院です。長谷寺参詣と一体になった門前町の祈りから、西国巡礼が形づくられていく歴史を紹介します。', sourceName: '西国三十三所札所会公式サイト（第8番 長谷寺・番外法起院）', sourceUrl: 'https://www.saikoku33.gr.jp/place/8' })
  ,makeNationalSpot({ id: 'religious-399', name: '高野寺', category: 'religious', region: '北海道', coordinate: { latitude: 41.7590, longitude: 140.7165, elevationMeter: 25 }, era: 'taisho', eraLabel: '北海道三十三観音第1番・大正2年（1913年）開創', religiousType: '寺院・高野山真言宗・北海道三十三観音', summary: '函館を起点とする北海道三十三観音の第一番札所です。', description: '高野寺は北海道三十三観音の第1番札所で、霊場会は函館を北海道の玄関口として第一番に定めた由来を紹介しています。北の開拓地に移植された観音巡礼の出発点として、海峡都市函館の宗教文化を紹介します。', sourceName: '北海道三十三観音霊場会公式サイト', sourceUrl: 'https://hokkaido33kannon.com/fudasyo/' })
  ,makeNationalSpot({ id: 'religious-400', name: '小樽高野山日光院', category: 'religious', region: '北海道', coordinate: { latitude: 43.2006, longitude: 140.9837, elevationMeter: 55 }, era: 'meiji', eraLabel: '明治24年（1891年）小樽に再興・北海道三十三観音第7番', religiousType: '寺院・高野山真言宗・北海道三十三観音', summary: '石狩湾を望む丘で北の巡礼文化を伝える小樽の札所です。', description: '小樽高野山日光院は北海道三十三観音第7番札所で、高野山の御本尊を請来し、明治24年に小樽へ再興された寺院です。港町の発展とともに広がった北海道の弘法信仰を紹介します。', sourceName: '北海道三十三観音霊場会公式サイト（日光院）', sourceUrl: 'https://hokkaido33kannon.com/no7_nikkoin/' })
  ,makeNationalSpot({ id: 'religious-401', name: '成田山新栄寺', category: 'religious', region: '北海道', coordinate: { latitude: 43.0523, longitude: 141.3527, elevationMeter: 25 }, era: 'meiji', eraLabel: '明治18年（1885年）開創・北海道三十三観音第9番', religiousType: '寺院・成田山札幌別院・北海道三十三観音', summary: '開拓期の札幌で信仰の支えとなった北海道三十三観音札所です。', description: '成田山新栄寺は北海道三十三観音第9番札所で、明治18年に成田山新勝寺から不動明王を勧請して開創された札幌別院です。開拓者の心の支えとなった都市の霊場として、北海道の近代化と信仰を紹介します。', sourceName: '北海道三十三観音霊場会公式サイト（成田山新栄寺）', sourceUrl: 'https://hokkaido33kannon.com/fudasyo/09.php' })
  ,makeNationalSpot({ id: 'castle-260', name: '大津城跡', category: 'castle', region: '中部', coordinate: { latitude: 35.0117, longitude: 135.8644, elevationMeter: 90 }, era: 'sengoku', eraLabel: '天正14年（1586年）頃築城・大津籠城の舞台', castleType: '史跡・琵琶湖の水城・港湾城郭', summary: '琵琶湖岸の港と城下町を一体化した近世初頭の水城です。', description: '大津城跡は琵琶湖岸に築かれ、関ヶ原合戦の前哨戦となった大津籠城の舞台です。湖上交通の港と城下町を押さえた水城の構造から、近江の物流と軍事の結びつきを紹介します。', sourceName: '大津市歴史博物館・大津市公式サイト', sourceUrl: 'https://www.rekihaku.otsu.shiga.jp/db/jiten/data/114.html' })
  ,makeNationalSpot({ id: 'castle-262', name: '八代城跡群（八代城跡）', category: 'castle', region: '九州・沖縄', coordinate: { latitude: 32.507418, longitude: 130.599911, elevationMeter: 6 }, era: 'edo', eraLabel: '元和6年（1620年）頃築城・八代城跡群の中核', castleType: '国指定史跡・平城・港湾都市の城郭', summary: '古麓城・麦島城とともに八代の三時代の城跡を構成します。', description: '八代城跡は中世の古麓城、安土桃山時代の麦島城とともに八代城跡群を構成する江戸時代の城です。地震後に築かれた石垣と城下の水運から、球磨川河口の交通・政治拠点の変遷を紹介します。', sourceName: '八代市公式サイト（八代城跡群）', sourceUrl: 'https://www.city.yatsushiro.lg.jp/kiji0032035/index.html' })
  ,makeNationalSpot({ id: 'religious-402', name: '宇治上神社', category: 'religious', region: '近畿', coordinate: { latitude: 34.891835, longitude: 135.811198, elevationMeter: 35 }, era: 'heian', eraLabel: '平安時代後期の本殿・世界文化遺産', religiousType: '神社・世界遺産・現存最古の神社建築', summary: '現存最古の神社本殿を伝える、宇治川東岸の世界遺産です。', description: '宇治上神社は菟道稚郎子・応神天皇・仁徳天皇を祀り、平安時代後期の本殿と鎌倉時代前期の拝殿を伝えます。宇治川や平等院と結びつく古代から中世の信仰景観を紹介します。', sourceName: '宇治上神社公式サイト・宇治市公式サイト', sourceUrl: 'https://www.ujikamijinja.jp/' })
  ,makeNationalSpot({ id: 'religious-403', name: '飛鳥寺', category: 'religious', region: '近畿', coordinate: { latitude: 34.478766, longitude: 135.820295, elevationMeter: 120 }, era: 'asuka', eraLabel: '6世紀末創建伝承・日本最古の本格寺院', religiousType: '寺院・真言宗豊山派・飛鳥大仏・飛鳥寺跡', summary: '蘇我馬子の発願で建てられた、日本最初の本格的な仏教寺院です。', description: '飛鳥寺は6世紀末から7世紀初めに蘇我馬子の発願で造営されたと伝えられる寺院です。飛鳥大仏と創建時の伽藍跡を通じ、日本が仏教を受け入れた初期の宗教拠点を紹介します。', sourceName: '文化庁 日本遺産ポータルサイト（飛鳥寺）', sourceUrl: 'https://japan-heritage.bunka.go.jp/ja/culturalproperties/result/3155/' })
  ,makeNationalSpot({ id: 'religious-404', name: '大徳寺', category: 'religious', region: '近畿', coordinate: { latitude: 35.043894, longitude: 135.746033, elevationMeter: 70 }, era: 'kamakura', eraLabel: '正和4年（1315年）開創・臨済宗大徳寺派大本山', religiousType: '寺院・臨済宗大徳寺派大本山・塔頭群', summary: '一休や戦国大名、茶の湯の文化が交差する京都の禅寺です。', description: '大徳寺は鎌倉時代末に開創され、応仁の乱後に一休宗純が復興し、桃山時代には織田信長や豊臣秀吉と深く結びつきました。大伽藍と塔頭群から、禅宗と武家・茶人の文化を紹介します。', sourceName: '京都市公式観光Navi（大徳寺）', sourceUrl: 'https://ja.kyoto.travel/tourism/single01.php?category_id=7&tourism_id=410' })
  ,makeNationalSpot({ id: 'religious-405', name: '吉野水分神社', category: 'religious', region: '近畿', coordinate: { latitude: 34.353889, longitude: 135.873056, elevationMeter: 560 }, era: 'momoyama', eraLabel: '世界遺産・慶長9年（1604年）社殿再建', religiousType: '神社・世界遺産・水分信仰・子守信仰', summary: '吉野山上で水と生命を司る神を祀る、子守宮の古社です。', description: '吉野水分神社は天水分大神を主祭神とし、子授け・安産・子どもの守護神として信仰されてきました。豊臣秀吉の祈願や秀頼による社殿再建の伝承から、吉野の山岳信仰と生命の祈りを紹介します。', sourceName: '奈良県観光公式サイト（吉野水分神社）', sourceUrl: 'https://yamatoji.nara-kankou.or.jp/01shaji/01jinja/04south_area/yoshinomikumarijinja/' })
  ,makeNationalSpot({ id: 'religious-406', name: '伊太祁曽神社', category: 'religious', region: '近畿', coordinate: { latitude: 34.2102, longitude: 135.2756, elevationMeter: 35 }, era: 'nara', eraLabel: '大宝2年（702年）初見・木の神を祀る紀伊国の古社', religiousType: '神社・木の神・紀伊国の信仰', summary: '木の神を祀り、「木の国」紀伊の自然信仰を伝える古社です。', description: '伊太祁曽神社は五十猛命を祀り、木の種を全国に広めた神が紀伊に鎮まったという神話を伝えます。文献上は大宝2年の記録に現れ、森林と暮らしを結ぶ紀伊の信仰拠点を紹介します。', sourceName: '和歌山市公式サイト（伊太祁曽神社）', sourceUrl: 'https://www.city.wakayama.wakayama.jp/kankou/kankouspot/1001038/1000590.html' })
  ,makeNationalSpot({ id: 'religious-407', name: '根来寺', category: 'religious', region: '近畿', coordinate: { latitude: 34.27726, longitude: 135.312, elevationMeter: 106 }, era: 'heian', eraLabel: '大治5年（1130年）を前身とする新義真言宗総本山', religiousType: '寺院・新義真言宗総本山・中世寺院都市', summary: '大塔と広大な境内に中世の宗教勢力と文化を伝える総本山です。', description: '根来寺は覚鑁上人の伝法院を前身とし、室町から戦国期に大規模な寺院勢力へ発展しました。国宝の大塔や史跡境内、根来衆の歴史から、寺院が学問・修行・政治の拠点となった姿を紹介します。', sourceName: '新義真言宗総本山 根來寺公式サイト', sourceUrl: 'https://www.negoroji.org/history' })
  ,makeNationalSpot({ id: 'religious-409', name: '妙成寺', category: 'religious', region: '中部', coordinate: { latitude: 36.9117, longitude: 136.7906, elevationMeter: 45 }, era: 'kamakura', eraLabel: '永仁2年（1294年）開創・北陸日蓮宗の本山', religiousType: '寺院・日蓮宗本山・前田家ゆかり', summary: '能登に桃山様式の伽藍を残す、北陸日蓮宗の本山です。', description: '妙成寺は1294年に日像上人を開祖として建立された北陸地方の日蓮宗本山です。前田家の外護で整えられた本堂・五重塔などの伽藍から、能登の宗教文化と加賀藩の信仰を紹介します。', sourceName: '石川県公式サイト（妙成寺）', sourceUrl: 'https://www.pref.ishikawa.lg.jp/kyoiku/bunkazai/kenzoubutu/k-2.html' })
  ,makeNationalSpot({ id: 'religious-410', name: '鶴林寺', category: 'religious', region: '近畿', coordinate: { latitude: 34.752278, longitude: 134.832603, elevationMeter: 15 }, era: 'asuka', eraLabel: '聖徳太子創建伝承・国宝太子堂と本堂', religiousType: '寺院・天台宗・太子信仰・新西国三十三所', summary: '「播磨の法隆寺」と呼ばれ、国宝建築を伝える古寺です。', description: '鶴林寺は聖徳太子の創建と伝えられ、太子堂や本堂など国宝・重要文化財を伝えます。新西国三十三所の札所としての信仰と、播磨の古代寺院文化を紹介します。', sourceName: '鶴林寺公式サイト', sourceUrl: 'https://www.kakurinji.or.jp/' })
  ,makeNationalSpot({ id: 'castle-263', name: '屋嶋城跡', category: 'castle', region: '四国', coordinate: { latitude: 34.3672, longitude: 134.1048, elevationMeter: 280 }, era: 'asuka', eraLabel: '天智天皇6年（667年）築城・古代山城', castleType: '国指定史跡・古代山城・屋島の防衛拠点', summary: '白村江の敗戦後に築かれた、屋島の古代山城です。', description: '屋嶋城跡は白村江の戦い後の対外緊張を背景に築かれた古代山城で、石積みの城壁と城門跡が残ります。瀬戸内海を見渡す屋島の地形から、古代国家の防衛と海上交通を紹介します。', sourceName: '高松市公式サイト（屋嶋城）', sourceUrl: 'https://www.city.takamatsu.kagawa.jp/kurashi/kosodate/bunka/bunkazai/chosa/yashimajo/index.html' })
  ,makeNationalSpot({ id: 'castle-264', name: '高安城跡', category: 'castle', region: '近畿', coordinate: { latitude: 34.617095, longitude: 135.657972, elevationMeter: 480 }, era: 'asuka', eraLabel: '天智天皇6年（667年）築城伝承・壬申の乱ゆかり', castleType: '古代山城・高安山の防衛施設', summary: '河内と大和を見渡す高安山に築かれた古代の防衛拠点です。', description: '高安城跡は日本書紀に記される古代山城で、奈良県と大阪府の境にある高安山に位置します。壬申の乱の戦場としても語られ、河内・大和を結ぶ峠の軍事的な重要性を紹介します。', sourceName: '奈良県公式サイト（高安城跡）', sourceUrl: 'https://www.pref.nara.lg.jp/narakikimanyo/2849.html' })
  ,makeNationalSpot({ id: 'castle-265', name: '伏見城跡', category: 'castle', region: '近畿', coordinate: { latitude: 34.930277, longitude: 135.771388, elevationMeter: 95 }, era: 'sengoku', eraLabel: '文禄元年（1592年）造営開始・豊臣・徳川政権の拠点', castleType: '城跡・政権所在地・桃山文化の中心', summary: '豊臣秀吉と徳川家康の政権運営を支えた、桃山の城跡です。', description: '伏見城跡は秀吉の築城から家康による再建、将軍宣下、廃城まで、安土桃山から江戸初期の政治を映す城跡です。伏見の港・城下町と移築された遺構から、城が国家運営の舞台となった歴史を紹介します。', sourceName: '京都市公式サイト（都市史・伏見城）', sourceUrl: 'https://www2.city.kyoto.lg.jp/somu/rekishi/fm/nenpyou/htmlsheet/toshi20.html' })
]);
